...
| `REASONING_REPLAY_ENABLED`                  | boolean | `true`  |         | Cache and replay model reasoning across multi-turn conversations. Disable to stop storing and re-injecting reasoning.                                                                                                                                                                                                                                                                                                                                                                                                        |
