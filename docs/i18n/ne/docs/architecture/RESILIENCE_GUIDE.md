...
- `rateLimitedUntil` — कूलडाउन समाप्त नहुन्जेलको टाइमस्ट्याम्प
- `testStatus: "unavailable"`
- `lastError`, `lastErrorType`, `errorCode`
- `backoffLevel` — घातीय ब्याकअफ काउन्टर
...
**थन्डरिङ-हर्ड-विरोधी सुरक्षा:** समवर्ती विफलताहरूले कूलडाउनलाई आवश्यकताभन्दा बढी लम्ब्याउन वा `backoffLevel` लाई दोहोरो रूपमा बढाउनबाट रोक्छ।

**अन्तिम अवस्थाहरू (कूलडाउन होइनन्):**

- `banned` — प्रतिबन्धित-कुञ्जीशब्द / खाता-प्रतिबन्ध पहिचानद्वारा सेट गरिन्छ ([BAN_DETECTION](../security/BAN_DETECTION.md) हेर्नुहोस्)
- `expired` (सीमित पुनःप्रयासपछि अन्तिम अवस्थामा रूपान्तरण हुन्छ — घातीय ब्याकअफसहित `EXPIRED_RETRY_MAX = 3` — जसले गर्दा क्षणिक OAuth त्रुटिहरूले खाता स्थायी रूपमा निष्क्रिय हुनुअघि आफैँ सुधार हुन सक्छन्)
- `credits_exhausted`

यी प्रमाणहरू परिवर्तन नभएसम्म वा सञ्चालकले तिनलाई रिसेट नगरेसम्म कायम रहन्छन्। अन्तिम अवस्थाहरूलाई क्षणिक कूलडाउन अवस्थाले अधिलेखन नगर्नुहोस्।

**अल्छी पुनःप्राप्ति:** `rateLimitedUntil` बितिसकेपछि, जडान फेरि योग्य हुन्छ। सफल प्रयोगपछि, `clearAccountError()` ले सबै त्रुटि फिल्डहरू खाली गर्छ।

### सत्र आत्मीयता (#7274)

**दायरा:** एउटा जडानमा पिन गरिएको एउटा क्लाइन्ट सत्र (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` हेडर), **कुनै पनि** प्रदायकका लागि।

**उद्देश्य:** बहु-टर्न एजेन्ट (Claude Code, aider, अनुकूलन एजेन्टहरू) लाई अनुरोधहरूभरि एउटै खातामा राख्ने, जसले क्रस-अकाउन्ट सन्दर्भ हानि र प्रति-खाता सत्र अवस्था भएका प्रदायकहरूमा दोहोरिने कोल्ड-स्टार्ट 429हरू घटाउँछ।

**कार्यान्वयन:**

- TTL निर्धारण: `src/sse/services/sessionAffinityPin.ts::resolveSessionAffinityTtlMs()`
- पिन छनोट/सिर्जना: `src/sse/services/sessionAffinityPin.ts::selectSessionAffinityConnection()`
...
- सेटिङ: `sessionAffinityTtlMs` (ms मा विश्वव्यापी TTL, `0` ले निष्क्रिय गर्छ) — `src/lib/db/settings.ts`। माइग्रेसन `124_generic_session_affinity_ttl.sql` द्वारा Codex-मात्र `codexSessionAffinityTtlMs` बाट पुनःनामकरण गरिएको हो, जसले पहिले कन्फिगर गरिएको कुनै पनि Codex TTL लाई नयाँ पूर्वनिर्धारित मानका रूपमा सार्छ।

#7274 अघि, `resolveSessionAffinityTtlMs()` ले `codex` बाहेक प्रत्येक प्रदायकका लागि तत्काल `0` फर्काउँथ्यो, त्यसैले पिनिङ संयन्त्र र हेडर निष्कर्षण पहिले नै प्रदायक-निरपेक्ष भए तापनि TTL सेटिङ (र सत्र हेडरहरू) ले अन्यत्र कुनै प्रभाव पार्दैनथे। समाधानले त्यो प्रारम्भिक फिर्ती हटायो; TTL लाई विश्वव्यापी रूपमा `0` भन्दा माथि सेट गरेपछि अब यो प्रत्येक प्रदायकमा समान रूपमा लागू हुन्छ।

तीनवटा सत्र-आत्मीयता हेडरहरू कहिल्यै अपस्ट्रिममा फर्वार्ड गरिँदैनन् — क्लाइन्ट हेडरहरूलाई जस्ताको तस्तै पठाउनुको सट्टा एक्जिक्युटरहरूले आफ्नै अपस्ट्रिम हेडरहरू सुरुदेखि निर्माण गर्छन्, त्यसैले यो आन्तरिक सहसम्बन्ध ID मात्र रहन्छ।

### विशिष्ट व्यवस्थित सत्र जडान लिजहरू

**दायरा:** एउटा सक्रिय व्यवस्थित HTTP क्लाइन्ट/सत्रले एउटा योग्य OmniRoute जडानको स्वामित्व लिन्छ।

**उद्देश्य:** अनुरोधहरूभरि कडा राउटिङ सीमा आवश्यक पर्ने क्लाइन्टहरूका लागि टिकाउ विशिष्ट जडान स्वामित्व प्रदान गर्ने। यो सत्र आत्मीयताभन्दा फरक छ, जुन निरन्तरताका लागि नरम प्राथमिकता हो:
विशिष्ट लिजले SQLite मा जीवनचक्र अवस्था कायम राख्छ, विश्वव्यापी सक्रिय-स्वामी र
सक्रिय-जडान विशिष्टता लागू गर्छ, र प्रदायक डिस्प्याचअघि पुरानो जेनेरेसन अस्वीकार गर्छ।

यो सुविधा प्रत्येक API कुञ्जीका लागि वैकल्पिक रूपमा सक्षम गर्न मिल्छ। व्यवस्थित कुञ्जीसँग `lease:exclusive` स्कोप र
स्पष्ट रूपमा गैर-खाली `allowedConnections` सूची हुनुपर्छ। कुनै पनि HTTP क्लाइन्टले जीवनचक्र एन्डपोइन्ट प्रयोग गर्न सक्छ; कुनै
...
योग्य रहुन्जेल मोडेल परिवर्तन गर्दा पनि बाइन्डिङ कायम रहन्छ। सामान्य मोडेल, कोटा, स्वास्थ्य, कूलडाउन र अनुमति-सूची नियमहरू आधिकारिक नै रहन्छन् र
सोही जेनेरेसनलाई अर्को खाली योग्य जडानमा स्थानान्तरण गर्न सक्छन्।

जीवनचक्र भनेको JSON कार्यहरू `acquire`, `renew`, र `release` सहितको `POST /api/v1/session-leases` हो।
...
यदि सामान्य राउटिङमा योग्य व्यवस्थित उम्मेदवारहरू छन् तर प्रत्येक खाली उम्मेदवार विदेशी सक्रिय लिजद्वारा ओगटिएको छ भने,
OmniRoute ले HTTP `429`, lease-capacity-unavailable कोड,
...
- OAuth सत्र अधिभोग OAuth खाताहरूका लागि प्रक्रिया-स्थानीय नरम वितरण हो।
- खाता सेमाफोरहरूले अनुरोध-समवर्तीता अनुमतिहरू प्रदान गर्छन् र अनुरोध पूरा भएपछि समाप्त हुन्छन्।
- विशिष्ट व्यवस्थित सत्र लिजहरू जेनेरेसन सीमासहितको टिकाउ जीवनचक्र स्वामित्व हुन्।
...
**उद्देश्य:** केवल एउटा मोडेल अनुपलब्ध वा कोटा-सीमित हुँदा सम्पूर्ण connection निष्क्रिय हुनबाट जोगाउनु।

**उदाहरणहरू:**

- प्रति-मोडेल कोटा भएका provider हरूले 429 फर्काउँदा
- एउटा हराइरहेको मोडेलका लागि स्थानीय provider हरूले 404 फर्काउँदा
- Provider-विशिष्ट mode/model अनुमति विफलताहरू (जस्तै, Grok modes)
...
यसले सक्रिय लकआउटहरूलाई निम्न विवरणसहित सूचीबद्ध गर्छ: provider, connection, model, reason, expiresAt। अपरेटरहरूले कार्डबाट मोडेललाई म्यानुअल रूपमा पुनः सक्षम गर्न सक्छन्।

**REST API:**

- `GET /api/resilience/model-cooldowns` — सक्रिय लकआउटहरूको सूची
- `DELETE /api/resilience/model-cooldowns` — म्यानुअल रूपमा पुनः सक्षम गर्ने। Body: `{provider, connection, model}`। Auth: व्यवस्थापन।

### लकआउट सेटिङ्स UI + सफलता-क्षय रिकभरी (v3.8.23)

मोडेल लकआउट सधैँ सक्रिय रहने हार्डकोड गरिएको व्यवहारबाट पूर्ण रूपमा कन्फिगर गर्न मिल्ने,
अप्ट-इन सुविधा बनेको छ, जसको आफ्नै सेटिङ्स कार्ड र स्व-पुनर्स्थापित हुने रिकभरी मार्ग छ।

**सेटिङ्स कार्ड:** Settings → Model Lockout
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`)।
यो माथिको पढ्न-मात्र मिल्ने `ModelCooldownsCard` भन्दा **फरक** छ (जसले सक्रिय लकआउटहरू
केवल _सूचीबद्ध_ गर्छ) — नयाँ कार्डले _प्यारामिटरहरू कन्फिगर गर्छ_। पूर्वनिर्धारित मानहरू
`DEFAULT_MODEL_LOCKOUT_SETTINGS`
(`src/lib/resilience/modelLockoutSettings.ts`) मा छन्:

| सेटिङ                   | पूर्वनिर्धारित                   | अर्थ                                                                  |
| ----------------------- | -------------------------------- | --------------------------------------------------------------------- |
| `enabled`               | `false`                          | मुख्य टगल — मोडेल लकआउट **पूर्वनिर्धारित रूपमा बन्द** हुन्छ।          |
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | मोडेल-स्कोप विफलताका रूपमा गणना हुने upstream statuses।               |
| `baseCooldownMs`        | `120_000` (120 s)                | पहिलो विफलताका लागि प्रारम्भिक लकआउट अवधि।                            |
| `maxCooldownMs`         | `1_800_000` (30 min)             | बढाइएको कुलडाउनको अधिकतम सीमा।                                        |
| `maxBackoffSteps`       | `10`                             | अधिकतम exponential-backoff वृद्धि चरणहरू।                             |
| `useExponentialBackoff` | `true`                           | दोहोरिएका विफलताहरूले कुलडाउनलाई exponential रूपमा बढाउने वा नबढाउने। |

सेटिङहरू सामान्य settings store मार्फत सुरक्षित रहन्छन् र
resilience settings schema मार्फत प्रमाणीकरण हुन्छन्; कार्डले `baseCooldownMs`/`maxCooldownMs`
लाई (`maxCooldownMs ≥ baseCooldownMs` सहित) र `maxBackoffSteps` लाई सीमाभित्र राख्छ।

**सफलता-क्षय रिकभरी:** रिकभरी पूर्ण रूपमा टाइमर समाप्तिमा मात्र आधारित **छैन**। स्वस्थ
response ले मोडेलको विफलता सङ्ख्या क्रमशः घटाउँछ, जसले गर्दा बीच अवधिमै रिकभर भएको मोडेलले
आफ्नो टाइमर समाप्त हुनुअघि नै वृद्धि रोक्छ (र लकआउट हटाउँछ)। सफल
combo target मा, `open-sse/services/combo.ts` ले `decayModelFailureCount()`
(`open-sse/services/accountFallback.ts`) कल गर्छ, जसले सुरक्षित गरिएको
`failureCount` लाई **आधा** बनाउँछ (`Math.floor(failureCount / 2)`); यो `0` पुगेपछि लकआउट
entry पूर्ण रूपमा मेटाइन्छ। यसको समकक्ष `recordModelLockoutFailure()` ले
escalation window भित्र भएका विफलताहरूमा count बढाउँछ (र कुलडाउन वृद्धि गर्छ)।
यो सफलता-क्षय सामान्य टाइमर समाप्तिको अतिरिक्त हो —
कुनै पनि मार्गले मोडेललाई पुनः सक्षम गर्न सक्छ।

**अवस्था:** लकआउटहरू DB मा सुरक्षित नराखी **in-memory** (प्रति-process `Map` हरूमा,
`provider:connectionId:model` द्वारा key गरिएको `ModelLockoutEntry`) राखिन्छन् —
restart हुँदा ती हराउँछन्। _सेटिङहरू_ सुरक्षित रहन्छन्; सक्रिय
लकआउट _अवस्था_ अस्थायी हुन्छ।
...
- कुनै प्रदायकका सबै कुञ्जीहरू छोडिए → सर्किट ब्रेकरको अवस्था र प्रत्येक जडानको `rateLimitedUntil`/`testStatus` दुवै जाँच गर्नुहोस्।
- रिसेट विन्डोपश्चात् प्रदायक स्थायी रूपमा बहिष्कृत भयो → कोडले `getStatus()`/`canExecute()` को सट्टा कच्चा `state` पढिरहेको छ।
- एउटा कुञ्जी असफल भयो, अरूले काम गर्नुपर्छ → सर्किट ब्रेकरभन्दा जडान कूलडाउनलाई प्राथमिकता दिनुहोस्।
- एउटा मोडेल मात्र असफल भयो → जडान कूलडाउनभन्दा मोडेल लकआउटलाई प्राथमिकता दिनुहोस्।
- अवस्था स्वतः पुनःस्थापित हुनुपर्ने तर हुँदैन → भविष्यको टाइमस्ट्याम्प र म्याद सकिएको अवस्था रिफ्रेस गर्ने रिड पाथ जाँच गर्नुहोस्। स्थायी स्थितिहरूका लागि म्यानुअल परिवर्तन आवश्यक हुन्छ।
