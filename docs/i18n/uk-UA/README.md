...
## 💰 ~1,47 млрд безкоштовних токенів на місяць

</div>

> Об’єднувати безкоштовні тарифи вручну складно — десятки SDK, десятки обмежень швидкості й жодного розуміння того, скільки ви насправді маєте. OmniRoute каталогізує **446 записів безкоштовних тарифів у межах 34 ключів повторюваних пулів** і обчислює загальну кількість токенів на основі **16 пулів з опублікованим додатним місячним бюджетом і п’яти окремих обмежень Groq для кожної моделі**, усуваючи дублювання спільних пулів. Квоти, які стають доступними лише після регіональної перевірки особи (наразі: ModelScope), відображаються окремо: ще ~6 млн після регіональної перевірки особи — і ніколи не додаються до загального показника. Результат постійно відображається на панелі керування (`/dashboard/free-tiers`).

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="Картка бюджету безкоштовних тарифів OmniRoute: стабільно ~1,47 млрд безкоштовних токенів на місяць і до ~2,07 млрд у перший місяць із вітальними кредитами, отриманими з 34 задокументованих ключів повторюваних пулів, що охоплюють 446 каталогізованих записів безкоштовних тарифів за єдиною кінцевою точкою. Чесний розрахунок з усуненням дублікатів пулів — кожен спільний пул враховується лише один раз, зокрема 16 повторюваних пулів з опублікованим додатним місячним бюджетом токенів і п’ять окремих обмежень Groq для кожної моделі; 13 провайдерів позначено в каталозі ризиків умов використання як такі, яких варто уникати, тож рішення залишається за вами. Смуга бюджету включає Mistral 1B, Nara 210M, LLM7 150M, Groq 30M (п’ять окремих обмежень для кожної моделі) та менші пули, а також вітальні кредити першого місяця й постійно безкоштовних провайдерів без обмеження кількості токенів, які відображаються окремо, щоб вони ніколи не завищували загальний показник. Поточні дані про використані та залишкові обсяги доступні на /dashboard/free-tiers."/>

> Анімований огляд сторінки `/dashboard/free-tiers` з актуальними даними. Повна методологія (усунення дублікатів пулів, рівні кредитів, умови провайдерів): **[docs/reference/FREE_TIERS.md](docs/reference/FREE_TIERS.md)**.
>
> <sub>Ці показники повторно перевіряються кожні два тижні за актуальним каталогом і **можуть змінюватися в обидва боки** — якщо провайдер припиняє дію безкоштовного тарифу, число зменшується; якщо з’являється новий — зростає. Ми публікуємо те, що фактично обчислює каталог, а не округлений у більший бік найкращий можливий результат.</sub>
...
⭐ Поставте зірку репозиторію, якщо OMNIROUTE допоміг вам заощадити гроші та полегшити роботу.
...
[![Рейтинг історії зірок](https://api.star-history.com/badge?repo=diegosouzapw/OmniRoute&theme=dark)](https://www.star-history.com/diegosouzapw/omniroute)
[![olud.ai](https://olud.ai/badge.php?tool=diegosouzapw-omniroute)](https://olud.ai/project/diegosouzapw-omniroute.html)

### 💬 Приєднуйтеся до спільноти

**👋 Стежте за супроводжувачем — першими дізнавайтеся про нових провайдерів, випуски та поради:**
...
[![WhatsApp — увесь світ](https://img.shields.io/badge/WhatsApp_Global-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/FvuCbrpZmQ6I85n2vW5QIC?s=cl&p=a&mlu=4)
...
**Запитання, поради щодо провайдерів, план розвитку та підтримка → [Discord](https://discord.gg/U47eFqAXCn) · [Telegram](https://t.me/omnirouteOficial) · WhatsApp [🌍 Увесь світ](https://chat.whatsapp.com/FvuCbrpZmQ6I85n2vW5QIC?s=cl&p=a&mlu=4) / [🇧🇷 Бразилія](https://chat.whatsapp.com/KWgatljAjmbELQory59Oti?s=cl&p=a&mlu=4) / [Портал](https://portal.sthub.com.br/communities/groups/st-hub/channels/Omniroute-World-8kRjmK)**
...
<table>
  ...
  <tr><td nowrap><b>База даних</b></td><td>better-sqlite3 (SQLite, журналювання WAL) + LowDB (застарілий формат JSON) — 122 доменні модулі, 177 міграцій</td></tr>
  ...
  <tr><td nowrap><b>Потокове передавання</b></td><td>Події, надіслані сервером (SSE) + міст WebSocket (<code>/v1/ws</code>)</td></tr>
  <tr><td nowrap><b>Стиснення</b></td><td>Конвеєр із 12 рушіїв — RTK, Caveman, LLMLingua-2 (MobileBERT ONNX), GCF, OmniGlyph</td></tr>
  <tr><td nowrap><b>Автентифікація та безпека</b></td><td>OAuth 2.0 (PKCE) + JWT + ключі API + автентифікація MCP з обмеженими областями доступу · AES-256-GCM для даних у стані спокою · DOMPurify</td></tr>
  <tr><td nowrap><b>Непомітність</b></td><td>wreq-js — імітація відбитків JA3 / JA4 TLS, трирівневий проксі</td></tr>
  <tr><td nowrap><b>Відмовостійкість</b></td><td>Автоматичний вимикач, експоненційна затримка повторних спроб, захист від «громового стада», самовідновлення автоматичних комбінацій</td></tr>
  <tr><td nowrap><b>Журналювання</b></td><td>pino — структуровані журнали JSON із контекстом запиту</td></tr>
  <tr><td nowrap><b>Тестування</b></td><td>Засіб запуску тестів Node.js + Vitest — <b>понад 39 000 статичних оголошень тестів</b> у понад 5 100 відстежуваних тестових файлах (модульні, інтеграційні, E2E, безпекові, екосистемні)</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/USER_GUIDE.md">Посібник користувача</a></b></td><td>Провайдери, комбінації, інтеграція CLI, розгортання</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Віддалений режим</a></b></td><td>Керування віддаленим OmniRoute (VPS) із CLI вашого ноутбука через токени доступу з обмеженими областями</td></tr>
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">Конфігурація Claude Code</a></b></td><td>Підключення Claude Code до OmniRoute (локального/віддаленого) за допомогою <code>launch</code> + профілів для окремих моделей</td></tr>
  <tr><td nowrap><b><a href="README.md#-quick-start">Швидкий старт</a></b></td><td>3 кроки: установлення → підключення → налаштування</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/ops/VM_DEPLOYMENT_GUIDE.md">Розгортання на ВМ</a></b></td><td>Повний посібник: налаштування ВМ + nginx + Cloudflare</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/PWA_GUIDE.md">Посібник із PWA</a></b></td><td>Установлення прогресивного вебзастосунку, кешування, архітектура</td></tr>
  <tr><td nowrap><b><a href="docs/guides/UNINSTALL.md">Посібник із видалення</a></b></td><td>Повне видалення для всіх способів установлення</td></tr>
  <tr><td nowrap><b><a href="docs/reference/ENVIRONMENT.md">Конфігурація середовища</a></b></td><td>Повний перелік змінних <code>.env</code> і довідкових матеріалів</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_GUIDE.md">Посібник зі стиснення</a></b></td><td>Конвеєр із 7 варіантами: вимкнено / легкий / стандартний / агресивний / ультра / RTK / комбінований</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/architecture/RESILIENCE_GUIDE.md">Посібник із відмовостійкості</a></b></td><td>Автоматичні вимикачі, періоди очікування, черга, запобігання лавиноподібним запитам, підміна TLS</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/PROXY_GUIDE.md">Посібник із проксі</a></b></td><td>3-рівнева система проксі, маркетплейс 1proxy, CRUD реєстру</td></tr>
  <tr><td nowrap><b><a href="docs/reference/FREE_TIERS.md">Безкоштовні рівні</a></b></td><td>Зведений каталог: 34 задокументовані повторювані пули / 446 каталогізованих записів безкоштовного рівня</td></tr>
  <tr><td nowrap><b><a href="docs/guides/FEATURES.md">Галерея можливостей</a></b></td><td>Візуальний огляд панелі керування зі знімками екрана</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/ops/COVERAGE_PLAN.md">План покриття</a></b></td><td>Стратегія тестового покриття для понад 39 000 статичних оголошень тестів у понад 5 100 відстежуваних тестових файлах</td></tr>
</table>
...
> OmniRoute розвивається завдяки відданій спільноті відкритого коду. Ці люди зробили винятковий внесок, який безпосередньо впливає на якість, стабільність і поширення проєкту. **Дякуємо.**
...
<sub>Зафіксовано на актуальній верхівці <code>release/v3.8.50</code> — <code>dafb4ae808</code>, з урахуванням об’єднань до 2026-08-24 05:26:03 UTC. Посторінковий перепис через GitHub GraphQL містить 5,911 об’єднаних PR: 2,707 від власника репозиторію, 179 від Dependabot і <b>3,025 зовнішніх PR від 535 різних учасників</b>. «Змінені рядки» — це сума доданих і видалених рядків за даними GitHub, включно зі згенерованими файлами, lock-файлами, каталогами, перекладами та документацією; це обсяг змін, а не кількість авторських рядків коду. Нічиї на межі рейтингу збережено.</sub>
...
<table>
  <tr>
    <td align="center" width="160">
      ...
      <sub>🥇 220 комітів, атрибутованих GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🥈 219 комітів, атрибутованих GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🥉 108 комітів, атрибутованих GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🏅 81 коміт, атрибутований GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🏅 70 комітів, атрибутованих GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🏅 69 комітів, атрибутованих GitHub · спільне 6-те місце</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="160">
    ...
    <td align="center" width="160">
      ...
      <sub>🏅 64 коміти, атрибутовані GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🏅 62 коміти, атрибутовані GitHub</sub>
    </td>
    <td align="center" width="160">
      ...
      <sub>🏅 51 коміт, атрибутований GitHub · спільне 10-те місце</sub>
    </td>
    <td align="center" width="160">
...
<sub>Повторно перевірено 2026-08-24 о 06:14:31 UTC: коміти, атрибутовані GitHub, за даними API учасників репозиторію для стандартної гілки <code>release/v3.8.50</code>. API повернув 525 ідентичностей (415 користувачів, 2 боти, 108 анонімних); із цієї таблиці виключено супровідника проєкту, ботів та анонімні ідентичності, а однакові результати збережено. Вона відрізняється як від наведеного вище рейтингу об’єднаних PR, так і від наведеного нижче перепису 639 осіб за метаданими Git.</sub>

> 🙏 Функції, виправлення помилок і вдосконалення інфраструктури від цих учасників є **невіддільною частиною** того, що робить OmniRoute надійним і функціонально багатим. Кожен запит на злиття, кожен тестовий випадок і кожен файл перекладу i18n мають значення. Відкритий код створюють такі люди, як вони.
