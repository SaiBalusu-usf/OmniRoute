...
**ഉദ്ദേശ്യം:** അതേ പ്രൊവൈഡറിന്റെ മറ്റ് കണക്ഷനുകൾ സേവനം തുടരുമ്പോൾ, പ്രശ്നമുള്ള ഒരു കീ ഒഴിവാക്കുക.
...
**തണ്ടറിങ്-ഹേർഡ് പ്രതിരോധ ഗാർഡ്:** ഒരേസമയം സംഭവിക്കുന്ന പരാജയങ്ങൾ കൂൾഡൗൺ അമിതമായി ദീർഘിപ്പിക്കുന്നതോ `backoffLevel` രണ്ടുതവണ വർധിപ്പിക്കുന്നതോ തടയുന്നു.

**അന്തിമ അവസ്ഥകൾ (കൂൾഡൗണുകൾ അല്ല):**

- `banned` — നിരോധിത-കീവേഡ് / അക്കൗണ്ട്-ബാൻ കണ്ടെത്തൽ വഴി സജ്ജമാക്കുന്നു ([BAN_DETECTION](../security/BAN_DETECTION.md) കാണുക)
- `expired` (പരിമിതമായ പുനഃശ്രമങ്ങൾക്ക് ശേഷം അന്തിമ അവസ്ഥയിലേക്ക് മാറുന്നു — എക്സ്പോണൻഷ്യൽ ബാക്ക്ഓഫോടുകൂടിയ `EXPIRED_RETRY_MAX = 3` — അതിനാൽ അക്കൗണ്ട് ശാശ്വതമായി നിർജ്ജീവമാക്കുന്നതിന് മുമ്പ് താൽക്കാലിക OAuth പിശകുകൾക്ക് സ്വയം പരിഹരിക്കാനാകും)
- `credits_exhausted`

ക്രെഡൻഷ്യലുകൾ മാറുന്നതോ ഒരു ഓപ്പറേറ്റർ അവ റീസെറ്റ് ചെയ്യുന്നതോ വരെ ഇവ നിലനിൽക്കും. താൽക്കാലിക കൂൾഡൗൺ അവസ്ഥ ഉപയോഗിച്ച് അന്തിമ അവസ്ഥകൾ ഓവർറൈറ്റ് ചെയ്യരുത്.

**ലേസി റിക്കവറി:** `rateLimitedUntil` കഴിഞ്ഞാൽ, കണക്ഷൻ വീണ്ടും തിരഞ്ഞെടുക്കാൻ യോഗ്യമാകും. വിജയകരമായി ഉപയോഗിക്കുമ്പോൾ, `clearAccountError()` എല്ലാ പിശക് ഫീൽഡുകളും മായ്ക്കുന്നു.

### സെഷൻ അഫിനിറ്റി (#7274)

**പരിധി:** **ഏത്** പ്രൊവൈഡറിനും, ഒരു കണക്ഷനിലേക്ക് പിൻ ചെയ്തിരിക്കുന്ന ഒരൊറ്റ ക്ലയന്റ് സെഷൻ (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` ഹെഡർ).

**ഉദ്ദേശ്യം:** അഭ്യർത്ഥനകളിലുടനീളം ഒരു മൾട്ടി-ടേൺ ഏജന്റിനെ (Claude Code, aider, ഇഷ്ടാനുസൃത ഏജന്റുകൾ) അതേ അക്കൗണ്ടിൽ നിലനിർത്തുക; ഇതിലൂടെ അക്കൗണ്ടുകൾക്കിടയിലെ കോൺടെക്സ്റ്റ് നഷ്ടവും ഓരോ അക്കൗണ്ടിനും പ്രത്യേകമായ സെഷൻ സ്റ്റേറ്റുള്ള പ്രൊവൈഡറുകളിൽ ആവർത്തിക്കുന്ന കോൾഡ്-സ്റ്റാർട്ട് 429-കളും കുറയ്ക്കാം.
...
- സ്ഥിരമായി സൂക്ഷിക്കുന്ന പിൻ പട്ടിക: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- ക്രമീകരണം: `sessionAffinityTtlMs` (ms-ലുള്ള ഗ്ലോബൽ TTL, `0` പ്രവർത്തനരഹിതമാക്കുന്നു) — `src/lib/db/settings.ts`. Codex-ന് മാത്രമായിരുന്ന `codexSessionAffinityTtlMs` എന്നതിൽ നിന്ന് `124_generic_session_affinity_ttl.sql` മൈഗ്രേഷൻ വഴി പുനർനാമകരണം ചെയ്തു; മുമ്പ് ക്രമീകരിച്ചിരുന്ന ഏതെങ്കിലും Codex TTL-നെ ഇത് പുതിയ ഡിഫോൾട്ടായി കൈമാറുന്നു.

#7274-ന് മുമ്പ്, `codex` ഒഴികെയുള്ള എല്ലാ പ്രൊവൈഡറുകൾക്കും `resolveSessionAffinityTtlMs()` ഉടൻ `0` നൽകി പുറത്തുകടന്നിരുന്നു. അതിനാൽ പിൻ ചെയ്യൽ സംവിധാനവും ഹെഡർ എക്സ്ട്രാക്ഷനും ഇതിനകം പ്രൊവൈഡർ-അഗ്നോസ്റ്റിക് ആയിരുന്നിട്ടും, TTL ക്രമീകരണത്തിനും സെഷൻ ഹെഡറുകൾക്കും മറ്റൊരിടത്തും പ്രഭാവമുണ്ടായിരുന്നില്ല. പരിഹാരം ആ നേരത്തെയുള്ള റിട്ടേൺ നീക്കം ചെയ്തു; TTL ഗ്ലോബലായി `0`-ന് മുകളിൽ സജ്ജമാക്കിയാൽ, അത് ഇപ്പോൾ എല്ലാ പ്രൊവൈഡറുകൾക്കും ഒരേപോലെ ബാധകമാകും.

മൂന്ന് സെഷൻ-അഫിനിറ്റി ഹെഡറുകളും ഒരിക്കലും അപ്സ്ട്രീമിലേക്ക് ഫോർവേഡ് ചെയ്യില്ല — ക്ലയന്റ് ഹെഡറുകൾ കടത്തിവിടുന്നതിന് പകരം എക്സിക്യൂട്ടറുകൾ സ്വന്തം അപ്സ്ട്രീം ഹെഡറുകൾ ആദ്യം മുതൽ നിർമ്മിക്കുന്നു; അതിനാൽ ഇത് ആന്തരിക കോറിലേഷൻ ഐഡി മാത്രമായി തുടരുന്നു.

### എക്സ്ക്ലൂസീവ് മാനേജ്ഡ് സെഷൻ കണക്ഷൻ ലീസുകൾ

**പരിധി:** സജീവമായ ഒരു മാനേജ്ഡ് HTTP ക്ലയന്റ്/സെഷൻ, യോഗ്യമായ ഒരു OmniRoute കണക്ഷന്റെ ഉടമസ്ഥത വഹിക്കുന്നു.

**ഉദ്ദേശ്യം:** അഭ്യർത്ഥനകളിലുടനീളം കർശനമായ റൂട്ടിങ് അതിർത്തി ആവശ്യമുള്ള ക്ലയന്റുകൾക്ക് ദീർഘകാലം നിലനിൽക്കുന്ന എക്സ്ക്ലൂസീവ് കണക്ഷൻ ഉടമസ്ഥത നൽകുക. സോഫ്റ്റ് കണ്ടിന്യൂയിറ്റി മുൻഗണനയായ സെഷൻ അഫിനിറ്റിയിൽ നിന്ന് ഇത് വ്യത്യസ്തമാണ്: ഒരു എക്സ്ക്ലൂസീവ് ലീസ് SQLite-ൽ ലൈഫ്സൈക്കിൾ സ്റ്റേറ്റ് സ്ഥിരമായി സൂക്ഷിക്കുകയും, ഗ്ലോബൽ സജീവ-ഉടമയുടെയും സജീവ-കണക്ഷന്റെയും ഏകത്വം നിർബന്ധമാക്കുകയും, പ്രൊവൈഡർ ഡിസ്പാച്ചിന് മുമ്പ് കാലഹരണപ്പെട്ട ജനറേഷൻ നിരസിക്കുകയും ചെയ്യുന്നു.

ഈ ഫീച്ചർ ഓരോ API കീയ്ക്കും ഓപ്റ്റ്-ഇൻ രീതിയിലാണ്. ഒരു മാനേജ്ഡ് കീയ്ക്ക് `lease:exclusive` സ്കോപ്പും വ്യക്തമായി നൽകിയ ശൂന്യമല്ലാത്ത `allowedConnections` ലിസ്റ്റും ഉണ്ടായിരിക്കണം. ഏത് HTTP ക്ലയന്റിനും ലൈഫ്സൈക്കിൾ എൻഡ്പോയിന്റ് ഉപയോഗിക്കാം; ക്ലയന്റ് നാമം, യൂസർ-ഏജന്റ്, പ്രൊവൈഡർ, OAuth രീതി, അല്ലെങ്കിൽ മോഡൽ എന്നിവയൊന്നും ആവശ്യമില്ല. ലീസ് ഒരു കണക്ഷനെയാണ് സ്വന്തമാക്കുന്നത്, മോഡലിനെയല്ല; അതിനാൽ കണക്ഷൻ സാധാരണ രീതിയിൽ യോഗ്യമായി തുടരുന്നിടത്തോളം മോഡൽ മാറ്റിയാലും ബൈൻഡിങ് നിലനിൽക്കും. സാധാരണ മോഡൽ, ക്വോട്ട, ആരോഗ്യം, കൂൾഡൗൺ, അലൗലിസ്റ്റ് നിയമങ്ങൾ എന്നിവയ്ക്ക് തുടർന്നും ആധികാരികതയുണ്ടാകും; അവ അതേ ജനറേഷനെ മറ്റൊരു സ്വതന്ത്രവും യോഗ്യവുമായ കണക്ഷനിലേക്ക് മാറ്റിയേക്കാം.

ലൈഫ്സൈക്കിൾ `POST /api/v1/session-leases` ആണ്; ഇതിൽ `acquire`, `renew`, `release` എന്നീ JSON ആക്ഷനുകൾ ഉപയോഗിക്കുന്നു. മാനേജ്ഡ് ഇൻഫറൻസ് അഭ്യർത്ഥനകൾ അർത്ഥം വെളിപ്പെടുത്താത്ത `X-OmniRoute-Lease-Owner` മൂല്യവും കൃത്യമായ `X-OmniRoute-Lease-Generation`-ഉം നൽകുന്നു. ഉടമയുടെ മൂല്യം `vlo_`-യ്ക്ക് പിന്നാലെ 43 base64url പ്രതീകങ്ങൾ ചേർന്നതാണ്; അതിന്റെ SHA-256 ഹാഷ് മാത്രമാണ് സംഭരിക്കുന്നത്. ഓരോ അന്തിമ ഡിസ്പാച്ച് ഫെൻസും പ്രാമാണീകരിച്ച API കീ ഐഡിയെയും സജീവ കണക്ഷൻ ഐഡിയെയും കൂടി ബന്ധിപ്പിക്കുന്നു. ലീസ് നിയന്ത്രണ ഹെഡറുകൾ ലോഗുകൾ, നിലനിർത്തിയ അഭ്യർത്ഥന സ്നാപ്പ്ഷോട്ടുകൾ, അപ്സ്ട്രീം എക്സിക്യൂട്ടർ ഹെഡറുകൾ എന്നിവയിൽ നിന്ന് നീക്കം ചെയ്യുന്നു.

സാധാരണ റൂട്ടിങ്ങിൽ യോഗ്യമായ മാനേജ്ഡ് കാൻഡിഡേറ്റുകൾ ഉണ്ടായിട്ടും, സ്വതന്ത്രമായ എല്ലാ കാൻഡിഡേറ്റുകളും മറ്റൊരു സജീവ ലീസിന്റെ കൈവശമാണെങ്കിൽ, OmniRoute HTTP `429`, ലീസ്-ശേഷി-ലഭ്യമല്ല കോഡ്, ശേഷിക്കായി-കാത്തിരിക്കുന്നു എന്ന സ്റ്റേറ്റ്, ഏറ്റവും നേരത്തെ പ്രസക്തമായ കാലാവധി അവസാനിക്കുന്ന സമയം അടിസ്ഥാനമാക്കി പരിധിയിട്ട `Retry-After` എന്നിവ നൽകുന്നു. സാധാരണയായി യോഗ്യത ശൂന്യമാകുന്നത് ലീസ് തർക്കമല്ല; അതിന്റെ നിലവിലുള്ള റൂട്ടിങ് പിശക് സെമാന്റിക്സ് തന്നെ തുടരും.

ബന്ധപ്പെട്ട സംവിധാനങ്ങൾ വേറിട്ടുതന്നെ തുടരുന്നു:

- OAuth സെഷൻ ഒക്ക്യുപൻസി എന്നത് OAuth അക്കൗണ്ടുകൾക്കായുള്ള പ്രോസസ്-ലോക്കൽ സോഫ്റ്റ് ഡിസ്ട്രിബ്യൂഷനാണ്.
- അക്കൗണ്ട് സെമഫോറുകൾ അഭ്യർത്ഥന-കൺകറൻസി പെർമിറ്റുകൾ നൽകുകയും ഒരു അഭ്യർത്ഥന പൂർത്തിയാകുമ്പോൾ അവസാനിക്കുകയും ചെയ്യുന്നു.
- എക്സ്ക്ലൂസീവ് മാനേജ്ഡ് സെഷൻ ലീസുകൾ ജനറേഷൻ ഫെൻസോടുകൂടിയ, ദീർഘകാലം നിലനിൽക്കുന്ന ലൈഫ്സൈക്കിൾ ഉടമസ്ഥതയാണ്.

---

## 3. മോഡൽ ലോക്ക്ഔട്ട്

**പരിധി:** provider + connection + model ട്രിപ്പിൾ.

**ഉദ്ദേശ്യം:** ഒരു മോഡൽ മാത്രം ലഭ്യമല്ലാതിരിക്കുകയോ അതിന്റെ ക്വോട്ട പരിമിതപ്പെടുത്തിയിരിക്കുകയോ ചെയ്യുമ്പോൾ ഒരു മുഴുവൻ connection പ്രവർത്തനരഹിതമാക്കുന്നത് ഒഴിവാക്കുക.

**ഉദാഹരണങ്ങൾ:**

- ഓരോ മോഡലിനും പ്രത്യേകം ക്വോട്ടയുള്ള providers 429 മടക്കിനൽകുന്നത്
- ഒരു മോഡൽ ലഭ്യമല്ലാത്തപ്പോൾ local providers 404 മടക്കിനൽകുന്നത്
- Provider-നിർദ്ദിഷ്ട mode/model അനുമതി പരാജയങ്ങൾ (ഉദാ., Grok modes)

**നടപ്പാക്കൽ:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### മോഡൽ കൂൾഡൗൺസ് ഡാഷ്ബോർഡ് (v3.8.0)

UI: Settings → Model Cooldowns (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

സജീവമായ lockouts ഇനിപ്പറയുന്ന വിവരങ്ങളോടെ പട്ടികപ്പെടുത്തുന്നു: provider, connection, model, reason, expiresAt. Operators-ക്ക് card-ൽനിന്ന് ഒരു model സ്വമേധയാ വീണ്ടും പ്രവർത്തനക്ഷമമാക്കാം.

**REST API:**

- `GET /api/resilience/model-cooldowns` — സജീവമായ lockouts പട്ടികപ്പെടുത്തുക
- `DELETE /api/resilience/model-cooldowns` — സ്വമേധയാ വീണ്ടും പ്രവർത്തനക്ഷമമാക്കൽ. Body: `{provider, connection, model}`. Auth: management.

### ലോക്ക്ഔട്ട് ക്രമീകരണ UI + വിജയ-ക്ഷയ റിക്കവറി (v3.8.23)

Model lockout എപ്പോഴും പ്രവർത്തിക്കുന്ന hardcoded സ്വഭാവത്തിൽനിന്ന്, സ്വന്തമായ settings card-ഉം സ്വയം സുഖപ്പെടുന്ന recovery path-ഉം ഉള്ള, പൂർണ്ണമായി ക്രമീകരിക്കാവുന്ന opt-in സവിശേഷതയായി മാറി.

**ക്രമീകരണ card:** Settings → Model Lockout
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
ഇത് മുകളിലുള്ള read-only `ModelCooldownsCard`-ൽനിന്ന് **വ്യത്യസ്തമാണ്** (അത് സജീവമായ lockouts മാത്രം
_പട്ടികപ്പെടുത്തുന്നു_) — പുതിയ card _parameters ക്രമീകരിക്കുന്നു_. Defaults
`DEFAULT_MODEL_LOCKOUT_SETTINGS`-ൽ സ്ഥിതിചെയ്യുന്നു
(`src/lib/resilience/modelLockoutSettings.ts`):

| ക്രമീകരണം               | Default                          | അർത്ഥം                                                                    |
| ----------------------- | -------------------------------- | ------------------------------------------------------------------------- |
| `enabled`               | `false`                          | Master toggle — model lockout **സ്ഥിരസ്ഥിതിയിൽ ഓഫാണ്**.                   |
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | Model-ന്റെ പരിധിയിലുള്ള പരാജയമായി കണക്കാക്കുന്ന upstream statuses.        |
| `baseCooldownMs`        | `120_000` (120 s)                | ആദ്യ പരാജയത്തിനുള്ള പ്രാരംഭ lockout ദൈർഘ്യം.                              |
| `maxCooldownMs`         | `1_800_000` (30 min)             | വർധിപ്പിച്ച cooldown-ന്റെ പരമാവധി പരിധി.                                  |
| `maxBackoffSteps`       | `10`                             | Exponential-backoff വർധനവിന്റെ പരമാവധി ഘട്ടങ്ങൾ.                          |
| `useExponentialBackoff` | `true`                           | ആവർത്തിച്ചുള്ള പരാജയങ്ങൾ cooldown-നെ exponentially വർധിപ്പിക്കണമോ എന്നത്. |

Settings സാധാരണ settings store വഴി നിലനിർത്തുകയും
resilience settings schema വഴി സാധൂകരിക്കുകയും ചെയ്യുന്നു; card `baseCooldownMs`/`maxCooldownMs`
(`maxCooldownMs ≥ baseCooldownMs` എന്ന നിബന്ധനയോടെ), `maxBackoffSteps` എന്നിവ പരിധിക്കുള്ളിൽ നിർത്തുന്നു.

**വിജയ-ക്ഷയ റിക്കവറി:** recovery എന്നത് timer കാലാവധി കഴിയുന്നതിൽ മാത്രം അധിഷ്ഠിതമല്ല. ആരോഗ്യകരമായ
ഒരു response മോഡലിന്റെ failure count ക്രമേണ കുറയ്ക്കുന്നു; അതിനാൽ window-ന്റെ മധ്യേ recovered ആയ model-ന്റെ escalation നിർത്തുകയും അതിന്റെ timer അവസാനിക്കുന്നതിന് മുമ്പ് lockout clear ചെയ്യുകയും ചെയ്യുന്നു. വിജയകരമായ
combo target-ൽ, `open-sse/services/combo.ts` എന്നത് `decayModelFailureCount()`
(`open-sse/services/accountFallback.ts`) വിളിക്കുന്നു; ഇത് സംഭരിച്ചിരിക്കുന്ന
`failureCount`-നെ **പകുതിയാക്കുന്നു** (`Math.floor(failureCount / 2)`); അത് `0`-ൽ എത്തുമ്പോൾ lockout
entry പൂർണ്ണമായും ഇല്ലാതാക്കുന്നു. ഇതിന്റെ counterpart ആയ `recordModelLockoutFailure()`
escalation window-നുള്ളിൽ പരാജയങ്ങൾ സംഭവിക്കുമ്പോൾ count വർധിപ്പിക്കുകയും cooldown escalate ചെയ്യുകയും ചെയ്യുന്നു. ഈ success-decay സാധാരണ timer expiry-യ്ക്ക് പുറമേയുള്ളതാണ് —
ഈ രണ്ട് വഴികളിലേതിലൂടെയും ഒരു model വീണ്ടും പ്രവർത്തനക്ഷമമാക്കാം.

**State:** lockouts **in-memory** ആയാണ് സൂക്ഷിക്കുന്നത് (`provider:connectionId:model` പ്രകാരം key ചെയ്തിരിക്കുന്ന
`ModelLockoutEntry`-കളുടെ ഓരോ process-ലുമുള്ള `Map`-കൾ), DB-യിൽ persist ചെയ്യുന്നില്ല —
restart ചെയ്യുമ്പോൾ അവ നഷ്ടപ്പെടും. _Settings_ persist ചെയ്യപ്പെടുന്നു; സജീവമായ
lockout _state_ താൽക്കാലികമാണ്.
...
- ഒരു പ്രൊവൈഡറിന്റെ എല്ലാ കീകളും ഒഴിവാക്കപ്പെടുന്നു → സർക്യൂട്ട് ബ്രേക്കറിന്റെ നിലയും ഓരോ കണക്ഷന്റെയും `rateLimitedUntil`/`testStatus` എന്നിവയും പരിശോധിക്കുക.
- റീസെറ്റ് വിൻഡോയ്ക്ക് ശേഷം പ്രൊവൈഡർ ശാശ്വതമായി ഒഴിവാക്കപ്പെടുന്നു → `getStatus()`/`canExecute()` എന്നതിനുപകരം റോ `state` വായിക്കുന്ന കോഡ് പരിശോധിക്കുക.
- ഒരു കീ പരാജയപ്പെട്ടാലും മറ്റുള്ളവ പ്രവർത്തിക്കണം → സർക്യൂട്ട് ബ്രേക്കറിനുപകരം കണക്ഷൻ കൂൾഡൗണിന് മുൻഗണന നൽകുക.
- ഒരു മോഡൽ മാത്രം പരാജയപ്പെടുന്നു → കണക്ഷൻ കൂൾഡൗണിനുപകരം മോഡൽ ലോക്കൗട്ടിന് മുൻഗണന നൽകുക.
- നില സ്വയം പുനഃസ്ഥാപിക്കേണ്ടതാണെങ്കിലും അങ്ങനെ സംഭവിക്കുന്നില്ല → ഭാവിയിലെ ടൈംസ്റ്റാമ്പും കാലഹരണപ്പെട്ട നില പുതുക്കുന്ന റീഡ് പാത്തും പരിശോധിക്കുക. സ്ഥിരമായ സ്റ്റാറ്റസുകൾക്ക് മാനുവൽ മാറ്റങ്ങൾ ആവശ്യമാണ്.
