...
സ്ക്രിപ്റ്റുകൾ `scripts/check/` (നയ ഗേറ്റുകൾ), `scripts/quality/` (റാച്ചറ്റ് എഞ്ചിൻ) എന്നിവയ്ക്ക് കീഴിലാണ്.
CI-യുടെ ആധികാരിക സ്രോതസ്സ് `.github/workflows/ci.yml` ആണ്.

### റിലീസ് PR ഫാസ്റ്റ്-പാത്ത് (`quality.yml`)

`.github/workflows/quality.yml`, `release/**` ലക്ഷ്യമിടുന്ന PR-കളിൽ പ്രവർത്തിക്കുന്നു. പാത്ത്-ഫിൽട്ടർ ചെയ്ത ഫാസ്റ്റ് ഗേറ്റുകളും കോഡ്
മാറ്റങ്ങൾക്കായുള്ള ഒരു ഉപദേശാത്മക പ്രൊഡക്ഷൻ-ബിൽഡ് സിഗ്നലും ഉപയോഗിച്ച് കോൺട്രിബ്യൂട്ടർ
ബ്രാഞ്ചുകൾ മുന്നോട്ട് നീങ്ങുന്നത് ഇത് ഉറപ്പാക്കുന്നു:

| ജോബ്                                             | വ്യാപ്തി                                                                                                                                                                                                                                                                           | തടയൽ                                                                                                            |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `Build (advisory)`                               | ഡ്രാഫ്റ്റ് അല്ലാത്ത കോഡ് PR-കളും Mergify ക്യൂ ബ്രാഞ്ചുകളും; Node 24, `npm-ci-retry`, `check:node-runtime`, `OMNIROUTE_USE_TURBOPACK=1` ഉപയോഗിച്ചുള്ള `npm run build`; ഡൗൺസ്ട്രീം ഗുണനിലവാര ജോബുകളൊന്നും ഇത് ഉപയോഗിക്കാത്തതിനാൽ ആർട്ടിഫാക്റ്റ് അപ്ലോഡ് ഇല്ല                         | **ഉപദേശാത്മകം** (`continue-on-error: true`; സ്ഥിരതയുള്ള റിലീസ്-PR റണ്ണുകൾ ഒരാഴ്ച പൂർത്തിയായ ശേഷം നീക്കംചെയ്യുക) |
| `Docs Gates (fast-path)`                         | ഡോക്സ്/കോഡ് PR-കൾ; API ഡോക്സ് റഫറൻസുകളും docs-all-ഉം                                                                                                                                                                                                                               | അതെ                                                                                                             |
...
| `Forgotten sibling tests`                        | കോഡ് PR-കൾ; മാറ്റം വരുത്തിയ മൊഡ്യൂളുകളിൽനിന്ന് സ്റ്റാറ്റിക് കൺസ്യൂമർമാരിലേക്കും സാധ്യതയുള്ള സിബ്ലിങ് ടെസ്റ്റുകളിലേക്കും ട്രേസ് ചെയ്യുന്നു; ബാരലും ഡൈനാമിക്-ഇംപോർട്ട് പാത്തുകളും റഫറൻസ് ചെയ്ത അനുവദനീയ പട്ടികാ ഒഴിവാക്കലുകളോടെ ഉപദേശാത്മക ഡയഗ്നോസ്റ്റിക്സായി റിപ്പോർട്ട് ചെയ്യുന്നു | **ഉപദേശാത്മകം**                                                                                                 |
| `Vitest (fast-path)`                             | കോഡ് PR-കൾ; വേഗതയേറിയ vitest സ്യൂട്ട്                                                                                                                                                                                                                                              | അതെ                                                                                                             |
| `Unit Tests fast-path`                           | കോഡ് PR-കൾ; 4-ഷാർഡ് യൂണിറ്റ് സ്യൂട്ട്                                                                                                                                                                                                                                              | അതെ                                                                                                             |
| `No new ESLint warnings`                         | കോഡ് PR-കൾ; സപ്രഷൻ-അവെയർ ലിന്റ് ഗാർഡ്                                                                                                                                                                                                                                              | സ്വന്തം ഒറിജിനുകൾക്ക് അതെ, ഫോർക്കുകൾക്ക് ഉപദേശാത്മകം                                                            |
| `Merge integrity (changelog + generated skills)` | ഡ്രാഫ്റ്റ് അല്ലാത്ത PR-കൾ; ചേഞ്ച്ലോഗും ജനറേറ്റ് ചെയ്ത സ്കിൽ സമന്വയവും                                                                                                                                                                                                              | സ്വന്തം ഒറിജിനുകൾക്ക് അതെ, ഫോർക്കുകൾക്ക് ഉപദേശാത്മകം                                                            |
...
മാറ്റം വരുത്തിയ ഓരോ പ്രൊഡക്ഷൻ മൊഡ്യൂളിനും, സാധ്യതയുള്ള
ടെസ്റ്റ് പുൾ-റിക്വസ്റ്റ് ഡിഫിൽ ഇല്ലെങ്കിൽ നിർണായകമായ
`മാറ്റം വരുത്തിയ മൊഡ്യൂൾ/സിംബൽ -> സ്റ്റാറ്റിക് കൺസ്യൂമർ -> സാധ്യതയുള്ള സിബ്ലിങ് ടെസ്റ്റ്` ശൃംഖലകൾ ഇത് റിപ്പോർട്ട് ചെയ്യുന്നു. ഏതെങ്കിലും തടയൽ നടപ്പാക്കുന്നതിന് മുമ്പുള്ള കാലിബ്രേഷനായി
Markdown സംഗ്രഹവും JSON ഫലവും `forgotten-sibling-tests` വർക്ക്ഫ്ലോ ആർട്ടിഫാക്റ്റായി നിലനിർത്തുന്നു.

ബാരൽ റീ-എക്സ്പോർട്ടുകളും ഡൈനാമിക് ഇംപോർട്ടുകളും റിസല്യൂഷൻ ഡയഗ്നോസ്റ്റിക്സ് മാത്രമാണ്; അവ ഒരിക്കലും
തടയുന്ന കണ്ടെത്തലുകൾ സൃഷ്ടിക്കില്ല. അവലോകനം ചെയ്ത ഒഴിവാക്കലുകൾ
`config/quality/forgotten-sibling-allowlist.json`-ൽ സൂക്ഷിക്കുന്നു. ഓരോ എൻട്രിയിലും കൺസ്യൂമറും സാധ്യതയുള്ള
ടെസ്റ്റും വ്യക്തമാക്കുകയും, നിർദ്ദിഷ്ടമായ ന്യായീകരണം നൽകുകയും, ഒരു GitHub ഇഷ്യൂവിലേക്കോ പുൾ റിക്വസ്റ്റിലേക്കോ ലിങ്ക് ചെയ്യുകയും വേണം. തെറ്റായ ഘടനയിലുള്ള എൻട്രികൾ
ഫെയിൽ-ക്ലോസ്ഡ് ആകും. ഇല്ലാതാക്കിയ സാധ്യതയുള്ള ടെസ്റ്റിനെയോ `.skip`/`.todo` ചേർക്കുന്ന ഡിഫിനെയോ ഒഴിവാക്കലുകൾക്ക് മറയ്ക്കാനാകില്ല;
അസർഷൻ ദുർബലപ്പെടുത്തലും മറ്റ് മറച്ചുവെക്കലുകളും സ്വതന്ത്രമായി തടയുന്ന
`check:test-masking` ഗേറ്റിന്റെ ഉത്തരവാദിത്തമായി തുടരും.
...
| `check:route-validation:t06`      | എല്ലാ റൂട്ടുകളിലും Zod സ്കീമകൾ ഉണ്ടായിരിക്കുന്നു (ടയർ 6 നയം)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | അതെ                                     |
| `check:any-budget:t11`            | `@ts-expect-error // any` എണ്ണം അനുവദിച്ച പരിധി കവിയുന്നില്ല (ടയർ 11 catraca)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | അതെ                                     |
| `check:provider-consistency`      | `providers.ts`-ലെ ഓരോ provider-നും `providerRegistry.ts`-ൽ പൊരുത്തപ്പെടുന്ന ഒരു entry ഉണ്ട് (തിരിച്ചും, allowlist-ന്റെ പരിധിക്കുള്ളിൽ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ഉണ്ട്                                   |
| `check:model-lifecycle`           | കൈകൊണ്ട് പരിപാലിക്കുന്ന മൂന്ന് routing table-കൾ checked-in lifecycle snapshot-നോട് (#11503) പൊരുത്തപ്പെട്ടു തുടരുന്നു: `FITNESS_TABLE` (`taskFitness.ts`), `REGISTRY`-ക്ക് route ചെയ്യാനാകുന്ന retired id-കൾക്കൊന്നും score നൽകുന്നില്ല; എല്ലാ `BUILT_IN_ALIASES` target-ുകളും `REGISTRY`-ൽ ഉണ്ടായിരിക്കുകയും retired-id snapshot-ൽ ഇല്ലാതിരിക്കുകയും ചെയ്യുന്നു; `REGISTRY`-യിൽ ഇപ്പോഴും ഉള്ള എല്ലാ retired id-കളും forward ചെയ്യപ്പെട്ടതോ `allowedRetiredInCatalog`-ൽ പട്ടികപ്പെടുത്തിയതോ ആണ്; കൂടാതെ `DEFAULT_DEGRADATION_MAP`-ലെ source-കളോ target-ുകളോ ആ snapshot-ൽ retired ആയി കാണപ്പെടുന്നില്ല. ഒരു model നിലവിൽ live upstream വഴി നൽകപ്പെടുന്നുണ്ടെന്ന് ഇത് തെളിയിക്കുന്നില്ല. Offline — `config/quality/model-lifecycle.json`-നോട് താരതമ്യം ചെയ്യുന്നു; ഇത് `npm run quality:refresh-model-lifecycle` ഉപയോഗിച്ച് കൈകൊണ്ട് പുതുക്കുന്നു (network; CI-യുമായി ബന്ധിപ്പിച്ചിട്ടില്ല). `allowedRetiredInCatalog` ഒരു burn-down ratchet ആണ്: tracking issue ഉണ്ടെങ്കിൽ മാത്രം ഒരു entry ചേർക്കുക. | ഉണ്ട്                                   |
| `check:fetch-targets`             | client-side `src/`-ലെ ഓരോ `fetch("/api/...")`-ഉം യഥാർത്ഥ `route.ts`-ലേക്ക് resolve ചെയ്യുന്നു                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | ഉണ്ട്                                   |
| `check:deps`                      | repo-യിലെ ഓരോ `package.json`-ലുമുള്ള, `npm install` ചെയ്യാവുന്ന എല്ലാ dependency-കളും `dependency-allowlist.json`-ൽ ഉണ്ട്; പുതുതായി ചേർത്ത unpinned അല്ലെങ്കിൽ slopsquatted package-ുകൾ flag ചെയ്യപ്പെടുന്നു                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ഉണ്ട്                                   |
| `audit:deps`                      | `npm audit` (root + electron) — high/critical advisory-കൾ ഇല്ല (osv `check:vuln-ratchet`-മായി overlap ചെയ്യുന്നു; Rationalization Backlog കാണുക)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ഉണ്ട്                                   |
| `check:lockfile`                  | `package-lock.json` integrity — https registry, integrity hash-കൾ, host override-കൾ ഇല്ല                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | ഉണ്ട്                                   |
| `check:licenses`                  | പ്രൊഡക്ഷൻ ഡിപ്പൻഡൻസികൾക്കായുള്ള SPDX ലൈസൻസ് അനുവദനീയ പട്ടിക                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | അതെ                                     |
...
| `check:vitest-exclusions`         | ഓരോ Vitest ഒഴിവാക്കലും ഒരു ട്രാക്കിംഗ് ഇഷ്യൂവിനെ സൂചിപ്പിക്കുകയും `config/quality/vitest-exclusions.json`-ൽ പ്രത്യക്ഷപ്പെടുകയും ചെയ്യുന്നു (#13204)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | അതെ                                     |
| `check:file-size`                 | ഒരു സോഴ്സ് ഫയലും ഓരോ എക്സ്റ്റൻഷനുമുള്ള പരിധി കവിയുന്നില്ല (റാച്ചറ്റ്: `frozen` പട്ടികയിലെ ഫ്രീസ് ചെയ്ത വലിയ ഫയലുകൾ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | അതെ                                     |
| `check:error-helper`              | എക്സിക്യൂട്ടറുകൾ/ഹാൻഡ്ലറുകൾ എന്നിവയിലെ പിശക് പ്രതികരണങ്ങൾ `buildErrorBody()` / `sanitizeErrorMessage()` ഉപയോഗിക്കുന്നു (കർശന നിയമം #12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | അതെ                                     |
| `check:migration-numbering`       | മൈഗ്രേഷൻ SQL ഫയലുകൾ വിടവുകളോ തനിപ്പകർപ്പുകളോ ഇല്ലാതെ ക്രമാനുഗതമായി അക്കമിട്ടിരിക്കുന്നു                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | അതെ                                     |
...
| `check:db-rules`                  | `src/lib/db/` മൊഡ്യൂളുകൾക്ക് പുറത്ത് അസംസ്കൃത SQL ഇല്ല; `localDb.ts`-ൽ നിന്ന് ബാരൽ-ഇംപോർട്ടുകൾ ഇല്ല (കർശന നിയമങ്ങൾ #2/#5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | അതെ                                     |
| `check:known-symbols`             | അവയുടെ ഡിസ്പാച്ച് പട്ടികകളിൽ രജിസ്റ്റർ ചെയ്തിട്ടുള്ള പ്രൊവൈഡർ എക്സിക്യൂട്ടറുകൾ, റൂട്ടിംഗ് തന്ത്രങ്ങൾ, ട്രാൻസ്ലേറ്ററുകൾ എന്നിവ ഡിസ്കിലുള്ള ഫയലുകളുമായി പൊരുത്തപ്പെടുന്നു — അനാഥമായതോ പ്രഖ്യാപിക്കാത്തതോ ആയ സിംബലുകൾ ഇല്ല                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | അതെ                                     |
| `check:route-guard-membership`    | ചൈൽഡ് പ്രോസസ് സൃഷ്ടിക്കുന്ന ഓരോ റൂട്ടും `isLocalOnlyPath()` ഉപയോഗിച്ച് വർഗ്ഗീകരിച്ചിരിക്കുന്നു (കർശന നിയമങ്ങൾ #15/#17)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | അതെ                                     |
| `check:test-discovery`            | റിപ്പോയിലെ ഓരോ `*.test.ts` / `*.spec.ts` ഫയലും കുറഞ്ഞത് ഒരു ടെസ്റ്റ് റണ്ണറെങ്കിലും ശേഖരിക്കുന്നു (റാച്ചറ്റ്: `test-discovery-baseline.json`-ലെ അനാഥ പട്ടിക ചുരുങ്ങാൻ മാത്രമേ പാടുള്ളൂ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | അതെ                                     |
| `check:agent-skills-sync`         | ജനറേറ്റ് ചെയ്ത ഏജന്റ്-സ്കിൽസ് ആർട്ടിഫാക്റ്റുകൾ അവയുടെ സോഴ്സ് കാറ്റലോഗുമായി പൊരുത്തപ്പെടുന്നു (വ്യതിയാനമില്ല)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `check:provider-asset-provenance` | പ്രൊവൈഡർ ലോഗോകൾക്കും/അസറ്റുകൾക്കും രേഖപ്പെടുത്തിയ ഉറവിട എൻട്രിയുണ്ട്                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `lint:json`                       | JSON കോൺഫിഗറേഷൻ ഫയലുകൾ പാഴ്സ് ചെയ്യാനാകുകയും റിപ്പോസിറ്ററിയിലെ ലിന്റ് നിയമങ്ങൾ പാലിക്കുകയും ചെയ്യുന്നു                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `typecheck:core`                  | പിശകുകളില്ലാത്ത TypeScript കംപൈലേഷൻ (ഉപദേശക മുന്നറിയിപ്പുകൾ മാത്രം)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | അതെ                                     |
| `typecheck:noimplicit:core`       | കർശനമായ `noImplicitAny` — ഭാവിയെ മുൻനിർത്തിയുള്ളത്; നിലവിലുള്ള നിരവധി കോൾ സൈറ്റുകൾക്ക് ഇപ്പോഴും അനോട്ടേഷനുകൾ ആവശ്യമാണ്                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | **ഉപദേശകം** (`continue-on-error: true`) |
| `check:dashboard-typecheck`       | `src/app/(dashboard)/**`-ലേക്ക് പരിമിതപ്പെടുത്തിയ `tsc` (#7033) — `typecheck:core`-ന്റെ ശ്രദ്ധാപൂർവം തിരഞ്ഞെടുത്ത 27-ഫയൽ അനുവദനീയപട്ടികയിൽ dashboard TSX ഫയലുകളൊന്നും ഉൾപ്പെടുന്നില്ല, കൂടാതെ `next build` അതിനെ ഒരിക്കലും ടൈപ്പ്-ചെക്ക് ചെയ്യുന്നുമില്ല (`next.config.mjs`-ൽ `ignoreBuildErrors: true` സജ്ജീകരിച്ചിരിക്കുന്നു); അതിനാൽ അവിടെയുള്ള അനാഥമായ ഐഡന്റിഫയർ റിഗ്രഷനുകൾ (#6625/#6909) CI-യ്ക്ക് ദൃശ്യമായിരുന്നില്ല. മാറ്റങ്ങൾ സ്ഥിരപ്പെടുത്തിയ ഓരോ-ഫയലിനും/ഓരോ-TS-കോഡിനുമുള്ള എണ്ണത്തിന്റെ ബേസ്ലൈനുമായി (`config/quality/dashboard-typecheck-baseline.json`, `check:known-symbols`-ലേതിന് സമാനമായ കാലഹരണപ്പെട്ടവ നിർബന്ധമാക്കുന്ന രീതി) താരതമ്യം ചെയ്യുന്നു — ബേസ്ലൈനിലെ എണ്ണത്തിനപ്പുറമുള്ള പുതിയ പിശകുകൾ മാത്രമേ ഗേറ്റ് പരാജയപ്പെടുത്തൂ; നിലവിലുള്ള ഒരു പിശക് പരിഹരിക്കുമ്പോൾ `--update` ഉപയോഗിച്ച് ബേസ്ലൈൻ കുറയ്ക്കുക.                                                                                                                                                                    | അതെ                                     |

### ജോലി: `quality-gate`

`test-coverage`-ന് ശേഷം പ്രവർത്തിക്കുന്നു. പരാജയപ്പെട്ടാൽ ലയിപ്പിക്കൽ തടയുന്നു.

| സ്ക്രിപ്റ്റ്                 | സാധൂകരിക്കുന്നത്                                                                                                                                                                                                               | തടയുന്നത്                      |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------ |
| `quality:collect`            | `quality-metrics.json` സൃഷ്ടിക്കുന്നു (ESLint മുന്നറിയിപ്പ് എണ്ണം, ലയിപ്പിച്ച ഷാർഡ് റിപ്പോർട്ടിൽ നിന്നുള്ള കവറേജ്)                                                                                                             | അതെ (റാച്ചറ്റിന്റെ അപ്സ്ട്രീം) |
| `quality:ratchet`            | `quality-baseline.json`-ലെ ഓരോ മെട്രിക്കും പിന്നോട്ടുപോയിട്ടില്ല (ESLint മുന്നറിയിപ്പുകൾ ≤ ബേസ്ലൈൻ; കവറേജ് ≥ ബേസ്ലൈൻ)                                                                                                          | അതെ                            |
| `check:duplication`          | കോഡ് ഡ്യൂപ്ലിക്കേഷൻ (jscpd@4) `quality-baseline.json`-ലെ ബേസ്ലൈൻ കവിയുന്നില്ല                                                                                                                                                  | അതെ                            |
| `check:complexity`           | ഫയൽതല സൈക്ലോമാറ്റിക് സങ്കീർണ്ണത പരിധി കവിയുന്നില്ല (കോർ ESLint `complexity` + `max-lines-per-function`)                                                                                                                        | അതെ                            |
| `check:cognitive-complexity` | കോഗ്നിറ്റീവ് സങ്കീർണ്ണത റാച്ചറ്റ് (`eslint-plugin-sonarjs`) — പ്രത്യേക ESLint പാസ്; CI രണ്ടും ലയിപ്പിച്ച് ഒറ്റ `check:complexity-ratchets` ഘട്ടമായി പ്രവർത്തിപ്പിക്കുന്നു                                                      | അതെ                            |
| `check:dead-code`            | ഉപയോഗിക്കാത്ത എക്സ്പോർട്ടുകൾ / ഫയലുകൾക്കായുള്ള റാച്ചറ്റ് (knip) ബേസ്ലൈനുമായി താരതമ്യപ്പെടുത്തുമ്പോൾ പിന്നോട്ടുപോകുന്നില്ല                                                                                                      | അതെ                            |
| `check:compression-budget`   | കംപ്രഷൻ ബെഞ്ച്മാർക്ക് ബജറ്റ് — ഓരോ എൻജിനിലുമുള്ള ടോക്കൺ ലാഭത്തിന്റെ കുറഞ്ഞ പരിധികൾ പിന്നോട്ടുപോകരുത്                                                                                                                           | അതെ                            |
| `check:type-coverage`        | ടൈപ്പ് ചെയ്ത ശതമാനത്തിനുള്ള റാച്ചറ്റ് (`type-coverage`) പിന്നോട്ടുപോകുന്നില്ല; പ്രധാനമായും `typecheck:noimplicit:core`-നെ ഉൾക്കൊള്ളുന്നു                                                                                       | അതെ                            |
| `check:codeql-ratchet`       | തുറന്നിരിക്കുന്ന CodeQL അലേർട്ടുകളുടെ എണ്ണം പിന്നോട്ടുപോകുന്നില്ല (`gh api` വഴി വായിക്കുന്നു; ടോക്കൺ ഇല്ലെങ്കിൽ പ്രശ്നമില്ലാതെ ഒഴിവാക്കുന്നു) — പുതുക്കൽ ഇടവേളയ്ക്കും മാനുവൽ ട്രിഗറിനുമായി: താഴെയുള്ള "CodeQL റാച്ചറ്റ്" കാണുക | അതെ                            |

### ജോലി: `quality-extended`

മുഴുവൻ ജോബും ഉപദേശാത്മകമാണ് (`continue-on-error: true`). npm അടിസ്ഥാനമാക്കിയുള്ള റാച്ചറ്റുകൾ
യഥാർത്ഥത്തിൽ പ്രവർത്തിക്കുന്നു; ബാഹ്യ സ്കാനറുകൾ `gh release download` വഴി ഇൻസ്റ്റാൾ ചെയ്യപ്പെടുകയും
...
| `check:bundle-size`      | ബണ്ടിൽ വലുപ്പം പരിധി കവിയുന്നില്ലെന്ന്                                                                                                                                                                                                                    | **ഉപദേശാത്മകം**      |
...
| `check:openapi-breaking` | അടിസ്ഥാന ബ്രാഞ്ചുമായി താരതമ്യം ചെയ്യുമ്പോൾ പൊതു API കരാറിൽ (`openapi.yaml`) ബ്രേക്കിങ് മാറ്റങ്ങളില്ലെന്ന് (oasdiff) — `openapiBreaking=N` പുറപ്പെടുവിക്കുന്നു; oasdiff ലഭ്യമല്ലെങ്കിലോ അടിസ്ഥാന സ്പെസിഫിക്കേഷൻ പരിഹരിക്കാനാകുന്നില്ലെങ്കിലോ ഒഴിവാക്കുന്നു | **ഉപദേശാത്മകം**      |

### ജോബ്: `docs-sync-strict`

`main`-ലേക്കുള്ള ഓരോ PR-ലും പ്രവർത്തിക്കുന്നു. പരാജയപ്പെട്ടാൽ മെർജ് തടയുന്നു.

| സ്ക്രിപ്റ്റ്                   | സാധൂകരിക്കുന്നത്                                                                                                                                                                            | തടസ്സപ്പെടുത്തുന്നത്        |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| `check:docs-all`               | താഴെയുള്ള 6 ഉപ-ഗേറ്റുകൾ ക്രമമായി പ്രവർത്തിപ്പിക്കുന്ന മെറ്റാ-ഗേറ്റ്                                                                                                                         | അതെ                         |
| ↳ `check:docs-sync`            | CHANGELOG / OpenAPI / llm.txt പതിപ്പുകളുടെ സ്ഥിരത                                                                                                                                           | അതെ                         |
| ↳ `check:docs-counts`          | ഗദ്യത്തിലെ എണ്ണങ്ങൾ (പ്രൊവൈഡർമാരുടെ എണ്ണം, മൈഗ്രേഷനുകളുടെ എണ്ണം തുടങ്ങിയവ) യഥാർത്ഥ എണ്ണങ്ങളുടെ റാച്ചറ്റ് പരിധിക്കുള്ളിലാണെന്ന്                                                              | അതെ                         |
| ↳ `check:env-doc-sync`         | `.env.example`-ലെ ഓരോ env var-ഉം ഡോക്സ് പട്ടികയിൽ രേഖപ്പെടുത്തിയിട്ടുണ്ടെന്നും തിരിച്ചും അങ്ങനെതന്നെയാണെന്നും                                                                               | അതെ                         |
...
| ↳ `check:fabricated-docs`      | ഡോക്സിൽ പരാമർശിച്ചിട്ടുള്ള റൂട്ടുകൾ, env vars, CLI കമാൻഡുകൾ, ഹുക്ക് പേരുകൾ, ഫയൽ പാതകൾ എന്നിവ കോഡ്ബേസിൽ നിലവിലുണ്ടെന്ന്. `--strict` വഴിയുള്ള ഹാർഡ് ഗേറ്റ്; ഫ്ലാഗ് ഇല്ലെങ്കിൽ സോഫ്റ്റ്-ഫെയിൽ. | അതെ (CI-യിൽ `--strict` വഴി) |
| `check:cli-i18n`               | CLI കമാൻഡ് സ്ട്രിങ്ങുകൾ എല്ലാ i18n ലോക്കേൽ ഫയലുകളിലും ഉണ്ടെന്ന്                                                                                                                             | അതെ                         |
| `check:openapi-coverage`       | OpenAPI സ്പെസിഫിക്കേഷൻ യഥാർത്ഥ റൂട്ടുകളുടെ റാച്ചറ്റ് ചെയ്ത ഏറ്റവും കുറഞ്ഞ പരിധിയെങ്കിലും ഉൾക്കൊള്ളുന്നുവെന്ന്                                                                               | അതെ                         |
| `check:openapi-security-tiers` | `openapi.yaml`-ലെ സുരക്ഷാ ടയർ വ്യാഖ്യാനങ്ങൾ `routeGuard.ts` വർഗ്ഗീകരണങ്ങളുമായി പൊരുത്തപ്പെടുന്നുവെന്ന്                                                                                      | **ഉപദേശാത്മകം**             |
| `check:openapi-routes`         | `openapi.yaml`-ലെ ഓരോ പാതയും യഥാർത്ഥ `route.ts`-ലേക്ക് പരിഹരിക്കപ്പെടുന്നുവെന്ന് (ഭ്രമസൃഷ്ടി തടയൽ)                                                                                          | അതെ                         |
| `check:docs-symbols`           | `docs/**/*.md`-ലെ ഓരോ `/api/...` പരാമർശവും യഥാർത്ഥ `route.ts`-ലേക്ക് പരിഹരിക്കപ്പെടുന്നുവെന്ന് (ഭ്രമസൃഷ്ടി തടയൽ)                                                                            | അതെ                         |
| `i18n` വിവർത്തന വ്യതിചലനം      | i18n ലോക്കേൽ ഫയലുകളിലെ വിവർത്തനം ചെയ്യാത്ത കീകൾ — മുന്നറിയിപ്പ് മാത്രം                                                                                                                      | **ഉപദേശാത്മകം**             |

### ജോബ്: `i18n-ui-coverage`

| സ്ക്രിപ്റ്റ്                     | സാധൂകരിക്കുന്നത്                                                                                                                                                                                       | തടയുന്നത്       |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- |
| `check-ui-keys-coverage` (ഇൻലൈൻ) | UI i18n കീ കവറേജ് ≥ 65% ആണ്                                                                                                                                                                            | അതെ             |
| `check-ui-value-drift` (ഇൻലൈൻ)   | തിരുത്തിയെഴുതിയ ഇംഗ്ലീഷ് **മൂല്യം** പഴകിയ വിവർത്തനങ്ങളൊന്നും അവശേഷിപ്പിക്കുന്നില്ല                                                                                                                     | അതെ             |
| `check-new-key-coverage` (ഇൻലൈൻ) | ഒരു **പുതിയ** ഇംഗ്ലീഷ് കീ എല്ലാ ലൊക്കേലുകളിലും എത്തുന്നു                                                                                                                                               | അതെ             |
| `check-translation-ratio`        | ഓരോ ലൊക്കേലിലുമുള്ള യഥാർഥ വിവർത്തന അനുപാതം (ഇംഗ്ലീഷിന് സമാനമായവ / പ്ലെയ്സ്ഹോൾഡർ / അനുവദനീയ പട്ടികയ്ക്ക് പുറത്തുള്ള നഷ്ടപ്പെട്ട ലീഫുകൾ) `config/quality/i18n-translation-baseline.json` + ഇളവ് കവിയരുത് | **ഉപദേശാത്മകം** |

`fetch-depth: 0` ആവശ്യമാണ് — മൂല്യ-ഡ്രിഫ്റ്റ് ഗേറ്റ്, മെർജ് ബേസുമായി `en.json`-ന്റെ വ്യത്യാസം പരിശോധിക്കുന്നു.

#### `check-ui-value-drift` — പഴകിയ വിവർത്തന ഗേറ്റ്

മറ്റ് ഗേറ്റുകൾക്ക് ഘടനാപരമായി കണ്ടെത്താനാകാത്ത ഒരേയൊരു i18n റിഗ്രഷൻ ഇത് കണ്ടെത്തുന്നു: ഒരു ഇംഗ്ലീഷ് മൂല്യം
തിരുത്തിയെഴുതുമ്പോൾ, _മുമ്പത്തെ_ ഇംഗ്ലീഷിൽനിന്ന് ഉരുത്തിരിഞ്ഞ വിവർത്തനങ്ങൾ മാറ്റമില്ലാതെ അവശേഷിക്കുകയും
ഇംഗ്ലീഷ് ഇതര ഉപയോക്താക്കൾ ആത്മവിശ്വാസത്തോടെ എഴുതിയിട്ടുള്ളതും ഇപ്പോൾ തെറ്റായതുമായ ഉള്ളടക്കം തുടർന്നും വായിക്കുകയും ചെയ്യുന്നു.

ഇത് യഥാർഥത്തിൽ റിലീസ് ചെയ്യപ്പെട്ടു. Antigravity ലോഗിൻ സഹായി ചേർത്തപ്പോൾ (#5203)
`oauthModal.googleOAuthWarning` തിരുത്തിയെഴുതി; **43 ലൊക്കേലുകളിൽ 39 എണ്ണവും**, ഓപ്പറേറ്റർമാരോട് "പൂർണ്ണ
URL പകർത്തി താഴെ ഒട്ടിക്കുക" എന്ന് പറയുന്ന വാചകം നിലനിർത്തി — ആ പ്രൊവൈഡറിൽ പൂർത്തിയാക്കാനാകാത്ത ഒരു പ്രവാഹമാണത്. ഇത്
#8463 വരെ ശ്രദ്ധിക്കപ്പെടാതെ പോയത് ഇനിപ്പറയുന്ന കാരണങ്ങളാലാണ്:

- `sync-ui-keys`, **ഇല്ലാത്ത** കീകൾ മാത്രമേ ബാക്ക്ഫിൽ ചെയ്യൂ; **പഴകിയ** കീകളെ ഒരിക്കലും ചെയ്യില്ല;
- `check-ui-keys-coverage` കീയുടെ _സാന്നിധ്യം_ കണക്കാക്കുന്നതിനാൽ, പഴകിയ വിവർത്തനവും ഉൾപ്പെടുത്തിയതായി കണക്കാക്കപ്പെടുന്നു;
- `check-translation-drift`, `docs/i18n/<locale>/**.md` ഡോക്യുമെന്റേഷൻ മിററുകളെയാണ് ട്രാക്ക് ചെയ്യുന്നത് —
  അത് ഒരിക്കലും `src/i18n/messages/*.json` വായിക്കുന്നില്ല. 2026-09 പുനഃസമന്വയം മുതൽ `docs-sync-strict` ജോബിൽ
  തടയുന്നു: ഒരു പ്രധാന ഡോക്യുമെന്റ് തിരുത്തുക → `npm run i18n:run -- --files=<doc>` (വിഭാഗ-തലത്തിൽ, ചെലവ് കുറവ്).

**ഡിഫ്-അവബോധമുള്ളത്, ബേസ്ലൈനിനെ അടിസ്ഥാനമാക്കിയുള്ളതല്ല.** മെർജ് ബേസിലെ `en.json`-നെ
വർക്കിങ് ട്രീയുമായി ഇത് താരതമ്യം ചെയ്യുന്നു; ഇംഗ്ലീഷ് മൂല്യം മാറിയ ഓരോ കീയ്ക്കും, മാറ്റമില്ലാത്ത
വിവർത്തനം ഇപ്പോഴും സൂക്ഷിക്കുന്ന ഏത് ലൊക്കേലും പഴകിയതാണ്. ഇത് മനഃപൂർവം **നിലവിലുള്ള കടം മരവിപ്പിക്കുന്നു** — ദീർഘകാലമായി
നിലനിൽക്കുന്ന ഒരു വിവർത്തനം ഏത് പഴയ ഇംഗ്ലീഷിൽനിന്നാണ് വന്നതെന്ന് ഒരു ഡിഫിന് വെളിപ്പെടുത്താനാകില്ല; അതിനാൽ നിലവിലെ മാറ്റം
സ്പർശിക്കുന്നവയെ മാത്രമാണ് ഗേറ്റ് വിലയിരുത്തുന്നത്. പകരമുള്ള മാർഗമായ ഓരോ കീയ്ക്കുമുള്ള ഹാഷ് ബേസ്ലൈനിന്
ഏകദേശം 600 KB വരുന്ന ഒരു ജനറേറ്റുചെയ്ത ഫയൽ ആവശ്യമായി വരും; അത് നിലവിലുള്ള ഏറ്റവും വലിയ ബേസ്ലൈനിന്റെ 3 മടങ്ങാണ്, കൂടാതെ ഓരോ i18n PR-ലും മാറ്റപ്പെടുകയും ചെയ്യും.

ഇത് വിജയിപ്പിക്കാൻ രണ്ട് മാർഗങ്ങളുണ്ട്:

1. ബാധിക്കപ്പെട്ട വിവർത്തനങ്ങൾ അപ്ഡേറ്റ് ചെയ്യുക, അല്ലെങ്കിൽ
2. അവയെ `__MISSING__:<new english>` ആയി സജ്ജമാക്കുക — തുടർന്ന് റൺടൈം തിരുത്തിയ ഇംഗ്ലീഷ് നൽകുകയും
   (`src/i18n/request.ts::deepMergeFallback`, #7258) കീ വിവർത്തനത്തിനായി ക്യൂവിൽ ചേരുകയും ചെയ്യും.

സ്ട്രിങ്ങിന്റെ **അർഥം** മാറിയിട്ടുണ്ടെങ്കിൽ, **കീയുടെ പേര് മാറ്റുന്നതാണ്** അഭികാമ്യം: ഒരു പുതിയ കീയ്ക്ക്
പഴകിയ വിവർത്തനം പാരമ്പര്യമായി ലഭിക്കാനാകില്ല. #8463 ഉപയോഗിച്ച മാതൃക അതാണ്.
...
അടിസ്ഥാന കാറ്റലോഗ് വായിക്കാൻ കഴിയാത്തപ്പോൾ (ബേസ് ref ഇല്ലാത്ത ഷാലോ
ക്ലോൺ), `check-openapi-breaking`-നെ അനുകരിച്ച് `SKIP reason=base-unresolved` സഹിതം 0-ൽ എക്സിറ്റ് ചെയ്യുന്നു.

### ജോബ്: `i18n`

പൂർണ്ണ i18n സാധൂകരണ മാട്രിക്സ് (ഓരോ ലൊക്കേലിനും ഒരു ജോബ്). മുഴുവൻ ജോബും ഉപദേശാത്മകമാണ്.

| സ്ക്രിപ്റ്റ്                    | സാധൂകരിക്കുന്നത്                    | തടയുന്നത്                                                  |
| ------------------------------- | ----------------------------------- | ---------------------------------------------------------- |
| `validate_translation.py quick` | ഓരോ ലൊക്കേലിലെയും വിവർത്തന സമ്പൂർണത | **ഉപദേശാത്മകം** (മുഴുവൻ ജോബിലും `continue-on-error: true`) |

### ജോബ്: `pr-test-policy`

പുൾ റിക്വസ്റ്റുകളിൽ മാത്രം പ്രവർത്തിക്കുന്നു.

| സ്ക്രിപ്റ്റ്           | സാധൂകരിക്കുന്നത്                                                                                                                                                     | തടയുന്നത് |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `check:pr-test-policy` | `src/`, `open-sse/`, `electron/`, അല്ലെങ്കിൽ `bin/` എന്നിവയിലെ പ്രൊഡക്ഷൻ കോഡ് മാറ്റുന്ന PR-ുകളിൽ ടെസ്റ്റുകൾ ഉൾപ്പെടുത്തുകയോ അപ്ഡേറ്റ് ചെയ്യുകയോ വേണം (കർശന നിയമം #8) | അതെ       |
| `check:test-masking`   | മാറ്റിയ ടെസ്റ്റ് ഫയലുകൾ മൊത്തം അസേർട്ട് എണ്ണം കുറയ്ക്കുകയോ `assert.ok(true)` പോലുള്ള സ്വയംസിദ്ധ പ്രസ്താവനകൾ ചേർക്കുകയോ ചെയ്യുന്നില്ല                                 | അതെ       |
| `check:pr-evidence`    | മാറ്റത്തിനായുള്ള ടെസ്റ്റ്/VPS തെളിവ് PR ബോഡിയിൽ ഉദ്ധരിക്കുന്നു (PR ഗദ്യം grep ചെയ്തുകൊണ്ട് കർശന നിയമം #18 യാന്ത്രികമാക്കുന്നു — ദുർബലമാണ്, Backlog കാണുക)            | അതെ       |

### ജോബ്: `test-vitest`

`build`-ന് ശേഷം പ്രവർത്തിക്കുന്നു. പരാജയപ്പെട്ടാൽ മെർജ് തടയുന്നു.

| സ്യൂട്ട്         | സാധൂകരിക്കുന്നത്                                       | തടസ്സപ്പെടുത്തുന്നത്                                                                                                                      |
| ---------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `test:vitest`    | MCP സെർവർ (110 ടൂളുകൾ), autoCombo, കാഷെ — vitest റണ്ണർ | അതെ                                                                                                                                       |
| `test:vitest:ui` | UI ഘടക പരിശോധനകൾ — vitest റണ്ണർ                        | **തടസ്സപ്പെടുത്തുന്നു** — നിലവിലുള്ള പരാജയങ്ങൾ `vitest.config.ts`-ൽ വ്യക്തമായി ഒഴിവാക്കിയിട്ടുണ്ട്; പുതിയ പരാജയങ്ങൾ ജോബ് പരാജയപ്പെടുത്തും |

### രാത്രികാല വർക്ക്ഫ്ലോകൾ (ഷെഡ്യൂൾ ചെയ്തവ, ഉപദേശാത്മകം)

ഇവ cron ഷെഡ്യൂൾ പ്രകാരവും (`workflow_dispatch` വഴിയും) പ്രവർത്തിക്കുന്നു, PR-കളിൽ ഒരിക്കലും പ്രവർത്തിക്കില്ല. എല്ലാം ഉപദേശാത്മകമാണ്.

| വർക്ക്ഫ്ലോ             | സാധൂകരിക്കുന്നത്                                                                                                                                                                                   | തടസ്സപ്പെടുത്തുന്നത് |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| `nightly-property`     | റാൻഡം സീഡും ഉയർന്ന റൺ എണ്ണവുമുള്ള fast-check പ്രോപ്പർട്ടി പരിശോധനകൾ                                                                                                                                | **ഉപദേശാത്മകം**      |
| `nightly-resilience`   | ഹീപ്പ്-വളർച്ചാ ഗേറ്റ്, കേയോസ് ഫോൾട്ട്-ഇൻജക്ഷൻ, k6 ലോഡ്/സോക്ക് പരിശോധനകൾ                                                                                                                            | **ഉപദേശാത്മകം**      |
| `nightly-llm-security` | promptfoo ഇൻജക്ഷൻ ഗാർഡ് (ബ്ലോക്ക് മോഡ്) + garak പ്രോബുകൾ (പ്രൊവൈഡർ സീക്രട്ട് ഇല്ലെങ്കിൽ ഒഴിവാക്കപ്പെടും)                                                                                           | **ഉപദേശാത്മകം**      |
| `nightly-schemathesis` | `docs/openapi.yaml` ഉപയോഗിച്ച് പ്രവർത്തനക്ഷമമായ OmniRoute-നെതിരെയുള്ള OpenAPI കോൺട്രാക്ട് ഫസിങ് (schemathesis) — സ്പെക് ലംഘനങ്ങൾ / കൈകാര്യം ചെയ്യാത്ത 500 പിശകുകൾ വെളിപ്പെടുത്തുന്നു (ഘട്ടം 8 B.4) | **ഉപദേശാത്മകം**      |
| `nightly-mutation`     | വേഗമേറിയ യൂണിറ്റ് ലെയിനിലെ Stryker മ്യൂട്ടേഷൻ-ടെസ്റ്റിങ് സ്കോർ — അതിജീവിക്കുന്ന മ്യൂട്ടന്റുകൾ ദുർബലമായ അസേർട്ടുകൾ വെളിപ്പെടുത്തുന്നു                                                               | **ഉപദേശാത്മകം**      |
...
- സപ്ലൈ ചെയിൻ (ഉത്ഭവവിവരം, SBOM, Trivy, Scorecard): [`docs/security/SUPPLY_CHAIN.md`](../security/SUPPLY_CHAIN.md)

#### `check-key-completeness` — കീ-സെറ്റ് സമത്വ ഗേറ്റ്
...
കീ എപ്പോൾ ചേർത്തതാണെന്നത് പരിഗണിക്കാതെ, ഏതെങ്കിലും ലീഫ് ഇല്ലാതിരിക്കുകയോ അധികമായിരിക്കുകയോ ചെയ്താൽ പരാജയപ്പെടുകയും ചെയ്യുന്നു.
`__MISSING__:` പ്ലേസ്ഹോൾഡറുകൾ നിലവിലുള്ളവയായി കണക്കാക്കുന്നു (അവയുടെ ഉള്ളടക്കം റേഷ്യോ ഗേറ്റിന്റെ പരിധിയിലാണ്).
രണ്ട് ഡിഫ്-അധിഷ്ഠിത/ശതമാന ഗേറ്റുകളുടെയും സമ്പൂർണ്ണ പൂരകമാണിത്: `check-ui-keys-coverage` ഓരോ
ലൊക്കേലിനും 80 % എന്ന കുറഞ്ഞ പരിധി നിർബന്ധമാക്കുന്നു (~13,000 കീകളിൽ 43 എണ്ണം ഇല്ലെങ്കിലും ഇപ്പോഴും 99.7 % എന്നാണ് കാണിക്കുക);
`check-new-key-coverage` ആകട്ടെ, ഒരു PR `en.json`-ലേക്ക് ചേർക്കുന്ന കീകൾ മാത്രമാണ് പരിശോധിക്കുന്നത്. ഒരു ലൊക്കേൽ ബാച്ചിന്റെ
ബ്രാഞ്ച് സൃഷ്ടിക്കുന്ന ദിവസത്തെ `en.json`-ൽനിന്നാണ് അത് ജനറേറ്റ് ചെയ്യുന്നത്; ബേസ് തുടർച്ചയായി കീകൾ ചേർക്കുമ്പോൾ നിരവധി ദിവസങ്ങളിലായി
വിവർത്തനം തുടരുന്നു. ബാച്ച് PR സ്വയം ഒരു കീയും ചേർക്കാത്തതിനാൽ, ബാച്ച് 1 (#13044) ഒൻപത് ലൊക്കേലുകളിൽ 43 കീകൾ
കുറവോടെ ലാൻഡ് ചെയ്തപ്പോഴും, ബാച്ച് 2 (#13660) എട്ട് ലൊക്കേലുകളിൽ 10 കീകൾ കുറവോടെ ലാൻഡ് ചെയ്തപ്പോഴും
(2026-09-15), ബന്ധപ്പെട്ട രണ്ട് ഗേറ്റുകളും നിശ്ശബ്ദമായി തുടർന്നു. പരാജയം പരിഹരിക്കാൻ
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers` ഉപയോഗിക്കുക; ഒരു `extra` ലീഫ്
എന്നാൽ സോഴ്സിൽനിന്ന് അത് നീക്കംചെയ്തുവെന്നാണ് അർത്ഥം — ലൊക്കേലിൽനിന്നും അത് ഇല്ലാതാക്കുക.
`--warn` പരാജയപ്പെടുത്താതെ റിപ്പോർട്ട് ചെയ്യുന്നു.
`--catalog=cli`, `bin/cli/locales`-ൽ ഇതേ താരതമ്യം നടത്തുന്നു (`npm run i18n:check-keys:cli`);
രണ്ട് ഘട്ടങ്ങളും `i18n-ui-coverage` ജോലിയിലാണ്.

#### `check-new-key-coverage` — പുതിയ കീയ്ക്കുള്ള i18n ഗേറ്റ്

`check-ui-value-drift`-ന്റെ സഹോദര ഗേറ്റ്. വിവർത്തനങ്ങൾ പുതുക്കാതെ ഒരു ഇംഗ്ലീഷ് മൂല്യം
**മാറ്റിയെഴുതിയാൽ** അതിനെ ആ ഗേറ്റ് കണ്ടെത്തുന്നു; ഒരു ഇംഗ്ലീഷ് കീ **ചേർത്തിട്ടും** ചില ലൊക്കേലുകൾക്ക്
അത് ലഭിക്കാത്ത സാഹചര്യം ഈ ഗേറ്റ് കണ്ടെത്തുന്നു.

`check-ui-keys-coverage`-ന് ഈ വിഭാഗം കണ്ടെത്താനാവില്ല: അത് ഓരോ ലൊക്കേലിനും ഒരു ശതമാനപരമായ കുറഞ്ഞ പരിധിയാണ്
നിർബന്ധമാക്കുന്നത്; ~13,000 ലീഫുകളിൽ പതിനൊന്ന് കീകൾ ഇല്ലെങ്കിലും കവറേജ് 99.9% ആയി തുടരും. ഓരോ ഭാഷയ്ക്കുമുള്ള
ഒരു ശതമാനം ഉപയോഗിച്ച് "ഈ ഫീച്ചർ വിവർത്തനം ചെയ്യാതെ പുറത്തിറങ്ങി" എന്ന് പ്രകടിപ്പിക്കാനാവില്ല — ഒരു പുതിയ ലൊക്കേലിൽ
ഒരു ഫീച്ചറിന്റെ മുഴുവൻ ടെക്സ്റ്റും ഇല്ലാതെ തന്നെ അത് ലാൻഡ് ചെയ്യാം, എന്നിട്ടും ആ സംഖ്യ മാറുകയില്ല.

ഇത് രേഖപ്പെടുത്തുന്ന സംഭവം: Orchestration Canvas-ന്റെ Phase 3, അന്ന് നിലവിലുണ്ടായിരുന്ന 42 ലൊക്കേലുകളിലേക്കും
അതിന്റെ പതിനൊന്ന് കീകൾ വിവർത്തനം ചെയ്തു. മണിക്കൂറുകൾക്ക് ശേഷം EU-language ബാച്ച് (#13044) റിപ്പോയെ 51
ലൊക്കേലുകളിലേക്ക് എത്തിച്ചു; പുതുതായി വന്ന ഒൻപത് ലൊക്കേലുകൾക്ക് (`el`, `et`, `ga`, `hr`, `lt`, `lv`, `mt`, `sl`, `sr`)
അവ ഒരിക്കലും ലഭിച്ചില്ല. ഇല്ലാത്ത കീയ്ക്ക് പകരം `deepMergeFallback` ഇംഗ്ലീഷ് നൽകുന്നതിനാൽ, ശൂന്യമായ UI-യ്ക്ക് പകരം
വിവർത്തനം ചെയ്യാത്ത UI ആയിരുന്നു പരാജയരീതി — യഥാർഥമായതും, രൂപകൽപ്പനപ്രകാരം നിശ്ശബ്ദമായതും.

സഹോദര ഗേറ്റിനെപ്പോലെ ഇതും **ഡിഫ്-അവബോധമുള്ളതാണ്**; മർജ് ബേസിലുള്ള ഇംഗ്ലീഷിനെ വർക്കിംഗ് ട്രീയുമായി
താരതമ്യം ചെയ്യുന്നതിനാൽ, മുമ്പേ നിലവിലുണ്ടായിരുന്ന വിടവുകൾ അതേപടി നിലനിൽക്കുകയും ഗേറ്റ് പ്രവർത്തനക്ഷമമാക്കാൻ
മൈഗ്രേഷൻ ആവശ്യമില്ലാതിരിക്കുകയും ചെയ്തു. ഒഴിവുവഴി: `__MISSING__:<english>` റൺടൈം ശരിയായി നിലനിർത്തിക്കൊണ്ട്
ഒരു വിവർത്തനം മാറ്റിവയ്ക്കുന്നു. `vi` പ്ലേസ്ഹോൾഡറുകൾ നിരോധിക്കുന്നു
(`tests/unit/i18n-vi-completeness.test.ts`), അതിനാൽ യഥാർഥ വിവർത്തനം ആവശ്യമാണ്.

#### `check-vitest-exclusions` — മാറ്റിവെച്ച ടെസ്റ്റുകൾക്കുള്ള ഗേറ്റ്

`vitest.config.ts`-ലെ `exclude` ലിസ്റ്റിലുള്ള ഒരു ഫയൽ പ്രവർത്തിപ്പിക്കാത്ത ഒരു ടെസ്റ്റാണ്; ട്രീ വായിക്കുന്നവർക്ക്
അത് കവറേജിന്റെ ഭാഗമാണെന്ന് തോന്നുകയും ചെയ്യും. അറുപത്തിരണ്ട് ഫയലുകൾ
`// #8618 — മുമ്പേ നിലവിലുണ്ടായിരുന്ന പരാജയം; പരിഹരിക്കുമ്പോൾ ഈ ഒഴിവാക്കൽ നീക്കംചെയ്യുക` എന്ന കമന്റിന് പിന്നിൽ അടിഞ്ഞുകൂടി.
Issue #8618, 2026-08-11-ന് അടച്ചു; എന്നാൽ അത് ട്രാക്ക് ചെയ്തിരുന്ന ലിസ്റ്റ് 45 എൻട്രികളിൽനിന്ന് 62 ആയി വളർന്നു,
പുതിയ ഓരോ എൻട്രിയും നിലവിലില്ലാത്ത ഒരു ഇഷ്യൂവിലേക്കു ചൂണ്ടുന്ന കമന്റ് പാരമ്പര്യമായി സ്വീകരിച്ചു. ഒടുവിൽ ലിസ്റ്റിലെ
ഓരോ ഫയലും പ്രത്യേകം അളന്നപ്പോൾ (#13204), **62-ൽ 51 എണ്ണം സോഴ്സിൽ മാറ്റമൊന്നുമില്ലാതെ നിലവിലെ ട്രീയിൽ പാസായി**.

ഒരു യഥാർഥ ഫയലായി പരിഹരിക്കപ്പെടുന്ന ഓരോ ഒഴിവാക്കലും (a) ഒരു ട്രാക്കിംഗ് ഇഷ്യൂവിനെ പരാമർശിക്കണമെന്നും
(b) അളന്ന സ്റ്റാറ്റസോടെ `config/quality/vitest-exclusions.json`-ൽ ഉൾപ്പെടണമെന്നും ഗേറ്റ് നിർബന്ധമാക്കുന്നു.
അതുകൊണ്ട് പുതിയൊരു ഒഴിവാക്കൽ ചേർക്കുന്നത് 60 എൻട്രികളുള്ള അറേയിലേക്ക് മറ്റൊരു വരി ചേർക്കുന്നതിന് പകരം,
ഒരു സമർപ്പിത ഫയലിലെ റിവ്യൂ ചെയ്യാവുന്ന ഡിഫ് ആകുന്നു. ഒഴിവാക്കിയ ടെസ്റ്റുകൾ ഇത് മനഃപൂർവം വീണ്ടും പ്രവർത്തിപ്പിക്കുന്നില്ല —
അതിന് ~10 മിനിറ്റ് ചെലവാകും, അത് ഒരു പീരിയഡിക് ജോലിയിൽ ഉൾപ്പെടേണ്ടതാണ്; ഓരോന്നും അവസാനം അളന്ന സമയം
ഇൻവെന്ററിയിൽ രേഖപ്പെടുത്തുന്നു.
