...
**විෂය පථය:** තනි provider සම්බන්ධතාවක්/account එකක්/key එකක්.

**අරමුණ:** එකම provider සඳහා වන අනෙකුත් සම්බන්ධතා දිගටම සේවය සපයන අතරතුර එක් දෝෂ සහිත key එකක් මඟහැරීම.

**ක්රියාත්මක කිරීම:**

- ලබාගත නොහැකි ලෙස සලකුණු කිරීම: `src/sse/services/auth.ts::markAccountUnavailable()`
- තේරීම: එම ගොනුවේම `getProviderCredentials*`
- Cooldown ගණනය: `open-sse/services/accountFallback.ts::checkFallbackError()`
- සැකසුම්: `src/lib/resilience/settings.ts`

**සම්බන්ධතාවකට අදාළ ක්ෂේත්ර:**

- `rateLimitedUntil` — cooldown අවසන් වන තෙක් කාල මුද්රාව
- `testStatus: "unavailable"`
- `lastError`, `lastErrorType`, `errorCode`
- `backoffLevel` — ඝාතීය backoff ගණකය

**පෙරනිමි cooldown:**

- OAuth මූලික අගය: 5s
- API-key මූලික අගය: 3s
- API-key 429: upstream `Retry-After`/reset headers/විග්රහ කළ හැකි reset පාඨයට ප්රමුඛත්වය දෙයි
- Backoff: `baseCooldownMs * 2 ** failureIndex`

**Anti-thundering-herd ආරක්ෂණය:** සමකාලීන අසාර්ථක වීම් හේතුවෙන් cooldown අධික ලෙස දිගු වීම හෝ `backoffLevel` දෙවරක් වැඩි වීම වළක්වයි.

**අවසාන තත්ත්ව (cooldown නොවේ):**

- `banned` — තහනම්-keyword / account-ban හඳුනාගැනීම මඟින් සකසයි ([BAN_DETECTION](../security/BAN_DETECTION.md) බලන්න)
- `expired` (සීමිත නැවත උත්සාහ ගණනකට පසු අවසාන තත්ත්වයකට මාරු වේ — ඝාතීය backoff සමඟ `EXPIRED_RETRY_MAX = 3` — එමඟින් තාවකාලික OAuth දෝෂ හේතුවෙන් account එක ස්ථිරව අක්රිය කිරීමට පෙර ස්වයංක්රීයව යථා තත්ත්වයට පත් විය හැක)
- `credits_exhausted`

අක්තපත්ර වෙනස් වන තෙක් හෝ ක්රියාකරුවෙකු ඒවා reset කරන තෙක් මේවා පවතී. තාවකාලික cooldown තත්ත්වයකින් අවසාන තත්ත්ව උඩින් ලිවීම නොකරන්න.

**අලස ප්රතිසාධනය:** `rateLimitedUntil` පසු වූ විට, සම්බන්ධතාව නැවත සුදුසුකම් ලබයි. සාර්ථක භාවිතයකදී, `clearAccountError()` සියලු දෝෂ ක්ෂේත්ර ඉවත් කරයි.

### Session affinity (#7274)

**විෂය පථය:** **ඕනෑම** provider සඳහා, එක් සම්බන්ධතාවකට pin කළ එක් client session එකක් (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` header).

**අරමුණ:** ඉල්ලීම් හරහා බහු-වාර agent එකක් (Claude Code, aider, අභිරුචි agents) එකම account එකේ තබාගැනීමෙන්, account අතර context අහිමි වීම සහ account එකකට session state ඇති providers මත නැවත නැවත ඇතිවන cold-start 429 අඩු කිරීම.

**ක්රියාත්මක කිරීම:**

- TTL නිරාකරණය: `src/sse/services/sessionAffinityPin.ts::resolveSessionAffinityTtlMs()`
- Pin තේරීම/නිර්මාණය: `src/sse/services/sessionAffinityPin.ts::selectSessionAffinityConnection()`
- Header උකහා ගැනීම (සාමාන්ය, ඕනෑම provider): `src/sse/services/auth.ts::extractSessionAffinityKey()`
- ස්ථීරව ගබඩා කළ pin වගුව: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- සැකසුම: `sessionAffinityTtlMs` (ms වලින් ගෝලීය TTL එක, `0` මඟින් අක්රිය කරයි) — `src/lib/db/settings.ts`. පෙර වින්යාස කළ ඕනෑම Codex TTL එකක් නව පෙරනිමිය ලෙස රැගෙන යන `124_generic_session_affinity_ttl.sql` migration එක මඟින් Codex සඳහා පමණක් වූ `codexSessionAffinityTtlMs` වෙතින් මෙය නැවත නම් කරන ලදී.

#7274 ට පෙර, `resolveSessionAffinityTtlMs()` විසින් `codex` හැර සෑම provider එකක් සඳහාම `0` වෙත වහාම පිටවීමක් සිදු කළ බැවින්, pin කිරීමේ යාන්ත්රණය සහ header උකහා ගැනීම දැනටමත් provider-agnostic වුවද TTL සැකසුමට (සහ session headers වලට) වෙනත් කිසිදු තැනක බලපෑමක් නොතිබුණි. නිවැරදි කිරීමෙන් එම early-return ඉවත් කරන ලදී; TTL එක ගෝලීයව `0` ට වැඩි අගයකට සැකසූ පසු දැන් එය සෑම provider එකකටම ඒකාකාරව අදාළ වේ.

session-affinity headers තුන කිසිවිටෙක upstream වෙත යොමු නොකෙරේ — executors විසින් client headers හරහා යැවීම වෙනුවට තමන්ගේම upstream headers මුල සිට ගොඩනඟන බැවින්, මෙය අභ්යන්තර correlation id එකක් ලෙස පමණක් පවතී.

### අනන්ය කළමනාකරණ session සම්බන්ධතා leases

**විෂය පථය:** එක් සක්රිය කළමනාකරණ HTTP client/session එකකට එක් සුදුසු OmniRoute සම්බන්ධතාවක් හිමි වේ.

**අරමුණ:** ඉල්ලීම් හරහා දැඩි routing
සීමාවක් අවශ්ය clients සඳහා දිගුකාලීන අනන්ය සම්බන්ධතා හිමිකාරිත්වය සැපයීම. මෙය මෘදු අඛණ්ඩතා මනාපයක් වන session affinity වෙතින් වෙනස් වේ:
අනන්ය lease එකක් SQLite තුළ lifecycle state ස්ථීරව තබාගනී, ගෝලීය active-owner සහ
active-connection අනන්යතාව බලාත්මක කරයි, සහ provider dispatch කිරීමට පෙර යල්පැනගිය generation එකක් ප්රතික්ෂේප කරයි.

මෙම විශේෂාංගය API key එකකට opt-in වේ. කළමනාකරණ key එකකට `lease:exclusive` scope එක සහ
පැහැදිලිව සපයා ඇති හිස් නොවන `allowedConnections` ලැයිස්තුවක් තිබිය යුතුය. ඕනෑම HTTP client එකකට lifecycle endpoint එක භාවිත කළ හැක; කිසිදු
client නාමයක්, user-agent එකක්, provider එකක්, OAuth ක්රමයක් හෝ model එකක් අවශ්ය නොවේ. lease එකට හිමි වන්නේ සම්බන්ධතාවක් මිස
model එකක් නොවන බැවින්, සම්බන්ධතාව සාමාන්යයෙන්
සුදුසුකම් ලබන තෙක් model වෙනසකදී binding එක පවත්වාගනී. සාමාන්ය model, quota, health, cooldown සහ allowlist නීති තවදුරටත් බලය දරන අතර එම generation එකම වෙනත් නිදහස් සුදුසු සම්බන්ධතාවකට
මාරු කළ හැක.

lifecycle එක යනු `acquire`, `renew`, සහ `release` යන JSON actions සහිත `POST /api/v1/session-leases` ය.
කළමනාකරණ inference ඉල්ලීම් පාරදෘශ්ය නොවන `X-OmniRoute-Lease-Owner` අගය සහ නිශ්චිත
`X-OmniRoute-Lease-Generation` ඉදිරිපත් කරයි. owner එක `vlo_` සහ ඉන් පසුව base64url අක්ෂර 43ක් භාවිත කරයි; ගබඩා කරන්නේ
එහි SHA-256 hash එක පමණි. සෑම අවසාන dispatch fence එකක්ම සත්යාපිත API key ID එක සහ
සක්රිය connection ID එක බැඳ තබයි. Lease පාලන headers logs, රඳවාගත් request snapshots සහ
upstream executor headers වෙතින් ඉවත් කරනු ලැබේ.

සාමාන්ය routing සඳහා සුදුසු කළමනාකරණ candidates තිබුණද සෑම නිදහස් candidate එකක්ම
විදේශීය සක්රිය lease එකකින් අල්ලාගෙන තිබේ නම්, OmniRoute විසින් HTTP `429`, lease-capacity-unavailable code එකක්,
waiting-for-capacity තත්ත්වයක් සහ අදාළ ආසන්නතම කල් ඉකුත්වීමෙන් ව්යුත්පන්න කළ සීමිත `Retry-After` එකක් ලබා දෙයි.
සාමාන්ය හිස් eligibility එක lease contention එකක් නොවන අතර එහි පවතින routing error semantics පවත්වාගනී.

අදාළ යාන්ත්රණ වෙන වෙනම පවතී:

- OAuth session occupancy යනු OAuth accounts සඳහා process-local මෘදු බෙදාහැරීමකි.
- Account semaphores මඟින් request-concurrency අවසර ලබා දෙන අතර request එකක් සම්පූර්ණ වූ විට ඒවා අවසන් වේ.
- අනන්ය කළමනාකරණ session leases යනු generation fence එකක් සහිත දිගුකාලීන lifecycle හිමිකාරිත්වයකි.
...
**අරමුණ:** එක් ආකෘතියක් පමණක් ලබාගත නොහැකි හෝ කෝටා සීමාවට ලක්ව ඇති විට සම්පූර්ණ සම්බන්ධතාවක් අක්රිය කිරීම වැළැක්වීම.

**උදාහරණ:**

- එක් එක් ආකෘතිය සඳහා කෝටා පවත්වාගෙන යන සැපයුම්කරුවන් 429 ආපසු ලබා දීම
- එක් ආකෘතියක් නොමැති විට දේශීය සැපයුම්කරුවන් 404 ආපසු ලබා දීම
- සැපයුම්කරුට විශේෂිත ප්රකාර/ආකෘති අවසර අසාර්ථක වීම් (උදා., Grok ප්රකාර)

**ක්රියාත්මක කිරීම:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### ආකෘති ශීතකාල උපකරණ පුවරුව (v3.8.0)

UI: සැකසුම් → ආකෘති ශීතකාල (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

සක්රිය අගුලු දැමීම් මේවා සමඟ ලැයිස්තුගත කරයි: සැපයුම්කරු, සම්බන්ධතාව, ආකෘතිය, හේතුව, expiresAt. ක්රියාකරුවන්ට කාඩ්පතෙන් ආකෘතියක් අතින් යළි සක්රිය කළ හැක.

**REST API:**

- `GET /api/resilience/model-cooldowns` — සක්රිය අගුලු දැමීම් ලැයිස්තුගත කරයි
- `DELETE /api/resilience/model-cooldowns` — අතින් යළි සක්රිය කිරීම. ඉල්ලීම් අන්තර්ගතය: `{provider, connection, model}`. සත්යාපනය: කළමනාකරණය.

### අගුලු දැමීමේ සැකසුම් UI + සාර්ථකත්ව-ක්ෂය ප්රතිසාධනය (v3.8.23)

ආකෘති අගුලු දැමීම සැමවිටම සක්රියව පවතින දෘඪ-කේතගත හැසිරීමක සිට, තමන්ගේම සැකසුම් කාඩ්පතක් සහ ස්වයං-සුවවීමේ ප්රතිසාධන මාර්ගයක් සහිත, සම්පූර්ණයෙන් වින්යාස කළ හැකි, අවශ්ය නම් තෝරා සක්රිය කළ හැකි විශේෂාංගයක් බවට පත් විය.

**සැකසුම් කාඩ්පත:** සැකසුම් → ආකෘති අගුලු දැමීම
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
මෙය ඉහත සඳහන් කියවීමට පමණක් හැකි `ModelCooldownsCard` වෙතින් **වෙනස්** වේ (එය සක්රිය අගුලු දැමීම් _ලැයිස්තුගත කිරීම_ පමණක් කරයි) — නව කාඩ්පත _පරාමිති වින්යාස කරයි_. පෙරනිමි අගයන් `DEFAULT_MODEL_LOCKOUT_SETTINGS`
...
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | ආකෘති-විෂය පථගත අසාර්ථක වීමක් ලෙස සැලකෙන උඩුගං තත්ව.            |
| `baseCooldownMs`        | `120_000` (තත්පර 120)            | පළමු අසාර්ථක වීම සඳහා ආරම්භක අගුලු දැමීමේ කාලසීමාව.             |
| `maxCooldownMs`         | `1_800_000` (මිනිත්තු 30)        | වැඩි කළ ශීතකාලය සඳහා උපරිම සීමාව.                               |
| `maxBackoffSteps`       | `10`                             | උපරිම ඝාතීය පසුබැසීම් වැඩි කිරීමේ පියවර ගණන.                    |
| `useExponentialBackoff` | `true`                           | නැවත නැවත සිදුවන අසාර්ථක වීම් ශීතකාලය ඝාතීයව වැඩි කරන්නේද යන්න. |

සැකසුම් සාමාන්ය සැකසුම් ගබඩාව හරහා ස්ථිරව තබා ගන්නා අතර ප්රතිරෝධී සැකසුම් යෝජනා ක්රමය හරහා වලංගු කෙරේ; කාඩ්පත `baseCooldownMs`/`maxCooldownMs`
(`maxCooldownMs ≥ baseCooldownMs` සමඟ) සහ `maxBackoffSteps` සඳහා සීමා පනවයි.

**සාර්ථකත්ව-ක්ෂය ප්රතිසාධනය:** ප්රතිසාධනය හුදෙක් කාලගණකය කල් ඉකුත් වීම මත පදනම් වන්නේ **නැත**. නිරෝගී ප්රතිචාරයක් ආකෘතියේ අසාර්ථක වීම් ගණන නැවත අඩු කරයි; එම නිසා කාල කවුළුව අතරතුර ප්රතිසාධනය වූ ආකෘතියක් එහි කාලගණකය අවසන් වීමට පෙර වැඩි වීම නවතා ඉවත් වේ. සාර්ථක සංයෝජන ඉලක්කයකදී, `open-sse/services/combo.ts` විසින් `decayModelFailureCount()`
(`open-sse/services/accountFallback.ts`) අමතනු ලබයි; එය ගබඩා කර ඇති
`failureCount` **අඩකින් අඩු කරයි** (`Math.floor(failureCount / 2)`); එය `0` වෙත ළඟා වූ විට අගුලු දැමීමේ ඇතුළත් කිරීම සම්පූර්ණයෙන්ම මකා දැමේ. එහි අනුරූප `recordModelLockoutFailure()` විසින් වැඩි කිරීමේ කාල කවුළුව තුළ අසාර්ථක වීම් ඇති විට ගණන වැඩි කරයි (සහ ශීතකාලය වැඩි කරයි). මෙම සාර්ථකත්ව-ක්ෂය සාමාන්ය කාලගණක කල් ඉකුත් වීමට අමතරව ක්රියා කරයි — ඕනෑම මාර්ගයකින් ආකෘතියක් යළි සක්රිය කළ හැක.

**තත්වය:** අගුලු දැමීම් DB වෙත ස්ථිරව සුරැකීම වෙනුවට, `provider:connectionId:model` මඟින් යතුරුගත කළ `ModelLockoutEntry` හි එක් එක් ක්රියාවලියට අදාළ `Map` ලෙස **මතකය තුළ** රඳවා තබා ගනී — නැවත ආරම්භ කිරීමේදී ඒවා නැති වේ. _සැකසුම්_ ස්ථිරව සුරකිනු ලැබේ; සක්රිය අගුලු දැමීමේ _තත්වය_ තාවකාලික වේ.
...
- සපයන්නෙකු සඳහා සියලු යතුරු මඟහැරී ඇත → පරිපථ බිඳිනයේ තත්ත්වය සහ එක් එක් සම්බන්ධතාවයේ `rateLimitedUntil`/`testStatus` යන දෙකම පරීක්ෂා කරන්න.
- යළි-සැකසුම් කවුළුවෙන් පසුව සපයන්නා ස්ථිරවම බැහැර කර ඇත → කේතය `getStatus()`/`canExecute()` වෙනුවට අමු `state` කියවයි.
- එක් යතුරක් අසමත් වුවත් අනෙක් ඒවා ක්රියා කළ යුතුය → පරිපථ බිඳිනයට වඩා සම්බන්ධතා විරාම කාලයට ප්රමුඛතාව දෙන්න.
- එක් ආකෘතියක් පමණක් අසමත් වේ → සම්බන්ධතා විරාම කාලයට වඩා ආකෘති අගුලු දැමීමට ප්රමුඛතාව දෙන්න.
- තත්ත්වය ස්වයංක්රීයව ප්රතිසාධනය විය යුතු නමුත් එසේ නොවේ → අනාගත කාලමුද්රාවක් සහ කල් ඉකුත් වූ තත්ත්වය නැවුම් කරන කියවීම් මාර්ගයක් තිබේදැයි පරීක්ෂා කරන්න. ස්ථිර තත්ත්ව සඳහා අතින් වෙනස්කම් කිරීම අවශ්ය වේ.
