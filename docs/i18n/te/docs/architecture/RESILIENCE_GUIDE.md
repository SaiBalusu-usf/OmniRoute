...
**ఉద్దేశ్యం:** అదే ప్రొవైడర్కు చెందిన ఇతర కనెక్షన్లు సేవలు అందిస్తూనే ఉండగా, ఒక సమస్యాత్మక కీని దాటవేయడం.
...
**ప్రతి కనెక్షన్కు సంబంధించిన ఫీల్డ్లు:**

- `rateLimitedUntil` — కూల్డౌన్ గడువు ముగిసే వరకు టైమ్స్టాంప్
...
**యాంటీ-థండరింగ్-హెర్డ్ రక్షణ:** సమకాలీన వైఫల్యాలు కూల్డౌన్ను అతిగా పొడిగించకుండా లేదా `backoffLevel`ను రెండుసార్లు పెంచకుండా నిరోధిస్తుంది.

**టెర్మినల్ స్థితులు (కూల్డౌన్లు కావు):**

- `banned` — నిషేధిత కీవర్డ్ / ఖాతా నిషేధ గుర్తింపు ద్వారా సెట్ చేయబడుతుంది ([BAN_DETECTION](../security/BAN_DETECTION.md) చూడండి)
- `expired` (పరిమిత రీట్రైల తర్వాత టెర్మినల్ స్థితికి మారుతుంది — ఎక్స్పోనెన్షియల్ బ్యాక్ఆఫ్తో `EXPIRED_RETRY_MAX = 3` — తద్వారా ఖాతా శాశ్వతంగా డీయాక్టివేట్ కావడానికి ముందు తాత్కాలిక OAuth లోపాలు స్వయంగా సరిదిద్దుకోగలవు)
- `credits_exhausted`

క్రెడెన్షియల్స్ మారే వరకు లేదా ఆపరేటర్ వాటిని రీసెట్ చేసే వరకు ఇవి అలాగే కొనసాగుతాయి. టెర్మినల్ స్థితులను తాత్కాలిక కూల్డౌన్ స్థితితో ఓవర్రైట్ చేయవద్దు.

**లేజీ రికవరీ:** `rateLimitedUntil` సమయం దాటినప్పుడు, కనెక్షన్ మళ్లీ అర్హత పొందుతుంది. విజయవంతంగా ఉపయోగించినప్పుడు, `clearAccountError()` అన్ని ఎరర్ ఫీల్డ్లను క్లియర్ చేస్తుంది.
...
**ఉద్దేశ్యం:** బహుళ-టర్న్ ఏజెంట్ను (Claude Code, aider, కస్టమ్ ఏజెంట్లు) రిక్వెస్ట్ల అంతటా అదే ఖాతాలో ఉంచడం, తద్వారా ఖాతాల మధ్య కాంటెక్స్ట్ నష్టాన్ని మరియు ఒక్కో ఖాతాకు సెషన్ స్థితి ఉండే ప్రొవైడర్లలో పునరావృతమయ్యే కోల్డ్-స్టార్ట్ 429లను తగ్గించడం.
...
- స్థిరంగా భద్రపరచబడే పిన్ టేబుల్: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- సెట్టింగ్: `sessionAffinityTtlMs` (msలో గ్లోబల్ TTL, `0` నిలిపివేస్తుంది) — `src/lib/db/settings.ts`. మైగ్రేషన్ `124_generic_session_affinity_ttl.sql` ద్వారా Codexకు మాత్రమే పరిమితమైన `codexSessionAffinityTtlMs` నుండి దీని పేరు మార్చబడింది; ఇది గతంలో కాన్ఫిగర్ చేసిన ఏదైనా Codex TTLను కొత్త డిఫాల్ట్గా కొనసాగిస్తుంది.

#7274కు ముందు, `codex` మినహా ప్రతి ప్రొవైడర్కు `resolveSessionAffinityTtlMs()` వెంటనే `0`తో నిష్క్రమించేది; అందువల్ల పిన్నింగ్ మెకానిజం మరియు హెడర్ వెలికితీత ఇప్పటికే ప్రొవైడర్-అజ్ఞేయంగా ఉన్నప్పటికీ, TTL సెట్టింగ్ (మరియు సెషన్ హెడర్లు) మరెక్కడా ప్రభావం చూపలేదు. ఈ పరిష్కారం ఆ ఎర్లీ-రిటర్న్ను తొలగించింది; TTLను గ్లోబల్గా `0` కంటే ఎక్కువకు సెట్ చేసిన తర్వాత, అది ఇప్పుడు ప్రతి ప్రొవైడర్కు ఏకరీతిగా వర్తిస్తుంది.

మూడు సెషన్-అఫినిటీ హెడర్లు ఎప్పుడూ అప్స్ట్రీమ్కు ఫార్వర్డ్ చేయబడవు — ఎగ్జిక్యూటర్లు క్లయింట్ హెడర్లను పంపకుండా తమ సొంత అప్స్ట్రీమ్ హెడర్లను మొదటి నుంచి నిర్మిస్తాయి, కాబట్టి ఇది అంతర్గత కోరిలేషన్ IDగా మాత్రమే ఉంటుంది.

### ప్రత్యేక మేనేజ్డ్ సెషన్ కనెక్షన్ లీజ్లు

**పరిధి:** ఒక యాక్టివ్ మేనేజ్డ్ HTTP క్లయింట్/సెషన్ ఒక అర్హమైన OmniRoute కనెక్షన్ను సొంతం చేసుకుంటుంది.

**ఉద్దేశ్యం:** రిక్వెస్ట్ల అంతటా కఠినమైన రూటింగ్
ఫెన్స్ అవసరమయ్యే క్లయింట్లకు మన్నికైన ప్రత్యేక కనెక్షన్ యాజమాన్యాన్ని అందించడం. ఇది సాఫ్ట్ కంటిన్యుటీ ప్రాధాన్యత అయిన సెషన్ అఫినిటీకి భిన్నంగా ఉంటుంది:
ప్రత్యేక లీజ్ లైఫ్సైకిల్ స్థితిని SQLiteలో నిల్వ చేస్తుంది, గ్లోబల్ యాక్టివ్-ఓనర్ మరియు
యాక్టివ్-కనెక్షన్ యూనిక్నెస్ను అమలు చేస్తుంది, అలాగే ప్రొవైడర్ డిస్పాచ్కు ముందు పాత జనరేషన్ను తిరస్కరిస్తుంది.

ఈ ఫీచర్ ఒక్కో API కీకి ఆప్ట్-ఇన్గా ఉంటుంది. మేనేజ్డ్ కీకి `lease:exclusive` స్కోప్ మరియు
స్పష్టమైన, ఖాళీ కాని `allowedConnections` జాబితా తప్పనిసరిగా ఉండాలి. ఏ HTTP క్లయింట్ అయినా లైఫ్సైకిల్ ఎండ్పాయింట్ను ఉపయోగించవచ్చు; ఎలాంటి
క్లయింట్ పేరు, యూజర్-ఏజెంట్, ప్రొవైడర్, OAuth పద్ధతి లేదా మోడల్ అవసరం లేదు. లీజ్ ఒక కనెక్షన్ను సొంతం చేసుకుంటుంది,
మోడల్ను కాదు; కాబట్టి కనెక్షన్ సాధారణంగా
అర్హంగా ఉన్నంత వరకు మోడల్ మార్పు బైండింగ్ను కొనసాగిస్తుంది. సాధారణ మోడల్, కోటా, హెల్త్, కూల్డౌన్ మరియు అలౌలిస్ట్ నియమాలు ప్రామాణికంగానే ఉంటాయి మరియు
అదే జనరేషన్ను మరొక ఖాళీగా ఉన్న అర్హమైన కనెక్షన్కు మార్చవచ్చు.

లైఫ్సైకిల్ `POST /api/v1/session-leases`; ఇందులో `acquire`, `renew`, మరియు `release` JSON చర్యలు ఉంటాయి.
మేనేజ్డ్ ఇన్ఫరెన్స్ రిక్వెస్ట్లు అపారదర్శకమైన `X-OmniRoute-Lease-Owner` విలువను మరియు ఖచ్చితమైన
`X-OmniRoute-Lease-Generation`ను అందిస్తాయి. ఓనర్ విలువ `vlo_`తో ప్రారంభమై, దాని తర్వాత 43 base64url అక్షరాలు ఉంటాయి; దాని SHA-256 హాష్ మాత్రమే నిల్వ చేయబడుతుంది. ప్రతి తుది డిస్పాచ్ ఫెన్స్, ప్రమాణీకరించిన API కీ ID మరియు
యాక్టివ్ కనెక్షన్ IDను కూడా బైండ్ చేస్తుంది. లీజ్ కంట్రోల్ హెడర్లు లాగ్లు, నిల్వ ఉంచిన రిక్వెస్ట్ స్నాప్షాట్లు మరియు
అప్స్ట్రీమ్ ఎగ్జిక్యూటర్ హెడర్ల నుంచి తొలగించబడతాయి.

సాధారణ రూటింగ్లో అర్హమైన మేనేజ్డ్ అభ్యర్థులు ఉన్నప్పటికీ, ఖాళీగా ఉన్న ప్రతి అభ్యర్థినీ
వేరొక యాక్టివ్ లీజ్ ఆక్రమించి ఉంటే, OmniRoute HTTP `429`, లీజ్-కెపాసిటీ-అందుబాటులో-లేదు కోడ్,
కెపాసిటీ-కోసం-వేచి-ఉన్న స్థితి మరియు సంబంధిత అత్యంత ముందస్తు గడువు ముగింపు నుంచి ఉత్పన్నమైన పరిమిత `Retry-After`ను తిరిగి ఇస్తుంది.
సాధారణంగా అర్హత కలిగినవి ఏవీ లేకపోవడం లీజ్ పోటీ కాదు; అది ఇప్పటికే ఉన్న రూటింగ్ ఎరర్ సెమాంటిక్స్ను కొనసాగిస్తుంది.

సంబంధిత మెకానిజంలు వేర్వేరుగానే ఉంటాయి:

- OAuth సెషన్ ఆక్యుపెన్సీ అనేది OAuth ఖాతాల కోసం ప్రాసెస్-లోకల్ సాఫ్ట్ డిస్ట్రిబ్యూషన్.
- ఖాతా సెమాఫోర్లు రిక్వెస్ట్-కంకరెన్సీ అనుమతులను మంజూరు చేస్తాయి మరియు రిక్వెస్ట్ పూర్తయినప్పుడు ముగుస్తాయి.
- ప్రత్యేక మేనేజ్డ్ సెషన్ లీజ్లు జనరేషన్ ఫెన్స్తో కూడిన మన్నికైన లైఫ్సైకిల్ యాజమాన్యం.

---

## 3. మోడల్ లాకౌట్

**పరిధి:** ప్రొవైడర్ + కనెక్షన్ + మోడల్ త్రయం.

**ఉద్దేశ్యం:** ఒక మోడల్ మాత్రమే అందుబాటులో లేనప్పుడు లేదా కోటా పరిమితికి లోనైనప్పుడు, మొత్తం కనెక్షన్ను నిలిపివేయకుండా ఉండటం.

**ఉదాహరణలు:**

- ప్రతి మోడల్కు ప్రత్యేక కోటా ఉండే ప్రొవైడర్లు 429ని తిరిగి ఇవ్వడం
- ఒక మోడల్ అందుబాటులో లేనప్పుడు లోకల్ ప్రొవైడర్లు 404ని తిరిగి ఇవ్వడం
- ప్రొవైడర్-నిర్దిష్ట మోడ్/మోడల్ అనుమతి వైఫల్యాలు (ఉదా., Grok మోడ్లు)

**అమలు:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### మోడల్ కూల్డౌన్ల డ్యాష్బోర్డ్ (v3.8.0)

UI: సెట్టింగ్లు → మోడల్ కూల్డౌన్లు (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

క్రియాశీల లాకౌట్లను వీటితో జాబితా చేస్తుంది: ప్రొవైడర్, కనెక్షన్, మోడల్, కారణం, expiresAt. ఆపరేటర్లు కార్డ్ నుండి మోడల్ను మాన్యువల్గా మళ్లీ ప్రారంభించవచ్చు.

**REST API:**

- `GET /api/resilience/model-cooldowns` — క్రియాశీల లాకౌట్లను జాబితా చేయండి
- `DELETE /api/resilience/model-cooldowns` — మాన్యువల్గా మళ్లీ ప్రారంభించండి. బాడీ: `{provider, connection, model}`. ప్రామాణీకరణ: మేనేజ్మెంట్.

### లాకౌట్ సెట్టింగ్ల UI + విజయ-క్షీణత రికవరీ (v3.8.23)

మోడల్ లాకౌట్ ఎల్లప్పుడూ ఆన్లో ఉండే హార్డ్కోడ్ చేసిన ప్రవర్తన నుండి, పూర్తిగా కాన్ఫిగర్ చేయగల,
ఎంచుకుని ప్రారంభించగల ఫీచర్గా మారింది; దీనికి సొంత సెట్టింగ్ల కార్డ్ మరియు స్వీయ-పునరుద్ధరణ రికవరీ మార్గం ఉన్నాయి.

**సెట్టింగ్ల కార్డ్:** సెట్టింగ్లు → మోడల్ లాకౌట్
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
ఇది పైన ఉన్న చదవడానికి-మాత్రమే ఉద్దేశించిన `ModelCooldownsCard`కు **భిన్నమైనది** (అది క్రియాశీల లాకౌట్లను మాత్రమే
_జాబితా చేస్తుంది_) — కొత్త కార్డ్ _పారామీటర్లను కాన్ఫిగర్ చేస్తుంది_. డిఫాల్ట్లు
`DEFAULT_MODEL_LOCKOUT_SETTINGS`లో ఉంటాయి
(`src/lib/resilience/modelLockoutSettings.ts`):

| సెట్టింగ్               | డిఫాల్ట్                         | అర్థం                                                           |
| ----------------------- | -------------------------------- | --------------------------------------------------------------- |
| `enabled`               | `false`                          | ప్రధాన టాగుల్ — మోడల్ లాకౌట్ **డిఫాల్ట్గా ఆఫ్లో ఉంటుంది**.      |
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | మోడల్-పరిధి వైఫల్యంగా పరిగణించే అప్స్ట్రీమ్ స్టేటస్లు.          |
| `baseCooldownMs`        | `120_000` (120 సె.)              | మొదటి వైఫల్యానికి ప్రారంభ లాకౌట్ వ్యవధి.                        |
| `maxCooldownMs`         | `1_800_000` (30 నిమి.)           | పెంచబడిన కూల్డౌన్కు గరిష్ఠ పరిమితి.                             |
| `maxBackoffSteps`       | `10`                             | గరిష్ఠ ఎక్స్పోనెన్షియల్-బ్యాక్ఆఫ్ పెంపు దశలు.                   |
| `useExponentialBackoff` | `true`                           | పునరావృత వైఫల్యాలు కూల్డౌన్ను ఎక్స్పోనెన్షియల్గా పెంచాలా వద్దా. |

సెట్టింగ్లు సాధారణ సెట్టింగ్ల స్టోర్ ద్వారా నిల్వ చేయబడతాయి మరియు
రెసిలియన్స్ సెట్టింగ్ల స్కీమా ద్వారా ధ్రువీకరించబడతాయి; కార్డ్ `baseCooldownMs`/`maxCooldownMs`
(`maxCooldownMs ≥ baseCooldownMs`తో) మరియు `maxBackoffSteps`లను పరిమితుల్లో ఉంచుతుంది.

**విజయ-క్షీణత రికవరీ:** రికవరీ అనేది పూర్తిగా టైమర్ గడువు ముగియడంపై మాత్రమే ఆధారపడదు. ఆరోగ్యకరమైన
రెస్పాన్స్ మోడల్ వైఫల్యాల సంఖ్యను క్రమంగా తగ్గిస్తుంది, అందువల్ల విండో మధ్యలో కోలుకున్న మోడల్
దాని టైమర్ ముగియకముందే పెరుగుదలను ఆపి (లాకౌట్ను క్లియర్ చేస్తుంది). విజయవంతమైన
కాంబో లక్ష్యంలో, `open-sse/services/combo.ts` అనేది `decayModelFailureCount()`ను కాల్ చేస్తుంది
(`open-sse/services/accountFallback.ts`), ఇది నిల్వ చేసిన
`failureCount`ను **సగానికి తగ్గిస్తుంది** (`Math.floor(failureCount / 2)`); అది `0`కు చేరుకున్నప్పుడు లాకౌట్
ఎంట్రీ పూర్తిగా తొలగించబడుతుంది. దీనికి ప్రతిరూపమైన `recordModelLockoutFailure()`
ఎస్కలేషన్ విండోలో వైఫల్యాలు సంభవించినప్పుడు కౌంట్ను పెంచుతుంది (మరియు కూల్డౌన్ను పెంచుతుంది).
ఈ విజయ-క్షీణత సాధారణ టైమర్ గడువు ముగింపుకు అదనంగా పనిచేస్తుంది —
ఏ మార్గమైనా మోడల్ను తిరిగి ప్రారంభించగలదు.

**స్థితి:** లాకౌట్లు DBలో నిల్వ చేయబడకుండా, **ఇన్-మెమరీలో** (ప్రతి ప్రాసెస్కు చెందిన `Map`లలో
`provider:connectionId:model` ఆధారంగా కీ చేయబడిన `ModelLockoutEntry`లుగా) ఉంచబడతాయి —
పునఃప్రారంభించినప్పుడు అవి పోతాయి. _సెట్టింగ్లు_ నిల్వ చేయబడతాయి; క్రియాశీల
లాకౌట్ _స్థితి_ తాత్కాలికమైనది.
...
- ఒక ప్రొవైడర్కు సంబంధించిన అన్ని కీలు దాటవేయబడ్డాయి → సర్క్యూట్ బ్రేకర్ స్థితితో పాటు ప్రతి కనెక్షన్కు చెందిన `rateLimitedUntil`/`testStatus` రెండింటినీ తనిఖీ చేయండి.
- రీసెట్ విండో తర్వాత ప్రొవైడర్ శాశ్వతంగా మినహాయించబడింది → కోడ్ `getStatus()`/`canExecute()` బదులుగా ముడి `state`ను చదువుతోంది.
- ఒక కీ విఫలమైనా, మిగతావి పనిచేయాలి → సర్క్యూట్ బ్రేకర్ కంటే కనెక్షన్ కూల్డౌన్కు ప్రాధాన్యత ఇవ్వండి.
- ఒక మోడల్ మాత్రమే విఫలమవుతోంది → కనెక్షన్ కూల్డౌన్ కంటే మోడల్ లాకౌట్కు ప్రాధాన్యత ఇవ్వండి.
- స్థితి స్వయంగా పునరుద్ధరించబడాలి, కానీ అలా జరగడం లేదు → భవిష్యత్ టైమ్స్టాంప్తో పాటు గడువు ముగిసిన స్థితిని రిఫ్రెష్ చేసే రీడ్ పాత్ను తనిఖీ చేయండి. శాశ్వత స్థితులకు మాన్యువల్ మార్పులు అవసరం.
