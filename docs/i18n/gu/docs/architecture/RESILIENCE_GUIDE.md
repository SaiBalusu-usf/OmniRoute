...
**વ્યાપ:** એકલ પ્રોવાઇડર કનેક્શન/એકાઉન્ટ/કી.
...
- `backoffLevel` — એક્સ્પોનેન્શિયલ બેકઓફ કાઉન્ટર
...
- બેકઓફ: `baseCooldownMs * 2 ** failureIndex`

**થન્ડરિંગ-હર્ડ વિરોધી સુરક્ષા:** સમકાલીન નિષ્ફળતાઓને કૂલડાઉન અતિશય લંબાવવાથી અથવા `backoffLevel`ને બે વાર વધારવાથી અટકાવે છે.

**ટર્મિનલ સ્થિતિઓ (કૂલડાઉન્સ નથી):**

- `banned` — પ્રતિબંધિત-કીવર્ડ / એકાઉન્ટ-પ્રતિબંધ શોધ દ્વારા સેટ થાય છે ([BAN_DETECTION](../security/BAN_DETECTION.md) જુઓ)
- `expired` (મર્યાદિત પુનઃપ્રયાસો પછી ટર્મિનલ સ્થિતિમાં પરિવર્તિત થાય છે — એક્સ્પોનેન્શિયલ બેકઓફ સાથે `EXPIRED_RETRY_MAX = 3` — જેથી એકાઉન્ટ કાયમી રીતે નિષ્ક્રિય થાય તે પહેલાં ક્ષણિક OAuth ભૂલો સ્વયં સુધરી શકે)
- `credits_exhausted`
...
**લેઝી રિકવરી:** જ્યારે `rateLimitedUntil` વીતી જાય, ત્યારે કનેક્શન ફરીથી પાત્ર બને છે. સફળ ઉપયોગ પર, `clearAccountError()` તમામ ભૂલ ફીલ્ડ્સ સાફ કરે છે.

### સેશન અફિનિટી (#7274)

**વ્યાપ:** એક ક્લાયન્ટ સેશન (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` હેડર), **કોઈપણ** પ્રોવાઇડર માટે, એક કનેક્શન સાથે પિન થયેલું.

**હેતુ:** મલ્ટિ-ટર્ન એજન્ટને (Claude Code, aider, કસ્ટમ એજન્ટ્સ) વિનંતીઓ દરમિયાન સમાન એકાઉન્ટ પર જાળવી રાખવું, જેથી ક્રોસ-એકાઉન્ટ સંદર્ભ ગુમાવવાનું અને પ્રતિ-એકાઉન્ટ સેશન સ્થિતિ ધરાવતા પ્રોવાઇડર્સ પર વારંવાર આવતા કોલ્ડ-સ્ટાર્ટ 429s ઘટાડાય.
...
- હેડર એક્સ્ટ્રેક્શન (સામાન્ય, કોઈપણ પ્રોવાઇડર): `src/sse/services/auth.ts::extractSessionAffinityKey()`
- પર્સિસ્ટેડ પિન ટેબલ: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- સેટિંગ: `sessionAffinityTtlMs` (msમાં વૈશ્વિક TTL, `0` અક્ષમ કરે છે) — `src/lib/db/settings.ts`. માઇગ્રેશન `124_generic_session_affinity_ttl.sql` દ્વારા માત્ર Codex માટેના `codexSessionAffinityTtlMs`માંથી તેનું નામ બદલવામાં આવ્યું છે, જે અગાઉ કૉન્ફિગર કરાયેલ કોઈપણ Codex TTLને નવા ડિફૉલ્ટ તરીકે આગળ લઈ જાય છે.

#7274 પહેલાં, `resolveSessionAffinityTtlMs()` `codex` સિવાયના દરેક પ્રોવાઇડર માટે સીધું `0` પર અટકી જતું હતું, તેથી પિનિંગ મિકેનિઝમ અને હેડર એક્સ્ટ્રેક્શન પહેલેથી જ પ્રોવાઇડર-અગ્નોસ્ટિક હોવા છતાં TTL સેટિંગ (અને સેશન હેડર્સ)ની અન્ય ક્યાંય કોઈ અસર થતી નહોતી. સુધારાએ તે વહેલું રિટર્ન દૂર કર્યું; TTLને વૈશ્વિક સ્તરે `0` કરતાં વધારે સેટ કર્યા પછી હવે તે દરેક પ્રોવાઇડર પર સમાન રીતે લાગુ થાય છે.

ત્રણેય સેશન-અફિનિટી હેડર્સ ક્યારેય અપસ્ટ્રીમ ફોરવર્ડ થતા નથી — એક્ઝિક્યુટર્સ ક્લાયન્ટ હેડર્સને આગળ મોકલવાને બદલે પોતાના અપસ્ટ્રીમ હેડર્સ શરૂઆતથી બનાવે છે, તેથી આ ફક્ત આંતરિક કોરિલેશન id તરીકે જ રહે છે.
...
**હેતુ:** એવી વિનંતીઓ વચ્ચે મજબૂત રાઉટિંગ
સીમાની જરૂર ધરાવતા ક્લાયન્ટ્સ માટે ટકાઉ એક્સક્લૂસિવ કનેક્શન માલિકી પ્રદાન કરવી. આ સેશન અફિનિટીથી અલગ છે, જે નરમ સાતત્ય પસંદગી છે:
એક્સક્લૂસિવ લીઝ SQLiteમાં લાઇફસાઇકલ સ્થિતિ યથાવત્ રાખે છે, વૈશ્વિક સક્રિય-માલિક અને
સક્રિય-કનેક્શન વિશિષ્ટતા લાગુ કરે છે, અને પ્રોવાઇડર ડિસ્પેચ પહેલાં જૂની જનરેશનને નકારે છે.

આ સુવિધા દરેક API કી દીઠ ઑપ્ટ-ઇન છે. મેનેજ્ડ કી પાસે `lease:exclusive` સ્કોપ અને
સ્પષ્ટ બિન-ખાલી `allowedConnections` સૂચિ હોવી આવશ્યક છે. કોઈપણ HTTP ક્લાયન્ટ લાઇફસાઇકલ એન્ડપોઇન્ટનો ઉપયોગ કરી શકે છે; કોઈ
ક્લાયન્ટ નામ, યુઝર-એજન્ટ, પ્રોવાઇડર, OAuth પદ્ધતિ અથવા મોડલ જરૂરી નથી. લીઝ કનેક્શનની માલિકી ધરાવે છે,
મોડલની નહીં, તેથી કનેક્શન સામાન્ય રીતે
પાત્ર રહે ત્યાં સુધી મોડલ બદલવાથી બાઇન્ડિંગ જળવાઈ રહે છે. સામાન્ય મોડલ, ક્વોટા, હેલ્થ, કૂલડાઉન અને અલાઉલિસ્ટ નિયમો અધિકૃત રહે છે અને
સમાન જનરેશનને બીજા મુક્ત પાત્ર કનેક્શન પર પરિવર્તિત કરી શકે છે.
...
તેનો SHA-256 હૅશ સંગ્રહિત થાય છે. દરેક અંતિમ ડિસ્પેચ સીમા પ્રમાણિત API કી ID અને
સક્રિય કનેક્શન IDને પણ બાઇન્ડ કરે છે. લીઝ કંટ્રોલ હેડર્સ લૉગ્સ, જાળવી રાખેલા વિનંતી સ્નૅપશૉટ્સ અને
અપસ્ટ્રીમ એક્ઝિક્યુટર હેડર્સમાંથી દૂર કરવામાં આવે છે.

જો સામાન્ય રાઉટિંગ પાસે પાત્ર મેનેજ્ડ ઉમેદવારો હોય પરંતુ દરેક મુક્ત ઉમેદવાર પર
કોઈ વિદેશી સક્રિય લીઝનો કબજો હોય, તો OmniRoute HTTP `429`, લીઝ-ક્ષમતા-અનુપલબ્ધ કોડ,
ક્ષમતા-માટે-પ્રતીક્ષા સ્થિતિ અને સૌથી વહેલી સંબંધિત સમાપ્તિ પરથી મેળવેલ મર્યાદિત `Retry-After` પરત કરે છે.
સામાન્ય ખાલી પાત્રતા લીઝ સ્પર્ધા નથી અને તેની હાલની રાઉટિંગ ભૂલ સિમેન્ટિક્સ જાળવી રાખે છે.

સંબંધિત મિકેનિઝમ્સ અલગ રહે છે:

- OAuth સેશન ઓક્યુપન્સી એ OAuth એકાઉન્ટ્સ માટે પ્રોસેસ-લોકલ નરમ વિતરણ છે.
- એકાઉન્ટ સેમાફોર્સ વિનંતી-સમકાલીનતા પરમિટ આપે છે અને વિનંતી પૂર્ણ થાય ત્યારે સમાપ્ત થાય છે.
- એક્સક્લૂસિવ મેનેજ્ડ સેશન લીઝ એ જનરેશન સીમા સાથેની ટકાઉ લાઇફસાઇકલ માલિકી છે.
...
**હેતુ:** જ્યારે માત્ર એક model અનુપલબ્ધ હોય અથવા quota-મર્યાદિત હોય ત્યારે આખું connection અક્ષમ કરવાનું ટાળવું.

**ઉદાહરણો:**

- પ્રતિ-model quota ધરાવતા providers દ્વારા 429 પરત કરવું
- એક ગુમ થયેલા model માટે local providers દ્વારા 404 પરત કરવું
- Provider-વિશિષ્ટ mode/model permission નિષ્ફળતાઓ (દા.ત., Grok modes)

**અમલીકરણ:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### મોડેલ કૂલડાઉન ડૅશબોર્ડ (v3.8.0)

UI: Settings → Model Cooldowns (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

આ વિગતો સાથે સક્રિય lockouts સૂચિબદ્ધ કરે છે: provider, connection, model, reason, expiresAt. ઑપરેટરો cardમાંથી modelને મેન્યુઅલી ફરીથી સક્ષમ કરી શકે છે.

**REST API:**

- `GET /api/resilience/model-cooldowns` — સક્રિય lockoutsની સૂચિ
- `DELETE /api/resilience/model-cooldowns` — મેન્યુઅલ રીતે ફરીથી સક્ષમ કરવું. Body: `{provider, connection, model}`. Auth: management.

### લોકઆઉટ સેટિંગ્સ UI + સફળતા-ક્ષય પુનઃપ્રાપ્તિ (v3.8.23)

મોડેલ lockout હંમેશા ચાલુ રહેતી hardcoded વર્તણૂકમાંથી સંપૂર્ણપણે ગોઠવી શકાય તેવી,
opt-in સુવિધામાં પરિવર્તિત થયું છે, જેમાં તેનું પોતાનું settings card અને સ્વયં-સુધારક પુનઃપ્રાપ્તિ માર્ગ છે.

**સેટિંગ્સ card:** Settings → Model Lockout
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
આ ઉપરના ફક્ત વાંચી શકાય તેવા `ModelCooldownsCard`થી **અલગ** છે (જે માત્ર
સક્રિય lockoutsની _સૂચિ_ આપે છે) — નવું card _પરિમાણો ગોઠવે છે_. ડિફૉલ્ટ્સ
...
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | Model-વ્યાપી નિષ્ફળતા તરીકે ગણાતા upstream statuses.                |
| `baseCooldownMs`        | `120_000` (120 s)                | પ્રથમ નિષ્ફળતા માટે lockoutની પ્રારંભિક અવધિ.                       |
| `maxCooldownMs`         | `1_800_000` (30 min)             | વધારાયેલા cooldownની મહત્તમ મર્યાદા.                                |
| `maxBackoffSteps`       | `10`                             | મહત્તમ exponential-backoff વૃદ્ધિનાં પગલાં.                         |
| `useExponentialBackoff` | `true`                           | પુનરાવર્તિત નિષ્ફળતાઓ cooldownને exponential રીતે વધારે છે કે નહીં. |

સેટિંગ્સ સામાન્ય settings store મારફતે જળવાઈ રહે છે અને
resilience settings schema દ્વારા માન્ય થાય છે; card `baseCooldownMs`/`maxCooldownMs`
ને (`maxCooldownMs ≥ baseCooldownMs` સાથે) અને `maxBackoffSteps`ને મર્યાદામાં રાખે છે.

**સફળતા-ક્ષય પુનઃપ્રાપ્તિ:** પુનઃપ્રાપ્તિ **માત્ર** timer સમાપ્ત થવા પર આધારિત નથી. સ્વસ્થ
response modelની failure countને પાછી ઘટાડે છે, જેથી windowની વચ્ચે પુનઃપ્રાપ્ત થયેલું model
તેનો timer સમાપ્ત થાય તે પહેલાં વધવાનું બંધ કરે (અને સાફ થાય). સફળ
combo target પર, `open-sse/services/combo.ts` દ્વારા `decayModelFailureCount()`
(`open-sse/services/accountFallback.ts`) કૉલ થાય છે, જે સંગ્રહિત
`failureCount`ને **અડધું** કરે છે (`Math.floor(failureCount / 2)`); જ્યારે તે `0` પર પહોંચે છે ત્યારે lockout
entry સંપૂર્ણપણે કાઢી નાખવામાં આવે છે. તેનો સમકક્ષ `recordModelLockoutFailure()`
escalation windowની અંદરની નિષ્ફળતાઓ પર count વધારે છે (અને cooldown વધારે છે).
આ success-decay સામાન્ય timer સમાપ્તિ ઉપરાંત છે —
બંનેમાંથી કોઈપણ માર્ગ modelને ફરીથી સક્ષમ કરી શકે છે.

**સ્થિતિ:** lockouts **in-memory** રાખવામાં આવે છે (દરેક process માટેના `Map`sમાં
`ModelLockoutEntry`, જે `provider:connectionId:model` દ્વારા keyed છે), DBમાં જાળવવામાં
આવતા નથી — restart થતાં તે ગુમ થઈ જાય છે. _સેટિંગ્સ_ જાળવવામાં આવે છે; સક્રિય
...
- પ્રોવાઇડરની બધી કીઝ સ્કિપ થઈ → સર્કિટ બ્રેકરની સ્થિતિ અને દરેક કનેક્શનનું `rateLimitedUntil`/`testStatus`, બંને તપાસો.
- રીસેટ વિન્ડો પછી પ્રોવાઇડર કાયમી રીતે બાકાત રહે → કોડ `getStatus()`/`canExecute()` ને બદલે સીધું `state` વાંચી રહ્યો છે.
- એક કી નિષ્ફળ જાય, તો અન્ય કીઝ કાર્યરત રહેવી જોઈએ → સર્કિટ બ્રેકરને બદલે કનેક્શન કૂલડાઉનને પ્રાથમિકતા આપો.
- માત્ર એક મૉડલ નિષ્ફળ જાય → કનેક્શન કૂલડાઉનને બદલે મૉડલ લૉકઆઉટને પ્રાથમિકતા આપો.
- સ્થિતિ જાતે પુનઃપ્રાપ્ત થવી જોઈએ પણ થતી નથી → ભવિષ્યનો ટાઇમસ્ટૅમ્પ અને સમયસમાપ્ત સ્થિતિને રિફ્રેશ કરતો રીડ પાથ તપાસો. કાયમી સ્થિતિઓ માટે મૅન્યુઅલ ફેરફારો જરૂરી છે.
