...
સ્ક્રિપ્ટ્સ `scripts/check/` (policy gates) અને `scripts/quality/` (ratchet engine) હેઠળ રહે છે.
CI માટેનું પ્રમાણભૂત સ્રોત `.github/workflows/ci.yml` છે.

### Release PR ફાસ્ટ-પાથ (`quality.yml`)

`.github/workflows/quality.yml` `release/**` ને લક્ષ્ય બનાવતા PRs પર ચાલે છે. તે યોગદાનકર્તા
બ્રાન્ચોને પાથ-ફિલ્ટર કરેલા ઝડપી ગેટ્સ સાથે આગળ વધતી રાખે છે, ઉપરાંત કોડ
ફેરફારો માટે એક સલાહકારી production-build સંકેત આપે છે:

| જોબ                                              | વ્યાપ                                                                                                                                                                                                                              | અવરોધક                                                                                  |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `Build (advisory)`                               | નોન-ડ્રાફ્ટ કોડ PRs અને Mergify queue બ્રાન્ચો; Node 24, `npm-ci-retry`, `check:node-runtime`, `OMNIROUTE_USE_TURBOPACK=1` સાથે `npm run build`; કોઈ artifact upload નહીં, કારણ કે કોઈ downstream quality job તેનો ઉપયોગ કરતું નથી | **સલાહકારી** (`continue-on-error: true`; સ્થિર release-PR રનના એક અઠવાડિયા પછી દૂર કરો) |
| `Docs Gates (fast-path)`                         | ડૉક્સ/કોડ PRs; API ડૉક્સ સંદર્ભો અને docs-all                                                                                                                                                                                      | હા                                                                                      |
| `Fast Quality Gates`                             | કોડ PRs; static checks, typecheck, dashboard typecheck, પ્રભાવિત unit tests                                                                                                                                                        | હા                                                                                      |
| `Forgotten sibling tests`                        | કોડ PRs; બદલાયેલા મોડ્યુલોને static consumers અને સંભવિત sibling tests સુધી ટ્રેસ કરવામાં આવે છે; barrel અને dynamic-import પાથ્સને સંદર્ભિત allowlist exceptions સાથે સલાહકારી diagnostics તરીકે રિપોર્ટ કરવામાં આવે છે           | **સલાહકારી**                                                                            |
| `Vitest (fast-path)`                             | કોડ PRs; ઝડપી vitest suite                                                                                                                                                                                                         | હા                                                                                      |
| `Unit Tests fast-path`                           | કોડ PRs; 4-shard unit suite                                                                                                                                                                                                        | હા                                                                                      |
| `No new ESLint warnings`                         | કોડ PRs; suppressions-aware lint guard                                                                                                                                                                                             | પોતાના મૂળના PRs માટે હા, forks માટે સલાહકારી                                           |
| `Merge integrity (changelog + generated skills)` | નોન-ડ્રાફ્ટ PRs; changelog અને generated skill sync                                                                                                                                                                                | પોતાના મૂળના PRs માટે હા, forks માટે સલાહકારી                                           |

#### ભૂલાઈ ગયેલા sibling tests નો રિપોર્ટ

`npm run check:forgotten-sibling-tests` test-impact map પાછળના import resolver નો પુનઃઉપયોગ કરે છે.
દરેક બદલાયેલા production module માટે, જ્યારે સંભવિત
test pull-request diff માં ગેરહાજર હોય ત્યારે તે નિર્ધારિત
`changed module/symbol -> static consumer -> candidate sibling test` શૃંખલાઓ રિપોર્ટ કરે છે. કોઈ પણ અવરોધક rollout પહેલાં calibration માટે Markdown સારાંશ અને JSON પરિણામને
...
અવરોધક finding બનાવતા નથી. સમીક્ષા કરાયેલા exceptions
`config/quality/forgotten-sibling-allowlist.json` માં રહે છે. દરેક entry માં consumer અને candidate
test નું નામ હોવું આવશ્યક છે, ચોક્કસ rationale આપવું આવશ્યક છે અને GitHub issue અથવા pull request ની link હોવી આવશ્યક છે. ખોટી રીતે રચાયેલી entries
નિષ્ફળતા તરફ બંધ થાય છે. Exceptions કાઢી નાખેલા candidate test અથવા `.skip`/`.todo` ઉમેરતા diff ને suppress કરી શકતા નથી;
assertion weakening અને અન્ય masking ની જવાબદારી સ્વતંત્ર રીતે અવરોધક
`check:test-masking` gate ની જ રહે છે.

### જોબ: `lint`

`main` માટેના દરેક PR પર ચાલે છે. નિષ્ફળતા થાય તો merge ને અવરોધે છે.

| સ્ક્રિપ્ટ (`npm run ...`)         | શું માન્ય કરે છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | અવરોધક                                  |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| `check:node-runtime`              | Node.js સંસ્કરણ સમર્થિત શ્રેણીમાં છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | હા                                      |
| `check:cycles`                    | ચક્રીય imports — બધા `src/` + `open-sse/` modules                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | હા                                      |
| `check:route-validation:t06`      | તમામ routes પર Zod schemas હાજર છે (Tier 6 નીતિ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | હા                                      |
| `check:any-budget:t11`            | `@ts-expect-error // any`ની સંખ્યા નિર્ધારિત મર્યાદાથી વધતી નથી (Tier 11 catraca)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | હા                                      |
| `check:provider-consistency`      | `providers.ts`માંના દરેક provider માટે `providerRegistry.ts`માં સુસંગત entry છે (અને તેનાથી વિપરીત પણ, allowlistની મર્યાદામાં)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | હા                                      |
| `check:model-lifecycle`           | હાથેથી જાળવવામાં આવતા ત્રણ routing tables checked-in lifecycle snapshot (#11503) સાથે સુસંગત રહે છે: `FITNESS_TABLE` (`taskFitness.ts`) એવા કોઈ retired idને score કરતું નથી જેને `REGISTRY` route કરી શકે; દરેક `BUILT_IN_ALIASES` target `REGISTRY`માં હાજર અને retired-id snapshotમાં ગેરહાજર છે; `REGISTRY`માં હજી રહેલું દરેક retired id forward કરાયેલું છે અથવા `allowedRetiredInCatalog`માં સૂચિબદ્ધ છે; અને કોઈ `DEFAULT_DEGRADATION_MAP` source કે target તે snapshotમાં retired તરીકે દેખાતું નથી. આ સાબિત કરતું નથી કે model હાલમાં live upstream દ્વારા serve થાય છે. Offline — `config/quality/model-lifecycle.json` સાથે સરખામણી કરે છે, જેને `npm run quality:refresh-model-lifecycle` વડે હાથેથી refresh કરવામાં આવે છે (network; CI સાથે જોડાયેલ નથી). `allowedRetiredInCatalog` એક burn-down ratchet છે: entry ફક્ત tracking issue સાથે જ ઉમેરો. | હા                                      |
| `check:fetch-targets`             | client-side `src/`માંનું દરેક `fetch("/api/...")` વાસ્તવિક `route.ts` સુધી resolve થાય છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | હા                                      |
| `check:deps`                      | repoમાંના દરેક `package.json`ની તમામ `npm install`-યોગ્ય dependencies `dependency-allowlist.json`માં છે; નવી unpinned અથવા slopsquatted packagesને flag કરવામાં આવે છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | હા                                      |
...
| `check:lockfile`                  | `package-lock.json`ની અખંડિતતા — https registry, integrity hashes, કોઈ host overrides નહીં                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | હા                                      |
| `check:licenses`                  | production dependencies માટે SPDX license allowlist                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | હા                                      |
| `check:tracked-artifacts`         | કોઈ build artifacts / committed `node_modules` symlinks નહીં (husky pre-commitમાં પણ ચાલે છે; pre-push ઇરાદાપૂર્વક હળવું છે — #6716)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | હા                                      |
| `check:vitest-exclusions`         | દરેક Vitest exclusion tracking issueનો ઉલ્લેખ કરે છે અને `config/quality/vitest-exclusions.json`માં દેખાય છે (#13204)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | હા                                      |
| `check:file-size`                 | કોઈ source file પ્રતિ-extension મર્યાદા કરતાં મોટી નથી (ratchet: `frozen` યાદીમાં સ્થિર કરેલી મોટી files)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | હા                                      |
| `check:error-helper`              | executors/handlersમાં error responses `buildErrorBody()` / `sanitizeErrorMessage()`નો ઉપયોગ કરે છે (Hard Rule #12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | હા                                      |
| `check:migration-numbering`       | Migration SQL files ક્રમિક રીતે ક્રમાંકિત છે, કોઈ gaps અથવા duplicates નથી                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | હા                                      |
| `check:public-creds`              | `publicCreds.ts`ની બહાર કોઈ literal OAuth `client_id`/`client_secret` અથવા Firebase Web keys નથી (Hard Rule #11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | હા                                      |
| `check:db-rules`                  | `src/lib/db/` modulesની બહાર કોઈ raw SQL નથી; `localDb.ts`માંથી કોઈ barrel-imports નથી (Hard Rules #2/#5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | હા                                      |
| `check:known-symbols`             | તેમના dispatch tablesમાં registered provider executors, routing strategies અને translators disk પરની files સાથે મેળ ખાય છે — કોઈ orphaned અથવા undeclared symbols નથી                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | હા                                      |
| `check:route-guard-membership`    | child process spawn કરતો દરેક route `isLocalOnlyPath()` દ્વારા classified છે (Hard Rules #15/#17)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | હા                                      |
| `check:test-discovery`            | repoમાંની દરેક `*.test.ts` / `*.spec.ts` file ઓછામાં ઓછા એક test runner દ્વારા collect થાય છે (ratchet: `test-discovery-baseline.json`માંની orphan યાદી ફક્ત નાની થઈ શકે છે)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | હા                                      |
| `check:agent-skills-sync`         | Generated agent-skills artifacts તેમના source catalog સાથે મેળ ખાય છે (કોઈ drift નથી)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `check:provider-asset-provenance` | Provider logos/assets માટે નોંધાયેલી provenance entry છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `lint:json`                       | JSON config files parse થાય છે અને repo lint rulesને સંતોષે છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `typecheck:core`                  | errors વિના TypeScript compilation (ફક્ત advisory warnings)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | હા                                      |
| `typecheck:noimplicit:core`       | કડક `noImplicitAny` — ભવિષ્યલક્ષી; અગાઉથી હાજર ઘણી call sitesને હજી annotationsની જરૂર છે                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | **સલાહરૂપ** (`continue-on-error: true`) |
| `check:dashboard-typecheck`       | `src/app/(dashboard)/**` સુધી મર્યાદિત `tsc` (#7033) — `typecheck:core`ની પસંદ કરેલી 27-file allowlistમાં કોઈ dashboard TSX સામેલ નથી, અને `next build` પણ તેને ક્યારેય type-check કરતું નથી (`next.config.mjs`માં `ignoreBuildErrors: true` સેટ છે), તેથી ત્યાંની orphaned-identifier regressions (#6625/#6909) CI માટે અદૃશ્ય હતી. સ્થિર કરેલા પ્રતિ-file/પ્રતિ-TS-code count baseline (`config/quality/dashboard-typecheck-baseline.json`, `check:known-symbols` જેવી જ stale-enforcement pattern) સામે diffs કરે છે — baselined countથી વધુ ફક્ત નવા errors જ gateને નિષ્ફળ કરે છે; અગાઉથી હાજર error સુધારવામાં આવે ત્યારે `--update` વડે ratchet ઘટાડો.                                                                                                                                                                                                       | હા                                      |

### જોબ: `quality-gate`

`test-coverage` પછી ચાલે છે. નિષ્ફળતા થાય તો મર્જને અવરોધે છે.

| સ્ક્રિપ્ટ                    | ચકાસણી                                                                                                                                                           | અવરોધક                 |
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| `quality:collect`            | `quality-metrics.json` ઉત્પન્ન કરે છે (ESLint ચેતવણીઓની સંખ્યા, મર્જ કરેલા શાર્ડ રિપોર્ટમાંથી કવરેજ)                                                             | હા (રૅચેટની અપસ્ટ્રીમ) |
| `quality:ratchet`            | `quality-baseline.json` માંનો દરેક મેટ્રિક પાછળ ગયો નથી (ESLint ચેતવણીઓ ≤ બેઝલાઇન; કવરેજ ≥ બેઝલાઇન)                                                              | હા                     |
| `check:duplication`          | કોડનું ડુપ્લિકેશન (jscpd@4) `quality-baseline.json` માંની બેઝલાઇનથી વધારે નથી                                                                                    | હા                     |
| `check:complexity`           | ફાઇલ-સ્તરની સાઇક્લોમેટિક જટિલતા મર્યાદાથી વધારે નથી (મુખ્ય ESLint `complexity` + `max-lines-per-function`)                                                       | હા                     |
| `check:cognitive-complexity` | કૉગ્નિટિવ જટિલતા રૅચેટ (`eslint-plugin-sonarjs`) — અલગ ESLint પાસ; CI બંનેને એકમાત્ર `check:complexity-ratchets` સ્ટેપ તરીકે મર્જ કરીને ચલાવે છે                 | હા                     |
| `check:dead-code`            | વપરાશમાં ન હોય તેવા એક્સપોર્ટ્સ / ફાઇલોનું રૅચેટ (knip) બેઝલાઇનની સરખામણીએ પાછળ જતું નથી                                                                         | હા                     |
| `check:compression-budget`   | કમ્પ્રેશન બેન્ચમાર્ક બજેટ — દરેક એન્જિન માટેની ટોકન-બચતની ન્યૂનતમ મર્યાદા પાછળ જવી જોઈએ નહીં                                                                     | હા                     |
| `check:type-coverage`        | ટાઇપ થયેલા કોડની ટકાવારીનું રૅચેટ (`type-coverage`) પાછળ જતું નથી; મોટા ભાગે `typecheck:noimplicit:core` ને સમાવી લે છે                                          | હા                     |
| `check:codeql-ratchet`       | ખુલ્લી CodeQL ચેતવણીઓની સંખ્યા વધતી નથી (`gh api` દ્વારા વાંચે છે; ટોકન વિના સુગમ રીતે છોડી દે છે) — રિફ્રેશ આવર્તન અને મેન્યુઅલ ટ્રિગર: નીચે "CodeQL રૅચેટ" જુઓ | હા                     |

### જોબ: `quality-extended`

સમગ્ર જોબ સલાહાત્મક છે (`continue-on-error: true`). npm-આધારિત રૅચેટ્સ
વાસ્તવમાં ચાલે છે; બાહ્ય સ્કેનર્સ `gh release download` દ્વારા ઇન્સ્ટોલ થાય છે અને જ્યારે
બાઇનરી હજી પણ ગેરહાજર હોય ત્યારે જાતે જ છોડી દે છે (exit 0).

| સ્ક્રિપ્ટ                | ચકાસણી                                                                                                                                                                                           | અવરોધક        |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------- |
| `check:circular-deps`    | કોઈ સર્ક્યુલર ડિપેન્ડન્સી નથી (dpdm)                                                                                                                                                             | **સલાહાત્મક** |
| `check:bundle-size`      | બંડલનું કદ મર્યાદાથી વધારે નથી                                                                                                                                                                   | **સલાહાત્મક** |
| `check:secrets`          | સિક્રેટ સ્કેનિંગ (gitleaks) — બાઇનરી ગેરહાજર હોય તો છોડી દે છે                                                                                                                                   | **સલાહાત્મક** |
| `check:vuln-ratchet`     | ડિપેન્ડન્સીની નબળાઈઓ (osv-scanner) પાછળ જતી નથી — બાઇનરી ગેરહાજર હોય તો છોડી દે છે                                                                                                               | **સલાહાત્મક** |
| `check:workflows`        | વર્કફ્લો લિન્ટ (actionlint + zizmor) — બાઇનરીઓ ગેરહાજર હોય તો છોડી દે છે                                                                                                                         | **સલાહાત્મક** |
| `check:openapi-breaking` | બેઝ બ્રાન્ચની સરખામણીએ જાહેર API કોન્ટ્રાક્ટ (`openapi.yaml`) માં બ્રેકિંગ ફેરફારો (oasdiff) — `openapiBreaking=N` ઉત્પન્ન કરે છે; oasdiff ગેરહાજર હોય અથવા બેઝ સ્પેક ઉકેલી ન શકાય તો છોડી દે છે | **સલાહાત્મક** |

### જોબ: `docs-sync-strict`

`main` માટેની દરેક PR પર ચાલે છે. નિષ્ફળતા થાય તો મર્જને અવરોધે છે.

| સ્ક્રિપ્ટ                      | શું માન્ય કરે છે                                                                                                                                             | અવરોધક                       |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------- |
| `check:docs-all`               | નીચેના 6 ઉપ-ગેટને ક્રમિક રીતે ચલાવતું મેટા-ગેટ                                                                                                               | હા                           |
| ↳ `check:docs-sync`            | CHANGELOG / OpenAPI / llm.txt સંસ્કરણ સુસંગતતા                                                                                                               | હા                           |
| ↳ `check:docs-counts`          | ગદ્યમાં આપેલી સંખ્યાઓ (પ્રદાતાની સંખ્યા, માઇગ્રેશનની સંખ્યા વગેરે) વાસ્તવિક સંખ્યાઓની રૅચેટ વિન્ડોની અંદર છે                                                 | હા                           |
| ↳ `check:env-doc-sync`         | `.env.example` માંનું દરેક env var દસ્તાવેજોના કોષ્ટકમાં દસ્તાવેજીકૃત છે અને તેનાથી વિપરીત પણ                                                                | હા                           |
...
| `check:cli-i18n`               | CLI કમાન્ડ સ્ટ્રિંગ્સ બધી i18n locale ફાઇલોમાં હાજર છે                                                                                                       | હા                           |
| `check:openapi-coverage`       | OpenAPI સ્પેક વાસ્તવિક રૂટ્સના ઓછામાં ઓછા રૅચેટેડ લઘુત્તમ સ્તરને આવરી લે છે                                                                                  | હા                           |
| `check:openapi-security-tiers` | `openapi.yaml` માંની સુરક્ષા સ્તરની ઍનોટેશન્સ `routeGuard.ts` વર્ગીકરણો સાથે સુસંગત છે                                                                       | **સલાહરૂપ**                  |
| `check:openapi-routes`         | `openapi.yaml` માંનો દરેક પાથ વાસ્તવિક `route.ts` તરફ નિર્દેશ કરે છે (ભ્રમજન્ય માહિતી વિરોધી)                                                                | હા                           |
| `check:docs-symbols`           | `docs/**/*.md` માંનો દરેક `/api/...` સંદર્ભ વાસ્તવિક `route.ts` તરફ નિર્દેશ કરે છે (ભ્રમજન્ય માહિતી વિરોધી)                                                  | હા                           |
| `i18n translation drift`       | i18n locale ફાઇલોમાં અનુવાદ ન થયેલી કીઝ — માત્ર ચેતવણી                                                                                                       | **સલાહરૂપ**                  |

### કાર્ય: `i18n-ui-coverage`

| સ્ક્રિપ્ટ                         | શું માન્ય કરે છે                                                                                                                                                                   | અવરોધક      |
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `check-ui-keys-coverage` (inline) | UI i18n કી કવરેજ ≥ 65% છે                                                                                                                                                          | હા          |
| `check-ui-value-drift` (inline)   | ફરી લખાયેલું અંગ્રેજી **મૂલ્ય** કોઈ જૂનો અનુવાદ પાછળ છોડતું નથી                                                                                                                    | હા          |
| `check-new-key-coverage` (inline) | એક **નવી** અંગ્રેજી કી દરેક locale સુધી પહોંચે છે                                                                                                                                  | હા          |
| `check-translation-ratio`         | locale દીઠ વાસ્તવિક-અનુવાદ ગુણોત્તર (અંગ્રેજી સમાન / placeholder / allowlistની બહાર ગુમ થયેલી લીવ્સ) `config/quality/i18n-translation-baseline.json` + slack કરતાં વધુ ન હોવો જોઈએ | **સલાહરૂપ** |

`fetch-depth: 0` જરૂરી છે — value-drift ગેટ merge baseની સામે `en.json` નો diff કરે છે.

#### `check-ui-value-drift` — જૂના-અનુવાદનો ગેટ

આ એવી એક i18n રિગ્રેશન પકડે છે જેને અન્ય ગેટ્સ માળખાકીય રીતે જોઈ શકતા નથી: કોઈ અંગ્રેજી મૂલ્ય
ફરી લખવામાં આવે અને _અગાઉના_ અંગ્રેજી પરથી બનેલા અનુવાદો યથાવત્ રહી જાય, જેથી
બિન-અંગ્રેજી વપરાશકર્તાઓ આત્મવિશ્વાસપૂર્વક લખાયેલું, પરંતુ હવે ખોટું લખાણ વાંચતા રહે.

આ ખરેખર રિલીઝ થયું હતું. Antigravity login helper ઉમેરાયો ત્યારે (#5203)
`oauthModal.googleOAuthWarning` ફરી લખવામાં આવ્યું હતું; **43માંથી 39 locale**માં operatorsને "સંપૂર્ણ URL કૉપિ કરીને તેને નીચે પેસ્ટ કરો" કહેતો ટેક્સ્ટ યથાવત્ રહ્યો — એવી પ્રક્રિયા જે તે provider માટે પૂર્ણ થઈ શકતી નથી. #8463 સુધી આ ધ્યાનમાં આવ્યું નહીં, કારણ કે:

- `sync-ui-keys` માત્ર **ગેરહાજર** કીઝ જ બૅકફિલ કરે છે, **જૂની** કીઝ ક્યારેય નહીં;
- `check-ui-keys-coverage` કીની _હાજરી_ ગણે છે, તેથી જૂનો અનુવાદ પણ આવરી લેવાયેલો ગણાય છે;
- `check-translation-drift` `docs/i18n/<locale>/**.md` દસ્તાવેજીકરણ mirrorsને ટ્રૅક કરે છે —
  તે `src/i18n/messages/*.json` ક્યારેય વાંચતું નથી. 2026-09ના પુનઃ-સિંકથી job `docs-sync-strict`માં અવરોધક: મુખ્ય દસ્તાવેજમાં ફેરફાર કરો → `npm run i18n:run -- --files=<doc>` (વિભાગ-સ્તરીય, સસ્તું).

**ડિફ-અવેર, બેઝલાઇન-આધારિત નહીં.** તે મર્જ બેઝ પરના `en.json`ની વર્કિંગ ટ્રી સાથે તુલના કરે છે; જે દરેક કીનું અંગ્રેજી મૂલ્ય બદલાયું હોય, તેના માટે હજુ પણ અસ્પર્શિત અનુવાદ ધરાવતી કોઈપણ લોકેલ જૂની ગણાય છે. આ ઇરાદાપૂર્વક **પહેલેથી અસ્તિત્વમાં રહેલું ઋણ સ્થિર રાખે છે** — લાંબા સમયથી રહેલો અનુવાદ કયા જૂના અંગ્રેજી લખાણમાંથી આવ્યો હતો તે ડિફ બતાવી શકતું નથી, તેથી ગેટ ફક્ત વર્તમાન ફેરફાર જે વસ્તુઓને સ્પર્શે છે તેનું જ મૂલ્યાંકન કરે છે. વિકલ્પ (પ્રતિ-કી હૅશ બેઝલાઇન) માટે ~600 KBની જનરેટ કરેલી ફાઇલની જરૂર પડે, જે હાલની સૌથી મોટી બેઝલાઇન કરતાં 3× મોટી હોય અને દરેક i18n PR પર બદલાતી રહે.

તેને સંતોષવાની બે રીતો:

1. અસરગ્રસ્ત અનુવાદો અપડેટ કરો, અથવા
2. તેમને `__MISSING__:<new english>` પર સેટ કરો — ત્યારબાદ રનટાઇમ સુધારેલું અંગ્રેજી લખાણ આપે છે
...
જ્યારે બેઝ કૅટલૉગ વાંચી શકાતો નથી (બેઝ ref વિનાનું શેલો ક્લોન), ત્યારે `check-openapi-breaking`ની જેમ `SKIP reason=base-unresolved` સાથે 0 એક્ઝિટ કરે છે.

### જોબ: `i18n`

સંપૂર્ણ i18n માન્યતા મેટ્રિક્સ (દરેક લોકેલ દીઠ એક જોબ). આખી જોબ સલાહરૂપ છે.

| સ્ક્રિપ્ટ                       | શું માન્ય કરે છે                | અવરોધક                                             |
| ------------------------------- | ------------------------------- | -------------------------------------------------- |
| `validate_translation.py quick` | દરેક લોકેલ દીઠ અનુવાદની પૂર્ણતા | **સલાહરૂપ** (આખી જોબ પર `continue-on-error: true`) |

### જોબ: `pr-test-policy`

ફક્ત પુલ રિક્વેસ્ટ પર ચાલે છે.

| સ્ક્રિપ્ટ              | શું માન્ય કરે છે                                                                                                                       | અવરોધક |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| `check:pr-test-policy` | `src/`, `open-sse/`, `electron/`, અથવા `bin/`માં પ્રોડક્શન કોડ બદલતા PRમાં ટેસ્ટ સામેલ અથવા અપડેટ થયેલા હોવા આવશ્યક છે (કડક નિયમ #8)   | હા     |
| `check:test-masking`   | બદલાયેલી ટેસ્ટ ફાઇલો ચોખ્ખી assert સંખ્યા ઘટાડતી નથી અથવા `assert.ok(true)` જેવી સ્વયંસિદ્ધ અભિવ્યક્તિઓ ઉમેરતી નથી                     | હા     |
| `check:pr-evidence`    | PR બોડીમાં ફેરફાર માટે ટેસ્ટ/VPS પુરાવાનો ઉલ્લેખ હોય છે (PRના ગદ્યમાં શોધ કરીને કડક નિયમ #18ને યાંત્રિક બનાવે છે — નાજુક, Backlog જુઓ) | હા     |
...
| `test:vitest:ui` | UI કમ્પોનન્ટ ટેસ્ટ્સ — vitest રનર                  | **અવરોધક** — પહેલેથી અસ્તિત્વમાં રહેલી નિષ્ફળતાઓને `vitest.config.ts`માં સ્પષ્ટ રીતે બાકાત રાખવામાં આવી છે; નવી નિષ્ફળતાઓ જોબને નિષ્ફળ બનાવે છે |

### રાત્રિકાલીન વર્કફ્લો (નિર્ધારિત, સલાહરૂપ)

આ cron શેડ્યૂલ પર (અને `workflow_dispatch` દ્વારા) ચાલે છે, PR પર ક્યારેય નહીં. બધા સલાહરૂપ છે.

| વર્કફ્લો               | શું માન્ય કરે છે                                                                                                                                                | અવરોધક      |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `nightly-property`     | રેન્ડમ સીડ + ઊંચી રન સંખ્યા સાથે fast-check પ્રોપર્ટી ટેસ્ટ્સ                                                                                                   | **સલાહરૂપ** |
...
| `nightly-schemathesis` | `docs/openapi.yaml`નો ઉપયોગ કરીને લાઇવ OmniRoute સામે OpenAPI કોન્ટ્રાક્ટ ફઝિંગ (schemathesis) — સ્પેકના ઉલ્લંઘનો / અનહેન્ડલ્ડ 500s ઉજાગર કરે છે (તબક્કો 8 B.4) | **સલાહરૂપ** |
| `nightly-mutation`     | ઝડપી યુનિટ લેન પર Stryker મ્યુટેશન-ટેસ્ટિંગ સ્કોર — બચી ગયેલા મ્યુટન્ટ્સ નબળા asserts ઉજાગર કરે છે                                                              | **સલાહરૂપ** |
...
- સપ્લાય-ચેઇન (મૂળસ્રોત, SBOM, Trivy, Scorecard): [`docs/security/SUPPLY_CHAIN.md`](../security/SUPPLY_CHAIN.md)
...
દરેક `src/i18n/messages/<locale>.json` ના લીફ કી સેટની `en.json` સાથે સરખામણી કરે છે અને
કી ક્યારે ઉમેરાઈ હતી તે ધ્યાનમાં લીધા વિના, કોઈપણ ગેરહાજર અથવા વધારાની લીફ હોય તો નિષ્ફળ જાય છે. `__MISSING__:` પ્લેસહોલ્ડરો
હાજર તરીકે ગણાય છે (તેમની સામગ્રી રેશિયો ગેટનો વિષય છે). આ બે diff-આધારિત/ટકાવારી ગેટ્સનું સંપૂર્ણ પૂરક
છે: `check-ui-keys-coverage` દરેક
લોકેલ માટે 80 % ની ન્યૂનતમ મર્યાદા લાગુ કરે છે (~13,000 માંથી 43 ગેરહાજર કી હોવા છતાં પણ 99.7 % દેખાય છે) અને `check-new-key-coverage`
માત્ર PR દ્વારા `en.json` માં ઉમેરાયેલી કીનું મૂલ્યાંકન કરે છે. લોકેલ બૅચ તેની બ્રાન્ચ બનાવવામાં આવે તે દિવસના `en.json` પરથી જનરેટ
થાય છે અને આધાર બ્રાન્ચમાં નવી કી ઉમેરાતી રહે ત્યારે તે ઘણા દિવસો સુધી અનુવાદિત થાય છે; બૅચ PR પોતે કોઈ
કી ઉમેરતું નથી, તેથી બૅચ 1 (#13044) નવ
લોકેલમાં 43 કી ઓછા સાથે અને બૅચ 2 (#13660) આઠ લોકેલમાં 10 કી ઓછા સાથે મર્જ થયા ત્યારે બંને સંબંધિત ગેટ મૌન રહ્યા (2026-09-15). નિષ્ફળતા આ રીતે સુધારો:
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers`; `extra` લીફનો
અર્થ એ છે કે સ્રોતમાંથી તે દૂર થઈ ગઈ છે — તેને લોકેલમાંથી કાઢી નાખો. `--warn` નિષ્ફળ થયા વિના અહેવાલ આપે છે.
`--catalog=cli` એ જ સરખામણી `bin/cli/locales` પર ચલાવે છે (`npm run i18n:check-keys:cli`);
બંને પગલાં જોબ `i18n-ui-coverage` માં છે.

#### `check-new-key-coverage` — નવી-કી i18n ગેટ

`check-ui-value-drift` નો સંબંધિત ગેટ. તે એવા અંગ્રેજી મૂલ્યને પકડે છે જેને **ફરીથી લખવામાં આવ્યું**
હોય પરંતુ તેના અનુવાદો પાછળ રહી ગયા હોય; આ ગેટ એવી અંગ્રેજી કીને પકડે છે જેને **ઉમેરવામાં આવી**
હોય પરંતુ કેટલાક લોકેલને તે ક્યારેય મળી ન હોય.

`check-ui-keys-coverage` આ પ્રકારની સ્થિતિ જોઈ શકતું નથી: તે દરેક લોકેલ માટે ટકાવારીની ન્યૂનતમ મર્યાદા લાગુ કરે છે અને
~13,000 માંથી અગિયાર કી ગેરહાજર હોવા છતાં કવરેજ 99.9% રહે છે. ભાષા દીઠ ટકાવારી
"આ સુવિધા અનુવાદ વિના રિલીઝ થઈ" એ વ્યક્ત કરી શકતી નથી — નવી લોકેલમાં આખી સુવિધા કોઈ
લખાણ વિના આવી શકે છે અને આંકડો જરાય બદલાતો નથી.

તે જે ઘટનાને સંકેતબદ્ધ કરે છે: Orchestration Canvas ના Phase 3 એ તેની અગિયાર કીનો તે સમયે
અસ્તિત્વમાં રહેલા 42 લોકેલમાં અનુવાદ કર્યો હતો. કલાકો પછી EU-ભાષા બૅચ (#13044) એ રિપોને
51 લોકેલ સુધી પહોંચાડ્યો અને નવ નવા લોકેલ (`el`, `et`, `ga`, `hr`, `lt`, `lv`, `mt`, `sl`, `sr`) ને તે
ક્યારેય મળ્યા નહીં. `deepMergeFallback` ગેરહાજર કીની જગ્યાએ અંગ્રેજી મૂકે છે, તેથી નિષ્ફળતાનું સ્વરૂપ
ખાલી UI ને બદલે અનુવાદ વિનાનું UI હતું — વાસ્તવિક, અને તેની રચનાને કારણે મૌન.

તેના સંબંધિત ગેટની જેમ, આ પણ **diff-aware** છે અને મર્જ બેઝ પરના અંગ્રેજીની વર્કિંગ
ટ્રી સાથે સરખામણી કરે છે, તેથી પહેલાંથી રહેલી ખામીઓ સ્થિર રહે છે અને ગેટ ચાલુ કરવા માટે કોઈ માઇગ્રેશનની જરૂર પડી નહીં. વૈકલ્પિક માર્ગ:
`__MISSING__:<english>` રનટાઇમને યોગ્ય રાખીને અનુવાદને મુલતવી રાખે છે. `vi` માં
પ્લેસહોલ્ડરો પ્રતિબંધિત છે (`tests/unit/i18n-vi-completeness.test.ts`) અને વાસ્તવિક અનુવાદ જરૂરી છે.

#### `check-vitest-exclusions` — સ્થગિત-ટેસ્ટ ગેટ

`vitest.config.ts` ની `exclude` સૂચિમાં રહેલી ફાઇલ એવી ટેસ્ટ છે જે ચાલતી નથી, અને ટ્રી વાંચનાર વ્યક્તિને તે
કવરેજ જેવી દેખાય છે. બાસઠ ફાઇલો
`// #8618 — pre-existing failure; remove this exclusion when fixed` ટિપ્પણી પાછળ એકઠી થઈ હતી. Issue #8618 ને
2026-08-11 ના રોજ બંધ કરવામાં આવી હતી, જ્યારે તે ટ્રૅક કરતી સૂચિ 45 એન્ટ્રીથી વધીને 62 થઈ હતી અને દરેક નવી એન્ટ્રીને બંધ થઈ ગયેલી issue તરફ
નિર્દેશ કરતી ટિપ્પણી વારસામાં મળી હતી. જ્યારે આખરે સૂચિનું ફાઇલ-દર-ફાઇલ માપન કરવામાં આવ્યું (#13204), ત્યારે **62 માંથી 51
કોઈ સ્રોત ફેરફાર વિના વર્તમાન ટ્રી સામે પાસ થઈ**.

ગેટ માટે જરૂરી છે કે વાસ્તવિક ફાઇલ તરીકે રિઝોલ્વ થતી દરેક exclusion (a) ટ્રૅકિંગ issue નો ઉલ્લેખ કરે અને
(b) તેની માપેલી સ્થિતિ સાથે `config/quality/vitest-exclusions.json` માં દેખાય, જેથી નવી exclusion ઉમેરવી એ
60-એન્ટ્રી ઍરેમાં વધુ એક લાઇન ઉમેરવાને બદલે સમર્પિત ફાઇલમાં સમીક્ષા કરી શકાય એવો diff બને. તે જાણીજોઈને
બાકાત રાખેલી ટેસ્ટને ફરીથી ચલાવતું નથી — તેમાં ~10 મિનિટ લાગે છે અને તે સમયાંતરે ચાલતી જોબમાં હોવું જોઈએ; ઇન્વેન્ટરીમાં
દરેકનું છેલ્લે ક્યારે માપન થયું હતું તે નોંધાય છે.
