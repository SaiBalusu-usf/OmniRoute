...
## 2. இணைப்பு குளிர்விப்பு

**வரம்பு:** ஒற்றை வழங்குநர் இணைப்பு/கணக்கு/விசை.

**நோக்கம்:** அதே வழங்குநரின் பிற இணைப்புகள் தொடர்ந்து சேவையளிக்கும் நிலையில், ஒரு செயலிழந்த விசையைத் தவிர்த்தல்.

**செயலாக்கம்:**

- கிடைக்காததாகக் குறித்தல்: `src/sse/services/auth.ts::markAccountUnavailable()`
- தேர்வு: அதே கோப்பிலுள்ள `getProviderCredentials*`
- குளிர்விப்புக் கணக்கீடு: `open-sse/services/accountFallback.ts::checkFallbackError()`
- அமைப்புகள்: `src/lib/resilience/settings.ts`

**ஒவ்வொரு இணைப்புக்குமான புலங்கள்:**

- `rateLimitedUntil` — குளிர்விப்பு காலாவதியாகும் வரையிலான நேரமுத்திரை
- `testStatus: "unavailable"`
- `lastError`, `lastErrorType`, `errorCode`
- `backoffLevel` — அதிவேகப் பின்னடைவு எண்ணி

**இயல்புநிலைக் குளிர்விப்புகள்:**

- OAuth அடிப்படை: 5s
- API-key அடிப்படை: 3s
- API-key 429: மேல்நிலையின் `Retry-After`/மீட்டமைப்பு தலைப்புகள்/பகுக்கக்கூடிய மீட்டமைப்பு உரைக்கு முன்னுரிமை அளிக்கிறது
- பின்னடைவு: `baseCooldownMs * 2 ** failureIndex`

**ஒரே நேரத்தில் குவியும் கோரிக்கைகளுக்கு எதிரான பாதுகாப்பு:** ஒரே நேரத்தில் ஏற்படும் தோல்விகள் குளிர்விப்பை அளவுக்கதிகமாக நீட்டிப்பதையோ, `backoffLevel`-ஐ இருமுறை அதிகரிப்பதையோ தடுக்கிறது.

**இறுதி நிலைகள் (குளிர்விப்புகள் அல்ல):**

- `banned` — தடைசெய்யப்பட்ட முக்கியச்சொல் / கணக்குத் தடை கண்டறிதலால் அமைக்கப்படுகிறது ([BAN_DETECTION](../security/BAN_DETECTION.md)-ஐப் பார்க்கவும்)
- `expired` (வரம்பிடப்பட்ட மறுமுயற்சிகளுக்குப் பிறகு இறுதி நிலைக்கு மாறுகிறது — அதிவேகப் பின்னடைவுடன் `EXPIRED_RETRY_MAX = 3` — இதனால் கணக்கு நிரந்தரமாகச் செயலிழக்கச் செய்யப்படுவதற்கு முன்பு தற்காலிக OAuth பிழைகள் தானாகச் சரியாகலாம்)
- `credits_exhausted`

நற்சான்றுகள் மாறும் வரை அல்லது ஓர் இயக்குநர் அவற்றை மீட்டமைக்கும் வரை இவை நீடிக்கும். இறுதி நிலைகளைத் தற்காலிகக் குளிர்விப்பு நிலையால் மேலெழுத வேண்டாம்.

**சோம்பேறி மீட்பு:** `rateLimitedUntil` கடந்துவிட்டால், இணைப்பு மீண்டும் தகுதிபெறும். வெற்றிகரமான பயன்பாட்டின்போது, `clearAccountError()` அனைத்துப் பிழைப் புலங்களையும் அழிக்கிறது.

### அமர்வு ஒட்டுறவு (#7274)

**வரம்பு:** **எந்தவொரு** வழங்குநருக்கும், ஓர் இணைப்புடன் நிலையாகப் பிணைக்கப்பட்ட ஒரு கிளையன்ட் அமர்வு (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` தலைப்பு).

**நோக்கம்:** பல சுற்றுகளைக் கொண்ட ஓர் முகவரை (Claude Code, aider, தனிப்பயன் முகவர்கள்) கோரிக்கைகள் முழுவதும் அதே கணக்கில் வைத்திருத்தல்; இதன் மூலம் கணக்குகளுக்கு இடையிலான சூழல் இழப்பையும், ஒவ்வொரு கணக்கிற்குமான அமர்வு நிலையைக் கொண்ட வழங்குநர்களில் மீண்டும் மீண்டும் ஏற்படும் தொடக்கநிலை 429 பிழைகளையும் குறைத்தல்.
...
- தலைப்புப் பிரித்தெடுப்பு (பொதுவானது, எந்த வழங்குநருக்கும்): `src/sse/services/auth.ts::extractSessionAffinityKey()`
- நிலைபேறாகச் சேமிக்கப்பட்ட பிணைப்பு அட்டவணை: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- அமைப்பு: `sessionAffinityTtlMs` (ms-இல் உலகளாவிய TTL, `0` முடக்குகிறது) — `src/lib/db/settings.ts`. Codex-க்கு மட்டுமான `codexSessionAffinityTtlMs` என்பதிலிருந்து `124_generic_session_affinity_ttl.sql` இடம்பெயர்வால் மறுபெயரிடப்பட்டது; இது முன்பே உள்ளமைக்கப்பட்ட எந்த Codex TTL-ஐயும் புதிய இயல்புநிலையாக எடுத்துச் செல்கிறது.

#7274-க்கு முன்பு, `codex` தவிர மற்ற ஒவ்வொரு வழங்குநருக்கும் `resolveSessionAffinityTtlMs()` உடனடியாக `0`-ஐத் திருப்பியதால், பிணைப்பு இயங்குமுறையும் தலைப்புப் பிரித்தெடுப்பும் ஏற்கெனவே வழங்குநர் சார்பற்றவையாக இருந்தபோதிலும், TTL அமைப்பும் (மற்றும் அமர்வுத் தலைப்புகளும்) வேறெங்கும் எந்த விளைவையும் ஏற்படுத்தவில்லை. இந்தத் திருத்தம் அந்த முன்கூட்டிய திரும்புதலை அகற்றியது; TTL உலகளவில் `0`-க்கு மேல் அமைக்கப்பட்டவுடன், அது இப்போது ஒவ்வொரு வழங்குநருக்கும் ஒரே மாதிரியாகப் பொருந்துகிறது.

மூன்று அமர்வு-ஒட்டுறவுத் தலைப்புகளும் மேல்நிலைக்கு ஒருபோதும் அனுப்பப்படுவதில்லை — கிளையன்ட் தலைப்புகளை நேரடியாக அனுப்புவதற்குப் பதிலாக, இயக்கிகள் தங்களுக்கான மேல்நிலைத் தலைப்புகளைப் புதிதாக உருவாக்குகின்றன; எனவே இது அகத் தொடர்புறுத்தல் ID-ஆக மட்டுமே உள்ளது.

### பிரத்தியேக நிர்வகிக்கப்பட்ட அமர்வு இணைப்புக் குத்தகைகள்

**வரம்பு:** செயலிலுள்ள ஒரு நிர்வகிக்கப்பட்ட HTTP கிளையன்ட்/அமர்வு, தகுதிபெற்ற ஒரு OmniRoute இணைப்பைச் சொந்தமாகக் கொண்டிருக்கும்.

**நோக்கம்:** கோரிக்கைகள் முழுவதும் கடுமையான வழிப்படுத்தல்
எல்லை தேவைப்படும் கிளையன்ட்களுக்கு நீடித்த பிரத்தியேக இணைப்பு உரிமையை வழங்குதல். இது மென்மையான தொடர்ச்சி முன்னுரிமையான அமர்வு ஒட்டுறவிலிருந்து வேறுபடுகிறது:
ஒரு பிரத்தியேகக் குத்தகை தனது வாழ்நிலைச் சுழற்சி நிலையை SQLite-இல் நிலையாகச் சேமித்து, உலகளாவிய செயலில் உள்ள உரிமையாளர் மற்றும்
செயலில் உள்ள இணைப்பின் தனித்தன்மையை அமல்படுத்தி, வழங்குநருக்கு அனுப்புவதற்கு முன்பு காலாவதியான தலைமுறையை நிராகரிக்கிறது.

இந்த அம்சம் ஒவ்வொரு API விசைக்கும் விருப்பத் தேர்வாகும். நிர்வகிக்கப்பட்ட ஒரு விசைக்கு `lease:exclusive` வரம்பும்,
வெளிப்படையான காலியாக இல்லாத `allowedConnections` பட்டியலும் இருக்க வேண்டும். எந்த HTTP கிளையன்டும் வாழ்நிலைச் சுழற்சி முனைப்புள்ளியைப் பயன்படுத்தலாம்; எந்த
கிளையன்ட் பெயரும், user-agent-உம், வழங்குநரும், OAuth முறையும், மாதிரியும் தேவையில்லை. குத்தகை ஒரு இணைப்பைச் சொந்தமாகக் கொண்டிருக்கும்;
மாதிரியை அல்ல. எனவே இணைப்பு வழக்கமான முறையில்
தகுதிபெற்றிருக்கும் வரை, மாதிரி மாற்றப்பட்டாலும் பிணைப்பு தக்கவைக்கப்படும். இயல்பான மாதிரி, ஒதுக்கீடு, ஆரோக்கியம், குளிர்விப்பு மற்றும் அனுமதிப்பட்டியல் விதிகள் தொடர்ந்து அதிகாரபூர்வமானவையாக இருக்கும்; மேலும் அதே தலைமுறையைத் தகுதிபெற்ற மற்றொரு காலியான இணைப்புக்கு மாற்றலாம்.

வாழ்நிலைச் சுழற்சி என்பது `acquire`, `renew` மற்றும் `release` ஆகிய JSON செயல்களைக் கொண்ட `POST /api/v1/session-leases` ஆகும்.
நிர்வகிக்கப்பட்ட அனுமானக் கோரிக்கைகள் தெளிவற்ற `X-OmniRoute-Lease-Owner` மதிப்பையும் துல்லியமான
`X-OmniRoute-Lease-Generation` மதிப்பையும் வழங்குகின்றன. உரிமையாளர் மதிப்பு `vlo_`-ஐத் தொடர்ந்து 43 base64url எழுத்துகளைக் கொண்டிருக்கும்;
அதன் SHA-256 ஹாஷ் மட்டுமே சேமிக்கப்படும். ஒவ்வொரு இறுதி அனுப்பல் எல்லையும் அங்கீகரிக்கப்பட்ட API விசை ID-யுடனும்
செயலில் உள்ள இணைப்பு ID-யுடனும் பிணைக்கப்படுகிறது. குத்தகைக் கட்டுப்பாட்டுத் தலைப்புகள் பதிவுகள், தக்கவைக்கப்பட்ட கோரிக்கைப் படப்பிடிப்புகள் மற்றும்
மேல்நிலை இயக்கித் தலைப்புகளிலிருந்து அகற்றப்படுகின்றன.

வழக்கமான வழிப்படுத்தலில் தகுதிபெற்ற நிர்வகிக்கப்பட்ட வேட்பாளர்கள் இருந்தாலும், காலியாக உள்ள ஒவ்வொரு வேட்பாளரும்
வேறொரு செயலில் உள்ள குத்தகையால் ஆக்கிரமிக்கப்பட்டிருந்தால், OmniRoute HTTP `429`, குத்தகைத் திறன்-கிடைக்கவில்லை குறியீடு,
திறனுக்காகக் காத்திருக்கும் நிலை மற்றும் தொடர்புடைய மிக முந்தைய காலாவதியிலிருந்து பெறப்பட்ட வரம்பிடப்பட்ட `Retry-After` ஆகியவற்றைத் திருப்புகிறது.
வழக்கமாக எந்தத் தகுதியும் இல்லாதிருப்பது குத்தகைப் போட்டி அல்ல; அது ஏற்கெனவே உள்ள வழிப்படுத்தல் பிழைப் பொருளியலைத் தக்கவைக்கிறது.

தொடர்புடைய இயங்குமுறைகள் தனித்தனியாகவே இருக்கும்:

- OAuth அமர்வு ஆக்கிரமிப்பு என்பது OAuth கணக்குகளுக்கான செயல்முறை-உள்ளக மென்மையான பகிர்வாகும்.
- கணக்கு semaphore-கள் கோரிக்கை-ஒருங்குநிகழ்வு அனுமதிகளை வழங்குகின்றன; ஒரு கோரிக்கை முடிவடையும்போது அவையும் முடிவடைகின்றன.
- பிரத்தியேக நிர்வகிக்கப்பட்ட அமர்வுக் குத்தகைகள் தலைமுறை எல்லையைக் கொண்ட நீடித்த வாழ்நிலைச் சுழற்சி உரிமையாகும்.

---

## 3. மாடல் பூட்டுதல்

**வரம்பு:** provider + connection + model மும்மை.

**நோக்கம்:** ஒரே ஒரு மாடல் மட்டும் கிடைக்காதபோது அல்லது ஒதுக்கீட்டு வரம்பை அடைந்திருக்கும்போது, முழு இணைப்பையும் முடக்குவதைத் தவிர்ப்பது.

**எடுத்துக்காட்டுகள்:**

- ஒவ்வொரு மாடலுக்கும் தனித்தனி ஒதுக்கீடு கொண்ட வழங்குநர்கள் 429-ஐத் திருப்புதல்
- காணாமல் போன ஒரு மாடலுக்காக உள்ளூர் வழங்குநர்கள் 404-ஐத் திருப்புதல்
- வழங்குநர்-சார்ந்த பயன்முறை/மாடல் அனுமதித் தோல்விகள் (எ.கா., Grok பயன்முறைகள்)

**செயலாக்கம்:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### மாடல் காத்திருப்பு நேர டாஷ்போர்டு (v3.8.0)

UI: அமைப்புகள் → மாடல் காத்திருப்பு நேரங்கள் (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

செயலில் உள்ள பூட்டுதல்களை இவற்றுடன் பட்டியலிடுகிறது: வழங்குநர், இணைப்பு, மாடல், காரணம், காலாவதியாகும் நேரம். இயக்குநர்கள் கார்டிலிருந்து ஒரு மாடலைக் கைமுறையாக மீண்டும் இயக்கலாம்.

**REST API:**

- `GET /api/resilience/model-cooldowns` — செயலில் உள்ள பூட்டுதல்களைப் பட்டியலிடும்
- `DELETE /api/resilience/model-cooldowns` — கைமுறையாக மீண்டும் இயக்கும். கோரிக்கை உடல்: `{provider, connection, model}`. அங்கீகாரம்: நிர்வாகம்.

### பூட்டுதல் அமைப்புகள் UI + வெற்றி-தேய்வு மீட்பு (v3.8.23)

மாடல் பூட்டுதல், எப்போதும் இயக்கத்தில் இருக்கும் நிரலுக்குள் நிலையாகப் பதிக்கப்பட்ட நடத்தையிலிருந்து, தனக்கென அமைப்புகள் கார்டையும் தானாகக் குணமடையும் மீட்புப் பாதையையும் கொண்ட, முழுமையாக உள்ளமைக்கக்கூடிய விருப்பத்தேர்வு அம்சமாக மாற்றப்பட்டது.

**அமைப்புகள் கார்டு:** அமைப்புகள் → மாடல் பூட்டுதல்
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
இது மேலே உள்ள, படிக்க மட்டும் இயலும் `ModelCooldownsCard`-இலிருந்து **வேறுபட்டது** (அது செயலில் உள்ள பூட்டுதல்களை மட்டும் _பட்டியலிடுகிறது_) — புதிய கார்டு _அளவுருக்களை உள்ளமைக்கிறது_. இயல்புநிலைகள்
`DEFAULT_MODEL_LOCKOUT_SETTINGS`-இல் உள்ளன
(`src/lib/resilience/modelLockoutSettings.ts`):

| அமைப்பு                 | இயல்புநிலை                       | பொருள்                                                                                        |
| ----------------------- | -------------------------------- | --------------------------------------------------------------------------------------------- |
| `enabled`               | `false`                          | முதன்மை நிலைமாற்றி — மாடல் பூட்டுதல் **இயல்பாக முடக்கப்பட்டுள்ளது**.                          |
| `errorCodes`            | `[403, 404, 429, 502, 503, 504]` | மாடல்-வரம்புடைய தோல்வியாகக் கணக்கிடப்படும் மேல்நிலை நிலைக் குறியீடுகள்.                       |
| `baseCooldownMs`        | `120_000` (120 வி)               | முதல் தோல்விக்கான ஆரம்பப் பூட்டுதல் காலம்.                                                    |
| `maxCooldownMs`         | `1_800_000` (30 நிமி)            | அதிகரிக்கப்பட்ட காத்திருப்பு நேரத்தின் உச்சவரம்பு.                                            |
| `maxBackoffSteps`       | `10`                             | அதிகபட்ச அதிவேகப் பின்னடைவு அதிகரிப்புப் படிகள்.                                              |
| `useExponentialBackoff` | `true`                           | மீண்டும் மீண்டும் நிகழும் தோல்விகள் காத்திருப்பு நேரத்தை அதிவேகமாக அதிகரிக்க வேண்டுமா என்பது. |

அமைப்புகள் வழக்கமான அமைப்புச் சேமிப்பகம் வழியாக நிலையாகச் சேமிக்கப்பட்டு, மீள்திறன் அமைப்புத் திட்டவரையறை மூலம் சரிபார்க்கப்படுகின்றன; கார்டு `baseCooldownMs`/`maxCooldownMs`-ஐ
(`maxCooldownMs ≥ baseCooldownMs` என்பதுடன்) மற்றும் `maxBackoffSteps`-ஐ வரம்புக்குள் கட்டுப்படுத்துகிறது.

**வெற்றி-தேய்வு மீட்பு:** மீட்பு என்பது முழுக்க நேரமானியின் காலாவதியை மட்டுமே சார்ந்ததல்ல. ஒரு சீரான பதில் மாடலின் தோல்வி எண்ணிக்கையைப் படிப்படியாகக் குறைக்கிறது; இதனால் இடைப்பட்ட காலத்திலேயே மீண்ட மாடலின் அதிகரிப்பு நிறுத்தப்பட்டு, அதன் நேரமானி முடிவதற்கு முன்பே பூட்டுதல் நீக்கப்படும். ஒரு வெற்றிகரமான சேர்க்கை இலக்கில், `open-sse/services/combo.ts` ஆனது `decayModelFailureCount()`-ஐ
(`open-sse/services/accountFallback.ts`) அழைக்கிறது; இது சேமிக்கப்பட்டுள்ள
`failureCount`-ஐ **பாதியாகக் குறைக்கிறது** (`Math.floor(failureCount / 2)`); அது `0`-ஐ எட்டும்போது பூட்டுதல் பதிவு முழுமையாக நீக்கப்படுகிறது. இதற்கு இணையான `recordModelLockoutFailure()`, அதிகரிப்பு சாளரத்திற்குள் ஏற்படும் தோல்விகளில் எண்ணிக்கையை அதிகரித்து, காத்திருப்பு நேரத்தையும் அதிகரிக்கிறது. இந்த வெற்றி-தேய்வு, சாதாரண நேரமானி காலாவதிக்குக் கூடுதலானது — எந்தப் பாதையின் மூலமும் ஒரு மாடலை மீண்டும் இயக்க முடியும்.

**நிலை:** பூட்டுதல்கள் தரவுத்தளத்தில் நிலையாகச் சேமிக்கப்படாமல், **நினைவகத்தில்** (ஒவ்வொரு செயல்முறைக்கும் `provider:connectionId:model`-ஐ விசையாகக் கொண்ட `ModelLockoutEntry`-இன் `Map`-கள்) வைக்கப்படுகின்றன — மறுதொடக்கத்தின்போது அவை இழக்கப்படும். _அமைப்புகள்_ நிலையாகச் சேமிக்கப்படுகின்றன; செயலில் உள்ள பூட்டுதல் _நிலை_ தற்காலிகமானது.
...
- ஒரு வழங்குநருக்கான அனைத்து விசைகளும் தவிர்க்கப்படுகின்றன → சுற்றுத் துண்டிப்பானின் நிலை மற்றும் ஒவ்வொரு இணைப்பின் `rateLimitedUntil`/`testStatus` ஆகிய இரண்டையும் சரிபார்க்கவும்.
- மீட்டமைப்புச் சாளரத்திற்குப் பிறகு வழங்குநர் நிரந்தரமாக விலக்கப்படுகிறார் → `getStatus()`/`canExecute()`-க்குப் பதிலாக மூல `state`-ஐ வாசிக்கும் குறியீடு.
- ஒரு விசை தோல்வியுற்றாலும் மற்றவை செயல்பட வேண்டும் → சுற்றுத் துண்டிப்பானைக் காட்டிலும் இணைப்புக் காத்திருப்பு இடைவெளியை விரும்பவும்.
- ஒரே ஒரு மாதிரி மட்டும் தோல்வியுறுகிறது → இணைப்புக் காத்திருப்பு இடைவெளியைக் காட்டிலும் மாதிரிப் பூட்டுதலை விரும்பவும்.
- நிலை தானாகவே மீள வேண்டும், ஆனால் மீளவில்லை → எதிர்கால நேரமுத்திரை மற்றும் காலாவதியான நிலையைப் புதுப்பிக்கும் வாசிப்புப் பாதை உள்ளதா எனச் சரிபார்க்கவும். நிரந்தர நிலைகளுக்குக் கைமுறை மாற்றங்கள் தேவை.
