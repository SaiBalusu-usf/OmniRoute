...
`.github/workflows/quality.yml` हे `release/**` ला लक्ष्य करणाऱ्या PRs वर चालते. ते पाथ-फिल्टर केलेल्या
जलद गेट्सद्वारे योगदानकर्त्यांच्या शाखांचे काम पुढे चालू ठेवते आणि कोड बदलांसाठी एक सूचनात्मक
प्रॉडक्शन-बिल्ड संकेतही देते:

| जॉब                                              | व्याप्ती                                                                                                                                                                                                             | अवरोधन                                                                                           |
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| `Build (advisory)`                               | नॉन-ड्राफ्ट कोड PRs आणि Mergify रांग शाखा; Node 24, `npm-ci-retry`, `check:node-runtime`, `OMNIROUTE_USE_TURBOPACK=1` सह `npm run build`; कोणताही डाउनस्ट्रीम गुणवत्ता जॉब ते वापरत नसल्यामुळे आर्टिफॅक्ट अपलोड नाही | **सूचनात्मक** (`continue-on-error: true`; रिलीज-PR चे रन एक आठवडा स्थिर राहिल्यानंतर काढून टाका) |
| `Docs Gates (fast-path)`                         | दस्तऐवज/कोड PRs; API दस्तऐवज संदर्भ आणि सर्व दस्तऐवज                                                                                                                                                                 | होय                                                                                              |
| `Fast Quality Gates`                             | कोड PRs; स्थिर तपासण्या, टाइपचेक, डॅशबोर्ड टाइपचेक, प्रभावित युनिट चाचण्या                                                                                                                                           | होय                                                                                              |
| `Forgotten sibling tests`                        | कोड PRs; बदललेल्या मॉड्यूल्सपासून स्थिर वापरकर्ते आणि संभाव्य सिब्लिंग चाचण्यांपर्यंत मागोवा; बॅरल आणि डायनॅमिक-इम्पोर्ट पाथ्स अनुमतीसूचीतील संदर्भित अपवादांसह सूचनात्मक निदान म्हणून नोंदवले जातात                 | **सूचनात्मक**                                                                                    |
| `Vitest (fast-path)`                             | कोड PRs; जलद vitest संच                                                                                                                                                                                              | होय                                                                                              |
| `Unit Tests fast-path`                           | कोड PRs; 4-शार्ड युनिट संच                                                                                                                                                                                           | होय                                                                                              |
| `No new ESLint warnings`                         | कोड PRs; सप्रेशन-जागरूक लिंट संरक्षक                                                                                                                                                                                 | स्वतःच्या उगमासाठी होय, फोर्क्ससाठी सूचनात्मक                                                    |
| `Merge integrity (changelog + generated skills)` | नॉन-ड्राफ्ट PRs; चेंजलॉग आणि व्युत्पन्न स्किल्स समक्रमण                                                                                                                                                              | स्वतःच्या उगमासाठी होय, फोर्क्ससाठी सूचनात्मक                                                    |
...
प्रत्येक बदललेल्या प्रॉडक्शन मॉड्यूलसाठी, संभाव्य चाचणी पुल-रिक्वेस्ट डिफमध्ये नसल्यास ते निर्धारक
`बदललेले मॉड्यूल/सिंबॉल -> स्थिर वापरकर्ता -> संभाव्य सिब्लिंग चाचणी` साखळ्यांचा अहवाल देते.
कोणतीही अवरोधक अंमलबजावणी सुरू करण्यापूर्वी कॅलिब्रेशनसाठी Markdown सारांश आणि JSON परिणाम
...
चाचणीचे नाव, विशिष्ट कारण आणि GitHub इश्यू किंवा पुल रिक्वेस्टची लिंक असणे आवश्यक आहे. सदोष नोंदी
सुरक्षितपणे अपयशी ठरतात. अपवाद हटवलेली संभाव्य चाचणी किंवा `.skip`/`.todo` जोडणारा डिफ दडपू
शकत नाहीत; अॅसर्शन कमकुवत करणे आणि इतर आच्छादन स्वतंत्रपणे अवरोधक असलेल्या
...
| स्क्रिप्ट (`npm run ...`)         | पडताळणी                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | अवरोधक                                    |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
...
| `check:any-budget:t11`            | `@ts-expect-error // any` ची संख्या निर्धारित मर्यादेपेक्षा जास्त नाही (Tier 11 catraca)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | होय                                       |
| `check:provider-consistency`      | `providers.ts` मधील प्रत्येक provider साठी `providerRegistry.ts` मध्ये जुळणारी नोंद आहे (आणि allowlist च्या मर्यादेत याउलटही)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | होय                                       |
| `check:model-lifecycle`           | हाताने सांभाळल्या जाणाऱ्या तीन routing tables, repository मध्ये समाविष्ट केलेल्या lifecycle snapshot (#11503) शी सुसंगत राहतात: `FITNESS_TABLE` (`taskFitness.ts`) अशा कोणत्याही retired id ला score देत नाही ज्याला `REGISTRY` route करू शकते; प्रत्येक `BUILT_IN_ALIASES` target `REGISTRY` मध्ये उपस्थित आणि retired-id snapshot मध्ये अनुपस्थित असतो; `REGISTRY` मध्ये अजूनही असलेला प्रत्येक retired id forward केलेला किंवा `allowedRetiredInCatalog` मध्ये सूचीबद्ध केलेला असतो; आणि कोणताही `DEFAULT_DEGRADATION_MAP` source किंवा target त्या snapshot मध्ये retired म्हणून दिसत नाही. यावरून एखादे model सध्या live upstream द्वारे उपलब्ध करून दिले जाते, हे सिद्ध होत नाही. Offline — `config/quality/model-lifecycle.json` शी तुलना करते; ते `npm run quality:refresh-model-lifecycle` वापरून हाताने refresh केले जाते (network; CI मध्ये जोडलेले नाही). `allowedRetiredInCatalog` हे burn-down ratchet आहे: tracking issue असेल तरच नोंद जोडा. | होय                                       |
| `check:fetch-targets`             | client-side `src/` मधील प्रत्येक `fetch("/api/...")` प्रत्यक्ष `route.ts` शी resolve होतो                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | होय                                       |
| `check:deps`                      | repo मधील प्रत्येक `package.json` मधील `npm install` करता येणाऱ्या सर्व deps `dependency-allowlist.json` मध्ये आहेत; नवीन unpinned किंवा slopsquatted packages चिन्हांकित केले जातात                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | होय                                       |
| `audit:deps`                      | `npm audit` (root + electron) — कोणत्याही high/critical advisories नाहीत (osv `check:vuln-ratchet` शी overlap होते; Rationalization Backlog पहा)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | होय                                       |
...
| `check:file-size`                 | कोणतीही स्रोत फाइल प्रत्येक एक्स्टेंशनसाठी असलेली कमाल मर्यादा ओलांडत नाही (रॅचेट: `frozen` सूचीतील गोठवलेल्या मोठ्या फाइल्स)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | होय                                       |
...
| `check:migration-numbering`       | माइग्रेशन SQL फाइल्सना कोणतेही क्रमांक वगळले किंवा पुनरावृत्त न करता अनुक्रमिक क्रमांक दिलेले आहेत                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | होय                                       |
| `check:public-creds`              | `publicCreds.ts` च्या बाहेर अक्षरशः OAuth `client_id`/`client_secret` किंवा Firebase Web कीज नाहीत (कठोर नियम #11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | होय                                       |
| `check:db-rules`                  | `src/lib/db/` मॉड्यूल्सच्या बाहेर रॉ SQL नाही; `localDb.ts` मधून बॅरल-इम्पोर्ट्स नाहीत (कठोर नियम #2/#5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | होय                                       |
| `check:known-symbols`             | त्यांच्या डिस्पॅच टेबल्समध्ये नोंदणीकृत प्रोव्हायडर एक्झिक्युटर्स, राउटिंग स्ट्रॅटेजीज आणि ट्रान्सलेटर्स डिस्कवरील फाइल्सशी जुळतात — कोणतीही अनाथ किंवा अघोषित सिंबल्स नाहीत                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | होय                                       |
| `check:route-guard-membership`    | चाइल्ड प्रोसेस सुरू करणारा प्रत्येक रूट `isLocalOnlyPath()` द्वारे वर्गीकृत केलेला आहे (कठोर नियम #15/#17)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | होय                                       |
...
| `check:agent-skills-sync`         | जनरेट केलेले एजंट-स्किल्स आर्टिफॅक्ट्स त्यांच्या स्रोत कॅटलॉगशी जुळतात (कोणतेही विचलन नाही)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `check:provider-asset-provenance` | प्रोव्हायडर लोगो/अॅसेट्ससोबत नोंदवलेली उगम-विषयक नोंद असते                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `lint:json`                       | JSON कॉन्फिगरेशन फाइल्स पार्स होतात आणि रेपॉझिटरीचे लिंट नियम पूर्ण करतात                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `typecheck:core`                  | त्रुटींशिवाय TypeScript संकलन (केवळ सल्लात्मक इशारे)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | होय                                       |
| `typecheck:noimplicit:core`       | कठोर `noImplicitAny` — भविष्योन्मुख; आधीपासून अस्तित्वात असलेल्या अनेक कॉल साइट्सना अजूनही अॅनोटेशन्सची आवश्यकता आहे                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **सल्लात्मक** (`continue-on-error: true`) |
| `check:dashboard-typecheck`       | `src/app/(dashboard)/**` पुरते मर्यादित `tsc` (#7033) — `typecheck:core` च्या निवडक 27-फाइल अनुमतीसूचीत कोणतेही डॅशबोर्ड TSX समाविष्ट नाही आणि `next build` देखील कधीही त्याची प्रकार-तपासणी करत नाही (`next.config.mjs` मध्ये `ignoreBuildErrors: true` सेट केले आहे), त्यामुळे तेथील अनाथ-आयडेंटिफायर रिग्रेशन्स (#6625/#6909) CI ला दिसत नव्हते. प्रत्येक फाइल/प्रत्येक TS-कोड संख्येच्या स्थिर बेसलाइनशी फरक तपासते (`config/quality/dashboard-typecheck-baseline.json`, `check:known-symbols` प्रमाणेच कालबाह्यता-अंमलबजावणी पद्धत) — बेसलाइनमध्ये नोंदवलेल्या संख्येपेक्षा फक्त नवीन त्रुटी आल्यास गेट अयशस्वी होते; आधीपासून अस्तित्वात असलेली त्रुटी दुरुस्त झाल्यावर `--update` वापरून बेसलाइन कमी करा.                                                                                                                                                                                                                                             | होय                                       |
...
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| `quality:collect`            | `quality-metrics.json` तयार करते (ESLint इशाऱ्यांची संख्या, मर्ज केलेल्या शार्ड अहवालातील कव्हरेज)                                                                          | होय (रॅचेटच्या अपस्ट्रीममध्ये) |
...
| `check:complexity`           | फाइल-स्तरीय सायक्लोमॅटिक जटिलता मर्यादेपेक्षा जास्त नाही (कोअर ESLint `complexity` + `max-lines-per-function`)                                                              | होय                            |
| `check:cognitive-complexity` | संज्ञानात्मक जटिलता रॅचेट (`eslint-plugin-sonarjs`) — स्वतंत्र ESLint पास; CI दोन्ही एकत्र करून एकमेव `check:complexity-ratchets` पायरी म्हणून चालवते                       | होय                            |
| `check:dead-code`            | न वापरलेल्या एक्सपोर्ट्स / फाइल्सचा रॅचेट (knip) बेसलाइनच्या तुलनेत रिग्रेस होत नाही                                                                                        | होय                            |
| `check:compression-budget`   | कॉम्प्रेशन बेंचमार्क बजेट — प्रत्येक इंजिनसाठी टोकन-बचतीच्या किमान मर्यादांमध्ये रिग्रेशन होता कामा नये                                                                     | होय                            |
| `check:type-coverage`        | टाइप केलेल्या कोडच्या टक्केवारीचा रॅचेट (`type-coverage`) रिग्रेस होत नाही; मोठ्या प्रमाणात `typecheck:noimplicit:core` समाविष्ट करते                                       | होय                            |
| `check:codeql-ratchet`       | उघड्या CodeQL अलर्ट्सची संख्या रिग्रेस होत नाही (`gh api` द्वारे वाचते; टोकन नसल्यास सुरळीतपणे वगळते) — रिफ्रेश वारंवारता आणि मॅन्युअल ट्रिगरसाठी: खालील "CodeQL रॅचेट" पहा | होय                            |

### जॉब: `quality-extended`

संपूर्ण जॉब सल्लागार स्वरूपाचा आहे (`continue-on-error: true`). npm-आधारित रॅचेट्स प्रत्यक्षात चालतात;
बाह्य स्कॅनर्स `gh release download` द्वारे स्थापित होतात आणि बायनरी अद्याप उपलब्ध नसल्यास
स्वतःहून वगळले जातात (exit 0).

| स्क्रिप्ट                | काय सत्यापित करते                                                                                                                                                                           | ब्लॉकिंग     |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| `check:circular-deps`    | कोणतीही चक्रीय अवलंबित्वे नाहीत (dpdm)                                                                                                                                                      | **सल्लागार** |
| `check:bundle-size`      | बंडलचा आकार कमाल मर्यादा ओलांडत नाही                                                                                                                                                        | **सल्लागार** |
| `check:secrets`          | गुपितांचे स्कॅनिंग (gitleaks) — बायनरी उपलब्ध नसल्यास वगळते                                                                                                                                 | **सल्लागार** |
| `check:vuln-ratchet`     | अवलंबित्वांमधील असुरक्षा (osv-scanner) मागील स्थितीपेक्षा बिघडत नाहीत — बायनरी उपलब्ध नसल्यास वगळते                                                                                         | **सल्लागार** |
| `check:workflows`        | वर्कफ्लो लिंट (actionlint + zizmor) — बायनरीज उपलब्ध नसल्यास वगळते                                                                                                                          | **सल्लागार** |
| `check:openapi-breaking` | सार्वजनिक API करारातील (`openapi.yaml`) बेस ब्रँचच्या तुलनेतील ब्रेकिंग बदल (oasdiff) — `openapiBreaking=N` आउटपुट करते; oasdiff उपलब्ध नसल्यास किंवा बेस स्पेकचे निराकरण होत नसल्यास वगळते | **सल्लागार** |
...
| स्क्रिप्ट                      | काय सत्यापित करते                                                                                                                                                | ब्लॉकिंग                        |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| `check:docs-all`               | खालील 6 उप-गेट्स क्रमाने चालवणारा मेटा-गेट                                                                                                                       | होय                             |
| ↳ `check:docs-sync`            | CHANGELOG / OpenAPI / llm.txt आवृत्तीची सुसंगतता                                                                                                                 | होय                             |
| ↳ `check:docs-counts`          | गद्य मजकुरातील संख्या (प्रदाता संख्या, स्थलांतर संख्या इ.) वास्तविक संख्यांच्या रॅचेट विंडोमध्ये आहेत                                                            | होय                             |
| ↳ `check:env-doc-sync`         | `.env.example` मधील प्रत्येक env var दस्तऐवजांच्या तक्त्यात नोंदवलेला आहे आणि तक्त्यातील प्रत्येक env var `.env.example` मध्ये आहे                               | होय                             |
| ↳ `check:deprecated-versions`  | दस्तऐवजांमध्ये कालबाह्य आवृत्ती स्ट्रिंग्स नाहीत                                                                                                                 | होय                             |
| ↳ `check:doc-links`            | दस्तऐवजांमधील अंतर्गत markdown दुवे वास्तविक फाइल्सकडे निर्देश करतात (`[text]`/`(path)` स्वरूप)                                                                  | होय                             |
| ↳ `check:fabricated-docs`      | दस्तऐवजांमध्ये नमूद केलेले रूट्स, env vars, CLI कमांड्स, हुक नावे आणि फाइल पाथ्स कोडबेसमध्ये अस्तित्वात आहेत. `--strict` द्वारे हार्ड गेट; फ्लॅगशिवाय सॉफ्ट-फेल. | होय (CI मधील `--strict` द्वारे) |
| `check:cli-i18n`               | CLI कमांड स्ट्रिंग्स सर्व i18n लोकेल फाइल्समध्ये उपलब्ध आहेत                                                                                                     | होय                             |
| `check:openapi-coverage`       | OpenAPI स्पेकमध्ये वास्तविक रूट्सच्या किमान रॅचेटेड मर्यादेइतके कव्हरेज आहे                                                                                      | होय                             |
| `check:openapi-security-tiers` | `openapi.yaml` मधील सुरक्षा स्तर अॅनोटेशन्स `routeGuard.ts` वर्गीकरणांशी सुसंगत आहेत                                                                             | **सल्लागार**                    |
| `check:openapi-routes`         | `openapi.yaml` मधील प्रत्येक पाथ वास्तविक `route.ts` कडे निर्देश करतो (भ्रामक निर्मितीविरोधी)                                                                    | होय                             |
| `check:docs-symbols`           | `docs/**/*.md` मधील प्रत्येक `/api/...` संदर्भ वास्तविक `route.ts` कडे निर्देश करतो (भ्रामक निर्मितीविरोधी)                                                      | होय                             |
| `i18n translation drift`       | i18n लोकेल फाइल्समधील अनुवादित न केलेल्या कीज — केवळ इशारा                                                                                                       | **सल्लागार**                    |
...
| `check-ui-value-drift` (इनलाइन)   | पुनर्लिखित इंग्रजी **मूल्यामुळे** कोणतेही कालबाह्य भाषांतर शिल्लक राहत नाही                                                                                                            | होय           |
| `check-new-key-coverage` (इनलाइन) | **नवीन** इंग्रजी की प्रत्येक लोकेलपर्यंत पोहोचते                                                                                                                                       | होय           |
| `check-translation-ratio`         | प्रत्येक लोकेलसाठी वास्तविक-भाषांतराचे प्रमाण (अनुमतिसूचीबाहेरील इंग्रजीशी समान / प्लेसहोल्डर / गहाळ पाने) `config/quality/i18n-translation-baseline.json` + शिथिलतेपेक्षा जास्त नसावे | **सल्लात्मक** |
...
इतर गेटना संरचनात्मकदृष्ट्या न दिसणारी एक i18n रिग्रेशन ही गेट पकडते: एखादे इंग्रजी मूल्य
पुन्हा लिहिले जाते आणि _मागील_ इंग्रजीवरून तयार केलेली भाषांतरे तशीच राहतात, त्यामुळे
इंग्रजीतर वापरकर्ते आत्मविश्वासाने मांडलेला, पण आता चुकीचा मजकूर वाचत राहतात.

हे प्रत्यक्षात रिलीज झाले होते. Antigravity लॉगिन हेल्पर समाविष्ट झाला तेव्हा (#5203)
...
होऊ न शकणारी ही प्रक्रिया आहे. #8463 पर्यंत हे लक्षात आले नाही, कारण:

- `sync-ui-keys` फक्त **अनुपस्थित** की बॅकफिल करते, **कालबाह्य** की कधीही नाही;
- `check-ui-keys-coverage` कीची _उपस्थिती_ मोजते, त्यामुळे कालबाह्य भाषांतर कव्हर झालेले मानले जाते;
- `check-translation-drift` हे `docs/i18n/<locale>/**.md` दस्तऐवजीकरण मिरर ट्रॅक करते —
  ते `src/i18n/messages/*.json` कधीही वाचत नाही. 2026-09 री-सिंकपासून `docs-sync-strict`
  जॉबमध्ये अवरोधक: मुख्य दस्तऐवज संपादित करा → `npm run i18n:run -- --files=<doc>` (विभाग-स्तरीय, कमी खर्चिक).

**फरक-जागरूक, बेसलाइन-आधारित नाही.** हे मर्ज बेसवरील `en.json` ची वर्किंग ट्रीशी
तुलना करते; ज्या प्रत्येक कीचे इंग्रजी मूल्य बदलले आहे, तिच्यासाठी न बदललेले भाषांतर
अजूनही असलेले कोणतेही लोकेल कालबाह्य आहे. हे जाणीवपूर्वक **आधीपासूनचे प्रलंबित काम गोठवते** —
दीर्घकाळ अस्तित्वात असलेले भाषांतर कोणत्या जुन्या इंग्रजीवरून आले हे फरकातून समजू शकत नाही,
त्यामुळे गेट फक्त सध्याच्या बदलाने स्पर्श केलेल्या गोष्टींचेच मूल्यमापन करते. पर्यायी उपायासाठी
(प्रति-की हॅश बेसलाइन) ~600 KB ची जनरेट केलेली फाइल लागेल, जी सर्वांत मोठ्या विद्यमान
बेसलाइनपेक्षा 3× मोठी असेल आणि प्रत्येक i18n PR मध्ये बदलेल.

याची पूर्तता करण्याचे दोन मार्ग:

1. प्रभावित भाषांतरे अद्ययावत करा, किंवा
2. ती `__MISSING__:<new english>` वर सेट करा — त्यानंतर रनटाइम सुधारित इंग्रजी पुरवतो
   (`src/i18n/request.ts::deepMergeFallback`, #7258) आणि की भाषांतराच्या रांगेत जाते.

स्ट्रिंगचा **अर्थ** बदलला असल्यास, **कीचे नाव बदलण्यास** प्राधान्य द्या: नवीन कीला
कालबाह्य भाषांतर वारशाने मिळू शकत नाही. #8463 मध्ये हाच नमुना वापरला गेला.

```bash
npm run i18n:check-value-drift          # कठोर (CI मध्ये हेच चालते)
npm run i18n:check-value-drift:warn     # केवळ अहवाल
BASE_REF=origin/release/vX.Y.Z npm run i18n:check-value-drift
```

बेस कॅटलॉग वाचता येत नसल्यास (`base ref` नसलेला शॅलो क्लोन), `check-openapi-breaking`
प्रमाणेच `SKIP reason=base-unresolved` सह 0 एक्झिट करते.

### जॉब: `i18n`

संपूर्ण i18n सत्यापन मॅट्रिक्स (प्रत्येक लोकेलसाठी एक जॉब). संपूर्ण जॉब सल्लात्मक आहे.
...
| स्क्रिप्ट              | काय सत्यापित करते                                                                                                                                   | अवरोधक |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| `check:pr-test-policy` | `src/`, `open-sse/`, `electron/`, किंवा `bin/` मधील प्रॉडक्शन कोड बदलणाऱ्या PR मध्ये चाचण्या समाविष्ट किंवा अद्ययावत असणे आवश्यक आहे (कठोर नियम #8) | होय    |
| `check:test-masking`   | बदललेल्या चाचणी फाइल्समुळे निव्वळ अॅसर्ट संख्या कमी होत नाही किंवा `assert.ok(true)` सारखी पुनरुक्त सत्य विधाने जोडली जात नाहीत                     | होय    |
| `check:pr-evidence`    | PR च्या मजकुरात बदलासाठी चाचणी/VPS पुराव्याचा संदर्भ असतो (PR चा मजकूर grep करून कठोर नियम #18 यांत्रिक करते — नाजूक, Backlog पहा)                  | होय    |

### जॉब: `test-vitest`

`build` नंतर चालते. अयशस्वी झाल्यास मर्ज अवरोधित करते.

| संच              | काय सत्यापित करते                                     | अवरोधक                                                                                                                              |
| ---------------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `test:vitest`    | MCP सर्व्हर (110 साधने), autoCombo, कॅशे — vitest रनर | होय                                                                                                                                 |
| `test:vitest:ui` | UI घटक चाचण्या — vitest रनर                           | **अवरोधक** — आधीपासून अस्तित्वात असलेल्या त्रुटी `vitest.config.ts` मध्ये स्पष्टपणे वगळल्या आहेत; नवीन त्रुटींमुळे जॉब अयशस्वी होतो |

### रात्रकालीन वर्कफ्लो (नियोजित, सल्लात्मक)

हे cron वेळापत्रकानुसार (आणि `workflow_dispatch` द्वारे) चालतात; PR वर कधीही चालत नाहीत. सर्व सल्लात्मक आहेत.

| वर्कफ्लो               | काय सत्यापित करते                                                                                                                                                     | अवरोधक        |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| `nightly-property`     | यादृच्छिक seed आणि उच्च run count सह fast-check प्रॉपर्टी चाचण्या                                                                                                     | **सल्लात्मक** |
| `nightly-resilience`   | heap-growth गेट, chaos fault-injection, k6 load/soak                                                                                                                  | **सल्लात्मक** |
| `nightly-llm-security` | promptfoo injection guard (ब्लॉक मोड) + garak probes (प्रदाता secret नसल्यास वगळले जातात)                                                                             | **सल्लात्मक** |
| `nightly-schemathesis` | `docs/openapi.yaml` वापरून थेट OmniRoute विरुद्ध OpenAPI कराराचे fuzzing (schemathesis) — तपशील-विनिर्देश उल्लंघने / न हाताळलेल्या 500 त्रुटी समोर आणते (टप्पा 8 B.4) | **सल्लात्मक** |
| `nightly-mutation`     | जलद unit lane वरील Stryker mutation-testing गुण — टिकून राहिलेले mutants कमकुवत assertions समोर आणतात                                                                 | **सल्लात्मक** |
| `nightly-compat`       | समर्थित `engines.node` श्रेणींमधील Node इंजिन सुसंगतता मॅट्रिक्स                                                                                                      | **सल्लात्मक** |
...
- पुरवठा-साखळी (उगम, SBOM, Trivy, Scorecard): [`docs/security/SUPPLY_CHAIN.md`](../security/SUPPLY_CHAIN.md)
...
प्रत्येक `src/i18n/messages/<locale>.json` मधील अंतिम-स्तरीय कींच्या संचाची `en.json` शी तुलना करते आणि
कोणतीही अंतिम-स्तरीय की नसल्यास किंवा अतिरिक्त असल्यास, ती की कधी जोडली गेली याची पर्वा न करता अपयशी ठरते. `__MISSING__:` प्लेसहोल्डर
उपस्थित म्हणून मोजले जातात (त्यांचा मजकूर हा गुणोत्तर गेटचा विषय आहे). हे दोन फरक-आधारित/टक्केवारी गेट्सचे
पूर्ण पूरक आहे: `check-ui-keys-coverage` प्रत्येक
लोकेलसाठी 80 % ची किमान मर्यादा लागू करते (~13,000 पैकी 43 की नसल्या तरीही 99.7 % दिसते) आणि `check-new-key-coverage`
फक्त PR ने `en.json` मध्ये जोडलेल्या कींचे मूल्यमापन करते. लोकेल बॅचची शाखा तयार केली जाते त्या दिवशीच्या `en.json` वरून
ती निर्माण केली जाते आणि बेसमध्ये सतत की जोडल्या जात असताना अनेक दिवस भाषांतर केले जाते; बॅच PR स्वतः
कोणतीही की जोडत नाही, त्यामुळे बॅच 1 (#13044) नऊ लोकेलमध्ये 43 कींनी अपूर्ण आणि
बॅच 2 (#13660) आठ लोकेलमध्ये 10 कींनी अपूर्ण असताना (2026-09-15) दोन्ही समकक्ष गेट्स शांत राहिले. लाल स्थितीचे निराकरण
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers` ने करा; `extra` अंतिम-स्तरीय कीचा
अर्थ स्रोतामधून ती काढून टाकली आहे — ती लोकेलमधून हटवा. `--warn` अपयशी न होता अहवाल देते.
`--catalog=cli` हेच तुलनात्मक परीक्षण `bin/cli/locales` वर चालवते (`npm run i18n:check-keys:cli`);
दोन्ही पायऱ्या `i18n-ui-coverage` जॉबमध्ये आहेत.

#### `check-new-key-coverage` — नवीन-की i18n गेट

`check-ui-value-drift` चे समकक्ष गेट. इंग्रजी मूल्य **पुन्हा लिहिले** गेले,
पण त्याची भाषांतरे मागे राहिली, तर ते गेट ते शोधते; तर हे गेट इंग्रजी की **जोडली** गेली,
पण काही लोकेलना ती कधीच मिळाली नाही, अशी स्थिती शोधते.

`check-ui-keys-coverage` ला हा प्रकार दिसू शकत नाही: ते प्रत्येक लोकेलसाठी टक्केवारीची किमान मर्यादा लागू करते आणि
~13,000 पैकी अकरा की नसल्या तरी कव्हरेज 99.9% राहते. प्रत्येक भाषेसाठीची टक्केवारी
"हे वैशिष्ट्य भाषांतराविना प्रसिद्ध झाले" हे व्यक्त करू शकत नाही — एखादे संपूर्ण वैशिष्ट्य नवीन लोकेलमध्ये कोणत्याही
मजकुराविना समाविष्ट होऊ शकते आणि तरीही हा आकडा बदलत नाही.

यात नोंदवलेली घटना: Orchestration Canvas च्या Phase 3 मधील अकरा कींचे त्यावेळी अस्तित्वात असलेल्या
42 लोकेलमध्ये भाषांतर केले गेले. काही तासांनंतर EU-भाषा बॅचने (#13044) रेपोमधील
लोकेलची संख्या 51 केली आणि नऊ नव्या लोकेलना (`el`, `et`, `ga`, `hr`, `lt`, `lv`, `mt`, `sl`, `sr`) त्या की
कधीच मिळाल्या नाहीत. `deepMergeFallback` नसलेल्या कीऐवजी इंग्रजी वापरते, त्यामुळे अपयशाचे स्वरूप
रिकाम्या UI ऐवजी भाषांतर न केलेली UI असे होते — वास्तविक आणि रचनेमुळेच मूक.

त्याच्या समकक्ष गेटप्रमाणेच हेही **फरक-जागरूक** आहे; ते मर्ज बेसवरील इंग्रजीची वर्किंग
ट्रीशी तुलना करते, त्यामुळे आधीपासून असलेल्या त्रुटी स्थिर राहतात आणि गेट सुरू करण्यासाठी कोणत्याही स्थलांतराची आवश्यकता नव्हती. पर्यायी मार्ग:
`__MISSING__:<english>` रनटाइम योग्य ठेवत भाषांतर पुढे ढकलते. `vi` मध्ये
प्लेसहोल्डरना मनाई आहे (`tests/unit/i18n-vi-completeness.test.ts`) आणि त्यासाठी वास्तविक भाषांतर आवश्यक आहे.

#### `check-vitest-exclusions` — स्थगित-चाचणी गेट

`vitest.config.ts` च्या `exclude` सूचीतील फाइल ही न चालणारी चाचणी असते आणि ट्री वाचणाऱ्याला
ती कव्हरेजचा भाग असल्यासारखी दिसते. बासष्ट फाइल्स
`// #8618 — pre-existing failure; remove this exclusion when fixed` या टिप्पणीमागे साचल्या. Issue #8618
2026-08-11 रोजी बंद करण्यात आली, मात्र ती ज्या सूचीचा मागोवा घेत होती ती 45 नोंदींपासून 62 पर्यंत वाढली आणि प्रत्येक नवीन नोंदीला
बंद झालेल्या issue कडे निर्देश करणारी टिप्पणी वारशाने मिळाली. अखेर सूचीतील प्रत्येक फाइल स्वतंत्रपणे मोजली गेली (#13204), तेव्हा **62 पैकी 51
फाइल्स कोणताही स्रोत बदल न करता सध्याच्या ट्रीवर उत्तीर्ण झाल्या**.

वास्तविक फाइलशी जुळणाऱ्या प्रत्येक exclusion ने (a) ट्रॅकिंग issue नमूद करणे आणि
(b) त्याच्या मोजलेल्या स्थितीसह `config/quality/vitest-exclusions.json` मध्ये दिसणे, अशी गेटची आवश्यकता आहे; त्यामुळे नवीन exclusion जोडणे म्हणजे
60-नोंदींच्या अॅरेमध्ये आणखी एक ओळ जोडण्याऐवजी, समर्पित फाइलमधील पुनरावलोकन करता येण्याजोगा फरक ठरतो. हे जाणूनबुजून
वगळलेल्या चाचण्या पुन्हा चालवत नाही — त्यासाठी ~10 मिनिटे लागतात आणि ते नियतकालिक जॉबमध्ये असणे योग्य आहे; प्रत्येक चाचणीचे शेवटचे मापन
कधी झाले, याची नोंद इन्व्हेंटरीमध्ये ठेवली जाते.
