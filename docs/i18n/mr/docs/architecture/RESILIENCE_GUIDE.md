...
- OAuth आधार: 5s
- API-key आधार: 3s
- API-key 429: अपस्ट्रीम `Retry-After`/रीसेट हेडर्स/पार्स करता येणाऱ्या रीसेट मजकुराला प्राधान्य
...
- `banned` — बंदी घातलेला कीवर्ड / खाते-बंदी शोधाद्वारे सेट केली जाते ([BAN_DETECTION](../security/BAN_DETECTION.md) पहा)
- `expired` (मर्यादित पुनर्प्रयत्नांनंतर टर्मिनल स्थितीत संक्रमण होते — एक्स्पोनेन्शियल बॅकऑफसह `EXPIRED_RETRY_MAX = 3` — त्यामुळे खाते कायमस्वरूपी निष्क्रिय होण्यापूर्वी तात्पुरत्या OAuth त्रुटी स्वतःहून दूर होऊ शकतात)
- `credits_exhausted`

क्रेडेन्शियल्स बदलेपर्यंत किंवा ऑपरेटरने त्या रीसेट करेपर्यंत या स्थिती कायम राहतात. तात्पुरत्या कूलडाउन स्थितीने टर्मिनल स्थिती अधिलिखित करू नका.

**विलंबित पुनर्प्राप्ती:** `rateLimitedUntil` उलटून गेल्यावर कनेक्शन पुन्हा पात्र होते. यशस्वी वापरानंतर `clearAccountError()` सर्व त्रुटी फील्ड्स साफ करते.

### सत्र संलग्नता (#7274)

**व्याप्ती:** **कोणत्याही** प्रदात्यासाठी एकाच कनेक्शनशी पिन केलेले एक क्लायंट सत्र (`X-Session-Id` / `x-codex-session-id` / `x-omniroute-session` हेडर).

**उद्देश:** मल्टी-टर्न एजंटला (Claude Code, aider, सानुकूल एजंट्स) सर्व विनंत्यांमध्ये एकाच खात्यावर ठेवणे, ज्यामुळे क्रॉस-अकाउंट संदर्भ गमावणे आणि प्रति-खाते सत्र स्थिती असलेल्या प्रदात्यांवर वारंवार येणारे कोल्ड-स्टार्ट 429 कमी होतात.
...
- कायमस्वरूपी साठवलेले पिन टेबल: `sessionAccountAffinity` (`src/lib/db/sessionAccountAffinity.ts`)
- सेटिंग: `sessionAffinityTtlMs` (ms मधील जागतिक TTL, `0` ते अक्षम करते) — `src/lib/db/settings.ts`. स्थलांतर `124_generic_session_affinity_ttl.sql` द्वारे केवळ Codex साठी असलेल्या `codexSessionAffinityTtlMs` वरून याचे नामांतर केले गेले; हे स्थलांतर पूर्वी कॉन्फिगर केलेला कोणताही Codex TTL नवीन डीफॉल्ट म्हणून पुढे नेते.

#7274 पूर्वी, `codex` वगळता प्रत्येक प्रदात्यासाठी `resolveSessionAffinityTtlMs()` थेट `0` परत करत असे, त्यामुळे पिनिंग यंत्रणा आणि हेडर निष्कर्षण आधीपासून प्रदाता-निरपेक्ष असूनही TTL सेटिंगचा (आणि सत्र हेडर्सचा) इतरत्र कुठेही परिणाम होत नव्हता. या दुरुस्तीने ते लवकर परतणे काढून टाकले; आता TTL जागतिक पातळीवर `0` पेक्षा अधिक सेट केल्यानंतर प्रत्येक प्रदात्याला एकसमानपणे लागू होतो.

सत्र-संलग्नतेचे हे तीन हेडर्स कधीही अपस्ट्रीमकडे फॉरवर्ड केले जात नाहीत — क्लायंट हेडर्स पुढे पाठवण्याऐवजी एक्झिक्युटर्स स्वतःचे अपस्ट्रीम हेडर्स सुरुवातीपासून तयार करतात, त्यामुळे हा केवळ अंतर्गत सहसंबंध ID राहतो.

### विशेष व्यवस्थापित सत्र कनेक्शन लीझ

**व्याप्ती:** एक सक्रिय व्यवस्थापित HTTP क्लायंट/सत्र एका पात्र OmniRoute कनेक्शनची मालकी घेते.

**उद्देश:** सर्व विनंत्यांमध्ये कठोर रूटिंग
मर्यादा आवश्यक असलेल्या क्लायंट्सना टिकाऊ, विशेष कनेक्शन मालकी प्रदान करणे. हे सत्र संलग्नतेपेक्षा वेगळे आहे, जी सातत्यासाठीची सौम्य प्राधान्य व्यवस्था आहे:
विशेष लीझ SQLite मध्ये जीवनचक्र स्थिती कायम ठेवते, जागतिक सक्रिय-मालक आणि
सक्रिय-कनेक्शन अद्वितीयता लागू करते आणि प्रदात्याकडे डिस्पॅच करण्यापूर्वी जुनी जनरेशन नाकारते.

हे वैशिष्ट्य प्रत्येक API कीसाठी स्वतंत्रपणे स्वीकारावे लागते. व्यवस्थापित कीकडे `lease:exclusive` स्कोप आणि
स्पष्ट, रिकामी नसलेली `allowedConnections` सूची असणे आवश्यक आहे. कोणताही HTTP क्लायंट जीवनचक्र एंडपॉइंट वापरू शकतो; कोणतेही
क्लायंट नाव, युजर-एजंट, प्रदाता, OAuth पद्धत किंवा मॉडेल आवश्यक नाही. लीझकडे कनेक्शनची मालकी असते,
मॉडेलची नाही; त्यामुळे कनेक्शन सामान्यतः
पात्र असेपर्यंत मॉडेल बदलले तरी बाइंडिंग कायम राहते. सामान्य मॉडेल, कोटा, आरोग्य, कूलडाउन आणि अनुमत-सूचीचे नियम अधिकृत राहतात आणि
त्याच जनरेशनला दुसऱ्या मुक्त पात्र कनेक्शनवर संक्रमित करू शकतात.

याचे जीवनचक्र JSON कृती `acquire`, `renew` आणि `release` यांसह `POST /api/v1/session-leases` आहे.
व्यवस्थापित इन्फरन्स विनंत्या अपारदर्शक `X-OmniRoute-Lease-Owner` मूल्य आणि अचूक
`X-OmniRoute-Lease-Generation` सादर करतात. मालक `vlo_` नंतर 43 base64url वर्ण वापरतो; फक्त
त्याचा SHA-256 हॅश साठवला जातो. प्रत्येक अंतिम डिस्पॅच मर्यादा प्रमाणीकृत API की ID आणि
सक्रिय कनेक्शन ID यांनाही बांधते. लीझ नियंत्रण हेडर्स लॉग्स, कायम ठेवलेले विनंती स्नॅपशॉट्स आणि
अपस्ट्रीम एक्झिक्युटर हेडर्समधून काढून टाकले जातात.

सामान्य रूटिंगमध्ये पात्र व्यवस्थापित उमेदवार असतील, परंतु प्रत्येक मुक्त उमेदवारावर
परकीय सक्रिय लीझचा ताबा असेल, तर OmniRoute HTTP `429`, lease-capacity-unavailable कोड,
क्षमता उपलब्ध होण्याची प्रतीक्षा करणारी स्थिती आणि सर्वांत लवकर संबंधित कालबाह्यता वेळेवरून मिळवलेले मर्यादित `Retry-After` परत करते.
सामान्य रिकामी पात्रता ही लीझ स्पर्धा नसते आणि ती तिचे विद्यमान रूटिंग त्रुटीचे अर्थशास्त्र कायम ठेवते.

संबंधित यंत्रणा स्वतंत्र राहतात:

- OAuth सत्र व्यापलेपण हे OAuth खात्यांसाठी प्रक्रियास्थानिक सौम्य वितरण आहे.
- खाते सेमाफोर्स विनंती-समकालिकता परवानग्या देतात आणि विनंती पूर्ण झाल्यावर समाप्त होतात.
- विशेष व्यवस्थापित सत्र लीझ म्हणजे जनरेशन मर्यादेसह टिकाऊ जीवनचक्र मालकी.

---

## 3. मॉडेल लॉकआउट

**व्याप्ती:** provider + connection + model ही त्रयी.

**उद्देश:** केवळ एक मॉडेल अनुपलब्ध किंवा कोटा-मर्यादित असताना संपूर्ण कनेक्शन अक्षम करणे टाळणे.

**उदाहरणे:**

- प्रत्येक मॉडेलनुसार कोटा असलेले providers जे 429 परत करतात
- एक मॉडेल उपलब्ध नसल्यास त्यासाठी 404 परत करणारे स्थानिक providers
- Provider-विशिष्ट mode/model परवानगी अपयशे (उदा., Grok modes)

**अंमलबजावणी:** `open-sse/services/accountFallback.ts` — `lockModel()`, `clearModelLock()`, `getAllModelLockouts()`.

### मॉडेल कूलडाउन्स डॅशबोर्ड (v3.8.0)

UI: Settings → Model Cooldowns (`src/app/(dashboard)/dashboard/settings/components/ModelCooldownsCard.tsx`)

सक्रिय लॉकआउट्सची पुढील माहितीसह सूची दाखवते: provider, connection, model, reason, expiresAt. ऑपरेटर्स कार्डमधून मॉडेल व्यक्तिचलितपणे पुन्हा सक्षम करू शकतात.

**REST API:**

- `GET /api/resilience/model-cooldowns` — सक्रिय लॉकआउट्सची सूची
- `DELETE /api/resilience/model-cooldowns` — व्यक्तिचलितपणे पुन्हा सक्षम करणे. Body: `{provider, connection, model}`. Auth: management.

### लॉकआउट सेटिंग्ज UI + यश-क्षय पुनर्प्राप्ती (v3.8.23)

मॉडेल लॉकआउटचे वर्तन नेहमी-सक्रिय हार्डकोडेड स्वरूपातून पूर्णपणे कॉन्फिगर करता येणाऱ्या,
स्वतंत्र सेटिंग्ज कार्ड आणि स्वयंपुनर्प्राप्ती मार्ग असलेल्या ऐच्छिक वैशिष्ट्यात बदलले आहे.

**सेटिंग्ज कार्ड:** Settings → Model Lockout
(`src/app/(dashboard)/dashboard/settings/components/ModelLockoutCard.tsx`).
हे वरील केवळ-वाचनीय `ModelCooldownsCard` पेक्षा **वेगळे** आहे (जे फक्त सक्रिय
लॉकआउट्सची _सूची दाखवते_) — नवीन कार्ड _पॅरामीटर्स कॉन्फिगर करते_. डीफॉल्ट मूल्ये
`DEFAULT_MODEL_LOCKOUT_SETTINGS` मध्ये आहेत
...
| `maxCooldownMs`         | `1_800_000` (30 मिनिटे)          | वाढवलेल्या कूलडाउनवरील कमाल मर्यादा.                              |
| `maxBackoffSteps`       | `10`                             | घातांकीय-बॅकऑफ वाढीच्या कमाल पायऱ्या.                             |
| `useExponentialBackoff` | `true`                           | पुनरावृत्त अपयशांमुळे कूलडाउन घातांकीय पद्धतीने वाढवायचे की नाही. |

सेटिंग्ज सामान्य settings store द्वारे टिकवून ठेवल्या जातात आणि
resilience settings schema द्वारे प्रमाणित केल्या जातात; कार्ड `baseCooldownMs`/`maxCooldownMs`
(`maxCooldownMs ≥ baseCooldownMs` सह) आणि `maxBackoffSteps` यांना मर्यादेत ठेवते.

**यश-क्षय पुनर्प्राप्ती:** पुनर्प्राप्ती ही पूर्णपणे टाइमर कालबाह्य होण्यावर अवलंबून **नाही**. निरोगी
प्रतिसाद मॉडेलची अपयश-संख्या टप्प्याटप्प्याने कमी करतो, त्यामुळे मधल्या कालावधीत पुनर्प्राप्त झालेले मॉडेल
त्याचा टाइमर संपण्यापूर्वी वाढवणे थांबवते (आणि लॉकआउट हटवते). यशस्वी
combo target वर, `open-sse/services/combo.ts` हे `decayModelFailureCount()`
(`open-sse/services/accountFallback.ts`) कॉल करते, जे संचयित
`failureCount` **निम्मी** करते (`Math.floor(failureCount / 2)`); ती `0` वर
पोहोचल्यावर लॉकआउट नोंद पूर्णपणे हटवली जाते. समतुल्य `recordModelLockoutFailure()`
वाढीच्या कालावधीतील अपयशांवर संख्या वाढवते (आणि कूलडाउन वाढवते).
हा यश-क्षय साध्या टाइमर कालबाह्यतेव्यतिरिक्त आहे —
यापैकी कोणताही मार्ग मॉडेल पुन्हा सक्षम करू शकतो.

**स्थिती:** लॉकआउट्स **इन-मेमरी** ठेवले जातात (प्रत्येक प्रोसेससाठीचे
`ModelLockoutEntry` चे `Map`s, ज्यांच्या कळा `provider:connectionId:model` असतात), DB मध्ये
टिकवून ठेवले जात नाहीत — रीस्टार्ट झाल्यावर ते नष्ट होतात. _सेटिंग्ज_ टिकवून ठेवल्या जातात; सक्रिय
लॉकआउट _स्थिती_ तात्पुरती असते.
...
- एखाद्या प्रदात्याच्या सर्व की वगळल्या गेल्या → सर्किट ब्रेकरची स्थिती आणि प्रत्येक कनेक्शनचे `rateLimitedUntil`/`testStatus` दोन्ही तपासा.
- रीसेट विंडोनंतर प्रदाता कायमस्वरूपी वगळला जातो → कोड `getStatus()`/`canExecute()` ऐवजी थेट `state` वाचत आहे.
- एक की अयशस्वी झाली, तरी इतरांनी काम करायला हवे → सर्किट ब्रेकरपेक्षा कनेक्शन कूलडाउनला प्राधान्य द्या.
- केवळ एक मॉडेल अयशस्वी होते → कनेक्शन कूलडाउनपेक्षा मॉडेल लॉकआउटला प्राधान्य द्या.
- स्थिती स्वतःहून पूर्ववत व्हायला हवी पण होत नाही → भविष्यातील टाइमस्टॅम्प + कालबाह्य स्थिती रीफ्रेश करणारा रीड पाथ तपासा. कायमस्वरूपी स्थितींसाठी मॅन्युअल बदल आवश्यक आहेत.
