...
> Combinarea manuală a nivelurilor gratuite este dificilă — zeci de SDK-uri, zeci de limite de utilizare și nicio idee despre cât ai de fapt la dispoziție. OmniRoute cataloghează **446 de intrări cu nivel gratuit în 34 de chei de pool recurente** și calculează totalul de tokenuri folosind **cele 16 pool-uri cu un buget lunar pozitiv publicat, plus cinci limite Groq per model**, cu eliminarea dublurilor în funcție de pool-ul comun. Cotele care devin disponibile numai după verificarea regională a identității (în prezent: ModelScope) sunt afișate separat, +~6 mil. după verificarea regională a identității, și nu sunt incluse niciodată în totalul principal. Rezultatul rămâne vizibil în panoul de control (`/dashboard/free-tiers`).

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="Cardul de buget pentru nivelurile gratuite OmniRoute: ~1,47 mld. de tokenuri gratuite lunar în mod constant, până la ~2,07 mld. în prima lună cu creditele de înregistrare, provenind din 34 de chei de pool recurente documentate, care acoperă 446 de intrări catalogate cu nivel gratuit în spatele unui singur endpoint. Calcul transparent, cu eliminarea dublurilor per pool — fiecare pool comun este numărat o singură dată, inclusiv 16 pool-uri recurente cu un buget lunar pozitiv de tokenuri publicat, plus cinci limite Groq per model; 13 furnizori sunt marcați de evitat în catalogul privind riscurile termenilor, astfel încât tu să decizi. Bara de buget include Mistral 1 mld., Nara 210 mil., LLM7 150 mil., Groq 30 mil. (cinci limite per model) și pool-uri mai mici, plus credite de înregistrare pentru prima lună și furnizori permanent gratuiți fără limită de tokenuri, afișați separat pentru a nu umfla niciodată totalul principal. Utilizarea și soldul rămas în timp real sunt disponibile la /dashboard/free-tiers."/>

> Rezumat animat al paginii live `/dashboard/free-tiers`. Metodologia completă (eliminarea dublurilor per pool, nivelurile de credit, termenii furnizorilor): **[docs/reference/FREE_TIERS.md](docs/reference/FREE_TIERS.md)**.
>
> <sub>Aceste valori sunt verificate din nou la fiecare două săptămâni în raport cu catalogul live și **se pot modifica în ambele direcții** — dacă un furnizor încheie un nivel gratuit, numărul scade; dacă apare unul nou, numărul crește. Publicăm ceea ce calculează efectiv catalogul, niciodată un scenariu optimist rotunjit în sus.</sub>
...
⭐ Acordă o stea repository-ului dacă OMNIROUTE te-a ajutat să economisești bani și să-ți ușurezi munca.
...
[![Clasament istoric al stelelor](https://api.star-history.com/badge?repo=diegosouzapw/OmniRoute&theme=dark)](https://www.star-history.com/diegosouzapw/omniroute)
[![olud.ai](https://olud.ai/badge.php?tool=diegosouzapw-omniroute)](https://olud.ai/project/diegosouzapw-omniroute.html)

### 💬 Alătură-te comunității

**👋 Urmărește maintainer-ul — află primul despre furnizori noi, versiuni și sfaturi:**
...
<table>
  ...
  <tr><td nowrap><b>Bază de date</b></td><td>better-sqlite3 (SQLite, jurnalizare WAL) + LowDB (JSON moștenit) — 122 de module de domeniu, 177 de migrări</td></tr>
  ...
  <tr><td nowrap><b>Reziliență</b></td><td>Întrerupător de circuit, întârziere exponențială, protecție împotriva efectului „thundering herd”, autoremediere automată a combinațiilor</td></tr>
  ...
  <tr><td nowrap><b>CI/CD</b></td><td>GitHub Actions — publicare automată în npm + Docker Hub la lansare</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/SETUP_GUIDE.md">Ghid de configurare</a></b></td><td>Toate metodele de instalare, configurările instrumentelor CLI, configurarea protocoalelor, ajustarea timpilor de expirare</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Mod la distanță</a></b></td><td>Controlați o instanță OmniRoute la distanță (VPS) din interfața CLI a laptopului, folosind tokenuri de acces cu domeniu limitat</td></tr>
  <tr><td nowrap><b><a href="docs/guides/CLAUDE-CODE-CONFIGURATION.md">Configurarea Claude Code</a></b></td><td>Conectați Claude Code la OmniRoute (local/la distanță) folosind <code>launch</code> + profiluri pentru fiecare model</td></tr>
  <tr><td nowrap><b><a href="README.md#-quick-start">Pornire rapidă</a></b></td><td>Instalare în 3 pași → conectare → configurare</td></tr>
</table>

### 🔧 Operațiuni & implementare

<table>
  <tr><th align="left">Document</th><th align="left">Descriere</th></tr>
  <tr><td nowrap><b><a href="docs/guides/DOCKER_GUIDE.md">Ghid Docker</a></b></td><td>Rulare Docker, profiluri Compose, Caddy HTTPS, tuneluri, etichete de imagine</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/reference/ENVIRONMENT.md">Configurarea mediului</a></b></td><td>Lista completă a variabilelor <code>.env</code> și referințele acestora</td></tr>
</table>

### 🧠 Funcționalități & arhitectură
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/RTK_COMPRESSION.md">Compresie RTK</a></b></td><td>Compresia rezultatelor comenzilor, filtre, încredere, verificare, recuperarea rezultatului brut</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/routing/AUTO-COMBO.md">Motor Auto-Combo</a></b></td><td>Evaluare pe baza a 16 factori, pachete de moduri, autoremediere</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/reference/FREE_TIERS.md">Niveluri gratuite</a></b></td><td>Catalog consolidat: 34 de grupuri recurente documentate / 446 de oferte de nivel gratuit catalogate</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/frameworks/MCP-SERVER.md">Ghid pentru serverul MCP</a></b></td><td>Instalarea MCP, mecanisme de transport și referința instrumentelor</td></tr>
...
<table>
  <tr><th align="left">Document</th><th align="left">Descriere</th></tr>
  <tr><td nowrap><b><a href="CONTRIBUTING.md">Contribuții</a></b></td><td>Configurarea mediului de dezvoltare și îndrumări</td></tr>
  <tr><td nowrap><b><a href="docs/ops/BRANCHING_MODEL.md">Model de ramificare și lansare</a></b></td><td>Ramurile vizate de solicitările de integrare (<code>release/*</code>) și semnificația ramurii <code>main</code> și a etichetelor</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/guides/I18N.md">Ghid i18n</a></b></td><td>Compatibilitate cu 42 de limbi, fluxul de traducere, RTL</td></tr>
  <tr><td nowrap><b><a href="docs/ops/RELEASE_CHECKLIST.md">Listă de verificare pentru lansare</a></b></td><td>Pași de validare înaintea lansării</td></tr>
  <tr><td nowrap><b><a href="docs/ops/COVERAGE_PLAN.md">Plan de acoperire</a></b></td><td>Strategia de acoperire cu teste pentru peste 39.000 de declarații statice de testare din peste 5.100 de fișiere de testare urmărite</td></tr>
</table>
...
> OmniRoute este modelat de o comunitate open-source pasionată. Aceste persoane au adus contribuții excepționale care influențează direct calitatea, stabilitatea și răspândirea proiectului. **Vă mulțumim.**

### Contribuitori externi după numărul solicitărilor de integrare acceptate

<table>
  <tr><th align="center">Loc</th><th align="left">Colaborator</th><th align="center">PR-uri îmbinate</th><th align="right">~Linii modificate</th></tr>
...
<sub>Înghețat la vârful curent al <code>release/v3.8.50</code>, <code>dafb4ae808</code>, cu îmbinări până la 2026-08-24 05:26:03 UTC. Recensământul paginat GitHub GraphQL conține 5,911 PR-uri îmbinate: 2,707 de către proprietarul depozitului, 179 de către Dependabot și <b>3,025 de PR-uri externe de la 535 de colaboratori distincți</b>. „Linii modificate” reprezintă suma adăugărilor și ștergerilor de pe GitHub și include fișiere generate, fișiere de blocare, cataloage, traduceri și documentație; este volumul modificărilor, nu numărul de linii de cod scrise. Egalitățile de la prag sunt păstrate.</sub>
