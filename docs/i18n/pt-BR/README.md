...
## 💰 ~1,47 bi de tokens gratuitos por mês

</div>

> Combinar níveis gratuitos manualmente é trabalhoso — dezenas de SDKs, dezenas de limites de uso e nenhuma ideia de quanto você realmente tem. O OmniRoute cataloga **446 entradas de níveis gratuitos em 34 chaves de pools recorrentes** e calcula o total de tokens em destaque com base nos **16 pools que possuem um orçamento mensal positivo publicado, além de cinco limites do Groq por modelo**, eliminando duplicidades de pools compartilhados. As cotas que só ficam disponíveis após uma verificação regional de identidade (atualmente: ModelScope) são exibidas separadamente, com mais ~6 mi disponíveis mediante verificação regional de identidade, e nunca são incluídas no total em destaque. O resultado permanece visível no painel (`/dashboard/free-tiers`).

<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="Cartão de orçamento dos níveis gratuitos do OmniRoute: ~1,47 bi de tokens gratuitos por mês de forma contínua, chegando a ~2,07 bi no primeiro mês com créditos de cadastro, provenientes de 34 chaves documentadas de pools recorrentes que abrangem 446 entradas catalogadas de níveis gratuitos por trás de um único endpoint. Cálculo transparente com eliminação de duplicidades por pool — cada pool compartilhado é contado uma única vez, incluindo 16 pools recorrentes com orçamento mensal positivo de tokens publicado e cinco limites do Groq por modelo; 13 provedores estão marcados como a evitar no catálogo de riscos dos termos, para que você possa decidir. A barra de orçamento inclui Mistral 1 bi, Nara 210 mi, LLM7 150 mi, Groq 30 mi (cinco limites por modelo) e pools menores, além de créditos de cadastro para o primeiro mês e provedores permanentemente gratuitos sem limite de tokens, exibidos separadamente para que nunca aumentem artificialmente o total em destaque. Uso e saldo restantes em tempo real em /dashboard/free-tiers."/>

> Resumo animado da página `/dashboard/free-tiers` em tempo real. Metodologia completa (eliminação de duplicidades por pool, níveis de créditos, termos dos provedores): **[docs/reference/FREE_TIERS.md](docs/reference/FREE_TIERS.md)**.
>
> <sub>Esses números são auditados novamente a cada duas semanas em comparação com o catálogo em tempo real e **podem variar em ambas as direções** — se um provedor encerrar um nível gratuito, o número diminui; se um novo for adicionado, ele aumenta. Publicamos o que o catálogo realmente calcula, nunca um melhor cenário arredondado para cima.</sub>
...
<table>
  ...
  <tr><td nowrap><b>Banco de dados</b></td><td>better-sqlite3 (SQLite, registro em diário WAL) + LowDB (JSON legado) — 122 módulos de domínio, 177 migrações</td></tr>
  ...
  <tr><td nowrap><b>Autenticação &amp; segurança</b></td><td>OAuth 2.0 (PKCE) + JWT + chaves de API + autenticação MCP com escopo · AES-256-GCM em repouso · DOMPurify</td></tr>
  <tr><td nowrap><b>Furtividade</b></td><td>wreq-js — personificação de impressões digitais TLS JA3 / JA4, proxy de 3 níveis</td></tr>
  <tr><td nowrap><b>Resiliência</b></td><td>Disjuntor, recuo exponencial, prevenção de avalanche de requisições, autorrecuperação automática de combos</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/REMOTE-MODE.md">Modo Remoto</a></b></td><td>Controle um OmniRoute remoto (VPS) a partir da CLI do seu laptop por meio de tokens de acesso com escopo</td></tr>
  ...
  <tr><td nowrap><b><a href="README.md#-quick-start">Início Rápido</a></b></td><td>Instalação em 3 etapas → conectar → configurar</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/guides/PWA_GUIDE.md">Guia de PWA</a></b></td><td>Instalação de Progressive Web App, cache, arquitetura</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/reference/ENVIRONMENT.md">Configuração de Ambiente</a></b></td><td>Variáveis e referências completas de <code>.env</code></td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_GUIDE.md">Guia de Compressão</a></b></td><td>Pipeline de 7 opções: desativada / leve / padrão / agressiva / ultra / RTK / empilhada</td></tr>
  <tr><td nowrap><b><a href="docs/compression/RTK_COMPRESSION.md">Compressão RTK</a></b></td><td>Compressão da saída de comandos, filtros, confiança, verificação e recuperação da saída bruta</td></tr>
  <tr><td nowrap><b><a href="docs/compression/COMPRESSION_ENGINES.md">Mecanismos de Compressão</a></b></td><td>Caveman, RTK, pipelines empilhados e interfaces de dashboard/API/MCP</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/architecture/RESILIENCE_GUIDE.md">Guia de Resiliência</a></b></td><td>Disjuntores, períodos de espera, fila, prevenção de estouro de requisições simultâneas e falsificação de TLS</td></tr>
  <tr><td nowrap><b><a href="docs/routing/AUTO-COMBO.md">Mecanismo Auto-Combo</a></b></td><td>Pontuação de 16 fatores, pacotes de modos e autorrecuperação</td></tr>
  <tr><td nowrap><b><a href="docs/ops/PROXY_GUIDE.md">Guia de Proxy</a></b></td><td>Sistema de proxy de 3 níveis, marketplace 1proxy e CRUD do registro</td></tr>
  <tr><td nowrap><b><a href="docs/reference/FREE_TIERS.md">Camadas Gratuitas</a></b></td><td>Diretório consolidado: 34 conjuntos recorrentes documentados / 446 entradas de camada gratuita catalogadas</td></tr>
  <tr><td nowrap><b><a href="docs/guides/FEATURES.md">Galeria de Recursos</a></b></td><td>Visão geral visual do dashboard com capturas de tela</td></tr>
  <tr><td nowrap><b><a href="docs/architecture/CODEBASE_DOCUMENTATION.md">Documentação da Base de Código</a></b></td><td>Guia introdutório da base de código</td></tr>
</table>
...
<table>
  ...
  <tr><td nowrap><b><a href="open-sse/mcp-server/README.md">Servidor MCP</a></b></td><td>110 ferramentas MCP, configurações de IDE e clientes Python/TS/Go</td></tr>
  ...
  <tr><td nowrap><b><a href="src/lib/a2a/README.md">Servidor A2A</a></b></td><td>Protocolo JSON-RPC 2.0, habilidades, streaming e gerenciamento de tarefas</td></tr>
...
<table>
  ...
  <tr><td nowrap><b><a href="docs/ops/BRANCHING_MODEL.md">Modelo de Branches e Lançamentos</a></b></td><td>Branches de destino dos PRs (<code>release/*</code>) e o significado de <code>main</code> e das tags</td></tr>
  ...
  <tr><td nowrap><b><a href="docs/ops/RELEASE_CHECKLIST.md">Lista de Verificação de Lançamento</a></b></td><td>Etapas de validação pré-lançamento</td></tr>
...
> O OmniRoute é moldado por uma comunidade apaixonada por código aberto. Estas pessoas fizeram contribuições excepcionais que afetam diretamente a qualidade, a estabilidade e o alcance do projeto. **Obrigado.**
...
<sub>Verificado novamente em 2026-08-24 06:14:31 UTC: commits atribuídos pelo GitHub, conforme relatados pela API de Colaboradores do repositório para a branch padrão <code>release/v3.8.50</code>. A API retornou 525 identidades (415 usuários, 2 bots e 108 anônimas); esta tabela exclui o mantenedor, os bots e as identidades anônimas, mantendo os empates na classificação. Ela é distinta tanto da classificação por PRs mesclados acima quanto do censo de 639 pessoas baseado nos metadados do Git abaixo.</sub>

> 🙏 Os recursos, as correções de bugs e as melhorias de infraestrutura desses colaboradores são uma **parte essencial** do que torna o OmniRoute confiável e rico em recursos. Cada pull request, cada caso de teste e cada arquivo de tradução i18n faz a diferença. O código aberto é construído por pessoas como elas.
