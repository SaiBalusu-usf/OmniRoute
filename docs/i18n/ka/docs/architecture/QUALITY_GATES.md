...
## ბარიერების ინვენტარი (~90 სკრიპტი)

სკრიპტები განთავსებულია `scripts/check/`-ში (პოლიტიკის ბარიერები) და `scripts/quality/`-ში (ეტაპობრივი გამკაცრების ძრავა).
CI-ის ჭეშმარიტების წყაროა `.github/workflows/ci.yml`.

### გამოშვების PR-ის სწრაფი გზა (`quality.yml`)

`.github/workflows/quality.yml` სრულდება `release/**`-ისკენ მიმართულ PR-ებზე. იგი კონტრიბუტორების
ბრენჩებზე მუშაობას შეუფერხებლად აგრძელებს გზების მიხედვით გაფილტრული სწრაფი ბარიერებით და კოდის
ცვლილებებისთვის წარმოების აგების ერთი სარეკომენდაციო სიგნალით:

| დავალება                                         | მოქმედების სფერო                                                                                                                                                                                                                  | ბლოკირება                                                                                                           |
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| `Build (advisory)`                               | არა-შავი კოდის PR-ები და Mergify-ის რიგის ბრენჩები; Node 24, `npm-ci-retry`, `check:node-runtime`, `npm run build` ცვლადით `OMNIROUTE_USE_TURBOPACK=1`; არტეფაქტი არ იტვირთება, რადგან მას ქვემდგომი ხარისხის დავალება არ იყენებს | **სარეკომენდაციო** (`continue-on-error: true`; წაიშალოს გამოშვების PR-ების ერთკვირიანი სტაბილური შესრულების შემდეგ) |
| `Docs Gates (fast-path)`                         | დოკუმენტაციის/კოდის PR-ები; API დოკუმენტაციის ბმულები და docs-all                                                                                                                                                                 | დიახ                                                                                                                |
| `Fast Quality Gates`                             | კოდის PR-ები; სტატიკური შემოწმებები, ტიპების შემოწმება, დაფის ტიპების შემოწმება, ცვლილებებით დაზარალებული მოდულური ტესტები                                                                                                        | დიახ                                                                                                                |
| `Forgotten sibling tests`                        | კოდის PR-ები; შეცვლილი მოდულების დაკავშირება სტატიკურ მომხმარებლებთან და შესაძლო მეზობელ ტესტებთან; barrel და დინამიკური იმპორტის გზები აისახება სარეკომენდაციო დიაგნოსტიკის სახით, დაშვებული გამონაკლისების მითითებით            | **სარეკომენდაციო**                                                                                                  |
| `Vitest (fast-path)`                             | კოდის PR-ები; სწრაფი vitest კომპლექტი                                                                                                                                                                                             | დიახ                                                                                                                |
| `Unit Tests fast-path`                           | კოდის PR-ები; 4 ნაწილად დაყოფილი მოდულური ტესტების კომპლექტი                                                                                                                                                                      | დიახ                                                                                                                |
| `No new ESLint warnings`                         | კოდის PR-ები; გამონაკლისების გათვალისწინებით მოქმედი lint-ის დამცავი შემოწმება                                                                                                                                                    | დიახ საკუთარი წყაროდან მიღებულთათვის, სარეკომენდაციო fork-ებისთვის                                                  |
| `Merge integrity (changelog + generated skills)` | არა-შავი PR-ები; ცვლილებების ჟურნალისა და გენერირებული უნარების სინქრონიზაცია                                                                                                                                                     | დიახ საკუთარი წყაროდან მიღებულთათვის, სარეკომენდაციო fork-ებისთვის                                                  |

#### დავიწყებული მეზობელი ტესტების ანგარიში

`npm run check:forgotten-sibling-tests` ხელახლა იყენებს ტესტებზე ცვლილებების გავლენის რუკის იმპორტების ამომხსნელს.
ყოველი შეცვლილი საწარმოო მოდულისთვის იგი აჩვენებს დეტერმინისტულ
`შეცვლილი მოდული/სიმბოლო -> სტატიკური მომხმარებელი -> შესაძლო მეზობელი ტესტი` ჯაჭვებს, როდესაც შესაძლო
ტესტი pull request-ის ცვლილებათა სხვაობაში არ არის. Markdown შეჯამება და JSON შედეგი ინახება
`forgotten-sibling-tests` სამუშაო პროცესის არტეფაქტის სახით, ნებისმიერი დამბლოკავი დანერგვის დაწყებამდე კალიბრაციისთვის.

Barrel-ის რეექსპორტები და დინამიკური იმპორტები მხოლოდ ამოხსნის დიაგნოსტიკაა; ისინი არასდროს წარმოქმნიან
დამბლოკავ აღმოჩენას. განხილული გამონაკლისები ინახება
`config/quality/forgotten-sibling-allowlist.json`-ში. თითოეულ ჩანაწერში უნდა იყოს მითითებული მომხმარებელი და შესაძლო
ტესტი, მოცემული უნდა იყოს კონკრეტული დასაბუთება და GitHub-ის საკითხის ან pull request-ის ბმული. არასწორად შედგენილი ჩანაწერები
იწვევს მკაცრ უარყოფას. გამონაკლისებს არ შეუძლიათ წაშლილი შესაძლო ტესტის ან `.skip`/`.todo`-ს დამამატებელი ცვლილებათა სხვაობის მიჩქმალვა;
მტკიცებების შესუსტება და სხვა სახის შენიღბვა კვლავ დამოუკიდებლად დამბლოკავი
`check:test-masking` ბარიერის პასუხისმგებლობაში რჩება.

### დავალება: `lint`

სრულდება `main`-ისკენ მიმართულ ყოველ PR-ზე. წარუმატებლობის შემთხვევაში შერწყმას ბლოკავს.
...
| `check:route-validation:t06`      | Zod სქემები წარმოდგენილია ყველა მარშრუტზე (Tier 6 პოლიტიკა)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | დიახ                                           |
| `check:any-budget:t11`            | `@ts-expect-error // any`-ის რაოდენობა არ აღემატება ლიმიტს (Tier 11 catraca)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | დიახ                                           |
| `check:provider-consistency`      | `providers.ts`-ში არსებულ ყველა პროვაიდერს აქვს შესაბამისი ჩანაწერი `providerRegistry.ts`-ში (და პირიქით, ნებადართული სიის ფარგლებში)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | დიახ                                           |
| `check:model-lifecycle`           | ხელით შენარჩუნებული მარშრუტიზაციის სამი ცხრილი შესაბამისობაში რჩება რეპოზიტორიაში შენახულ სასიცოცხლო ციკლის სნეპშოტთან (#11503): `FITNESS_TABLE` (`taskFitness.ts`) არ ანიჭებს ქულას არცერთ ამოღებულ id-ს, რომლის მარშრუტიზაციაც `REGISTRY`-ს შეუძლია; `BUILT_IN_ALIASES`-ის ყველა სამიზნე წარმოდგენილია `REGISTRY`-ში და არ არის ამოღებული id-ების სნეპშოტში; `REGISTRY`-ში ჯერ კიდევ არსებული ყველა ამოღებული id გადამისამართებულია ან ჩამოთვლილია `allowedRetiredInCatalog`-ში; და `DEFAULT_DEGRADATION_MAP`-ის არცერთი წყარო ან სამიზნე ამ სნეპშოტში ამოღებულად არ არის მონიშნული. ეს არ ადასტურებს, რომ მოდელს ამჟამად რეალური ზედა დონის სერვისი ემსახურება. ოფლაინ — შედარება ხდება `config/quality/model-lifecycle.json`-თან, რომელიც ხელით ახლდება `npm run quality:refresh-model-lifecycle`-ის მეშვეობით (საჭიროებს ქსელს; CI-ში ინტეგრირებული არ არის). `allowedRetiredInCatalog` შემცირების მექანიზმია: ჩანაწერი დაამატეთ მხოლოდ შესაბამისი თვალთვალის საკითხის არსებობისას. | დიახ                                           |
| `check:fetch-targets`             | კლიენტის მხარეს `src/`-ში არსებული ყოველი `fetch("/api/...")` რეალურ `route.ts`-ს უკავშირდება                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | დიახ                                           |
| `check:deps`                      | რეპოზიტორიის ყველა `package.json`-ში არსებული, `npm install`-ით დასაყენებელი ყველა დამოკიდებულება შეტანილია `dependency-allowlist.json`-ში; ახალი დაუფიქსირებელი ვერსიის ან slopsquatting-ის ნიშნების მქონე პაკეტები მონიშნულია                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | დიახ                                           |
| `audit:deps`                      | `npm audit` (root + electron) — მაღალი/კრიტიკული სიმძიმის არცერთი გაფრთხილება (ნაწილობრივ ემთხვევა osv `check:vuln-ratchet`-ს; იხილეთ რაციონალიზაციის ბექლოგი)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | დიახ                                           |
| `check:lockfile`                  | `package-lock.json`-ის მთლიანობა — https რეესტრი, მთლიანობის ჰეშები, ჰოსტის ჩანაცვლებების გარეშე                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | დიახ                                           |
| `check:licenses`                  | საწარმოო დამოკიდებულებებისთვის დაშვებული SPDX ლიცენზიების სია                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | დიახ                                           |
| `check:tracked-artifacts`         | არ არის build-არტეფაქტები / რეპოზიტორიაში დამატებული `node_modules` სიმბოლური ბმულები (ასევე სრულდება husky pre-commit-ში; pre-push განზრახ მსუბუქია — #6716)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | დიახ                                           |
| `check:vitest-exclusions`         | Vitest-ის თითოეული გამონაკლისი მიუთითებს თვალყურის სადევნებელ issue-ს და წარმოდგენილია `config/quality/vitest-exclusions.json`-ში (#13204)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | დიახ                                           |
| `check:file-size`                 | არცერთი წყაროს ფაილი არ აჭარბებს გაფართოებისთვის განსაზღვრულ ზღვარს (ratchet: დიდი ფაილები დაფიქსირებულია `frozen` სიაში)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | დიახ                                           |
| `check:error-helper`              | შემსრულებლებსა/დამმუშავებლებში შეცდომის პასუხები იყენებს `buildErrorBody()` / `sanitizeErrorMessage()`-ს (მკაცრი წესი #12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | დიახ                                           |
| `check:migration-numbering`       | მიგრაციის SQL ფაილები დანომრილია თანმიმდევრულად, გამოტოვებებისა და დუბლიკატების გარეშე                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | დიახ                                           |
| `check:public-creds`              | ლიტერალური OAuth `client_id`/`client_secret` ან Firebase Web გასაღებები დაუშვებელია `publicCreds.ts`-ის გარეთ (მკაცრი წესი #11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | დიახ                                           |
| `check:db-rules`                  | ნედლი SQL დაუშვებელია `src/lib/db/` მოდულების გარეთ; `localDb.ts`-დან barrel-იმპორტები დაუშვებელია (მკაცრი წესები #2/#5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | დიახ                                           |
| `check:known-symbols`             | პროვაიდერების შემსრულებლები, მარშრუტიზაციის სტრატეგიები და მთარგმნელები, რომლებიც რეგისტრირებულია შესაბამის დისპეტჩერიზაციის ცხრილებში, უნდა ემთხვეოდეს დისკზე არსებულ ფაილებს — დაობლებული ან გამოუცხადებელი სიმბოლოების გარეშე                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | დიახ                                           |
...
| `check:test-discovery`            | რეპოზიტორიაში არსებული ყველა `*.test.ts` / `*.spec.ts` ფაილი შეგროვებულია სულ მცირე ერთი ტესტების გამშვების მიერ (ხრუტუნა მექანიზმი: `test-discovery-baseline.json`-ში დაობლებული ფაილების სია მხოლოდ შეიძლება შემცირდეს)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | დიახ                                           |
| `check:agent-skills-sync`         | გენერირებული agent-skills არტეფაქტები ემთხვევა მათ წყაროს კატალოგს (აცდენის გარეშე)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `check:provider-asset-provenance` | პროვაიდერების ლოგოებს/რესურსებს თან ახლავს წარმოშობის შესახებ რეგისტრირებული ჩანაწერი                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `lint:json`                       | JSON-ის კონფიგურაციის ფაილები სწორად იშიფრება და აკმაყოფილებს რეპოზიტორიის lint-ის წესებს                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `typecheck:core`                  | TypeScript-ის კომპილაცია შეცდომების გარეშე (მხოლოდ სარეკომენდაციო გაფრთხილებები)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | დიახ                                           |
| `typecheck:noimplicit:core`       | მკაცრი `noImplicitAny` — სამომავლო მოთხოვნა; ბევრ უკვე არსებულ გამოძახების ადგილს ჯერ კიდევ სჭირდება ანოტაციები                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | **სარეკომენდაციო** (`continue-on-error: true`) |
| `check:dashboard-typecheck`       | `tsc`, რომლის მოქმედების არეა `src/app/(dashboard)/**` (#7033) — `typecheck:core`-ის საგანგებოდ შერჩეული 27-ფაილიანი დაშვებული სია არ შეიცავს dashboard-ის არცერთ TSX ფაილს, ხოლო `next build` მათ ტიპებს საერთოდ არ ამოწმებს (`next.config.mjs`-ში დაყენებულია `ignoreBuildErrors: true`), ამიტომ იქ არსებული მიუწვდომელი იდენტიფიკატორების რეგრესიები (#6625/#6909) CI-სთვის შეუმჩნეველი იყო. შედეგები შედარებულია გაყინულ, თითოეული ფაილისა და თითოეული TS-კოდის რაოდენობაზე დაფუძნებულ საბაზისო მაჩვენებელთან (`config/quality/dashboard-typecheck-baseline.json`, მოძველებული ჩანაწერების კონტროლის იგივე მიდგომით, რასაც `check:known-symbols` იყენებს) — შემოწმება ჩავარდება მხოლოდ მაშინ, როდესაც ახალი შეცდომების რაოდენობა საბაზისო მაჩვენებელს გადააჭარბებს; უკვე არსებული შეცდომის გამოსწორებისას ზღვარი შეამცირეთ `--update`-ის გამოყენებით.                                                                                                                                | დიახ                                           |

### დავალება: `quality-gate`

ეშვება `test-coverage`-ის შემდეგ. წარუმატებლობის შემთხვევაში შერწყმას ბლოკავს.

| სკრიპტი                      | რას ამოწმებს                                                                                                                                                                                                       | დამბლოკავია                        |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- |
| `quality:collect`            | ქმნის `quality-metrics.json`-ს (ESLint-ის გაფრთხილებების რაოდენობა, დაფარვა გაერთიანებული shard-ანგარიშიდან)                                                                                                       | დიახ (ratchet-ის წინმსწრები ეტაპი) |
| `quality:ratchet`            | `quality-baseline.json`-ში მოცემული არცერთი მეტრიკა არ გაუარესებულა (ESLint-ის გაფრთხილებები ≤ საბაზისო მაჩვენებელს; დაფარვა ≥ საბაზისო მაჩვენებელს)                                                               | დიახ                               |
| `check:duplication`          | კოდის დუბლირება (jscpd@4) არ აღემატება `quality-baseline.json`-ში მითითებულ საბაზისო მაჩვენებელს                                                                                                                   | დიახ                               |
...
| `check:cognitive-complexity` | კოგნიტიური სირთულის ratchet (`eslint-plugin-sonarjs`) — ESLint-ის ცალკე გაშვება; CI ორივეს აერთიანებს ერთ `check:complexity-ratchets` ეტაპად                                                                       | დიახ                               |
| `check:dead-code`            | გამოუყენებელი ექსპორტების / ფაილების ratchet (knip) საბაზისო მაჩვენებელთან შედარებით არ უარესდება                                                                                                                  | დიახ                               |
...
| `check:type-coverage`        | ტიპიზებული კოდის პროცენტული მაჩვენებლის ratchet (`type-coverage`) არ უარესდება; მეტწილად მოიცავს `typecheck:noimplicit:core`-ის ფუნქციონალს                                                                        | დიახ                               |
| `check:codeql-ratchet`       | ღია CodeQL გაფრთხილებების რაოდენობა არ უარესდება (კითხულობს `gh api`-ის მეშვეობით; ტოკენის გარეშე შემოწმებას უსაფრთხოდ გამოტოვებს) — განახლების სიხშირისა და ხელით გაშვების შესახებ იხილეთ „CodeQL ratchet“ ქვემოთ | დიახ                               |

### დავალება: `quality-extended`

მთელი დავალება სარეკომენდაციოა (`continue-on-error: true`). npm-ზე დაფუძნებული ratchet-ები რეალურად სრულდება; გარე სკანერები ინსტალირდება `gh release download`-ის მეშვეობით და ავტომატურად გამოტოვებს შესრულებას (exit 0), როდესაც ბინარული ფაილი ჯერ კიდევ არ არსებობს.

| სკრიპტი                  | რას ამოწმებს                                                                                                                                                                                                   | ბლოკირებადი        |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `check:circular-deps`    | ციკლური დამოკიდებულებების არარსებობას (dpdm)                                                                                                                                                                   | **სარეკომენდაციო** |
| `check:bundle-size`      | bundle-ის ზომა არ აღემატება ზღვარს                                                                                                                                                                             | **სარეკომენდაციო** |
| `check:secrets`          | საიდუმლოებების სკანირებას (gitleaks) — გამოტოვებს, თუ ბინარული ფაილი არ არსებობს                                                                                                                               | **სარეკომენდაციო** |
...
| `check:workflows`        | workflow-ების lint-შემოწმებას (actionlint + zizmor) — გამოტოვებს, თუ ბინარული ფაილები არ არსებობს                                                                                                              | **სარეკომენდაციო** |
| `check:openapi-breaking` | საჯარო API კონტრაქტის (`openapi.yaml`) შეუთავსებელ ცვლილებებს საბაზისო branch-თან შედარებით (oasdiff) — გამოაქვს `openapiBreaking=N`; გამოტოვებს, თუ oasdiff არ არსებობს ან საბაზისო სპეციფიკაცია ვერ მოიძებნა | **სარეკომენდაციო** |

### დავალება: `docs-sync-strict`

სრულდება `main`-ზე მიმართულ ყოველ PR-ზე. წარუმატებლობის შემთხვევაში merge-ს ბლოკავს.

| სკრიპტი                        | რას ამოწმებს                                                                                                                                                                                                                    | ბლოკირებადი                          |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| `check:docs-all`               | მეტა-კარიბჭეს, რომელიც ქვემოთ მოცემულ 6 ქვეკარიბჭეს თანმიმდევრულად ასრულებს                                                                                                                                                     | დიახ                                 |
| ↳ `check:docs-sync`            | CHANGELOG / OpenAPI / llm.txt ვერსიების თანხვედრას                                                                                                                                                                              | დიახ                                 |
| ↳ `check:docs-counts`          | ტექსტში მოცემული რაოდენობები (პროვაიდერების რაოდენობა, მიგრაციების რაოდენობა და ა.შ.) რეალური რაოდენობების ratchet-ფანჯრის ფარგლებშია                                                                                           | დიახ                                 |
| ↳ `check:env-doc-sync`         | `.env.example`-ში არსებული ყოველი env var დოკუმენტაციის ცხრილშია აღწერილი და პირიქით                                                                                                                                            | დიახ                                 |
| ↳ `check:deprecated-versions`  | დოკუმენტაციაში მოძველებული ვერსიის სტრიქონები არ არსებობს                                                                                                                                                                       | დიახ                                 |
| ↳ `check:doc-links`            | დოკუმენტაციაში არსებული შიდა markdown ბმულები რეალურ ფაილებზე მიუთითებს (`[text]`/`(path)` ფორმა)                                                                                                                               | დიახ                                 |
| ↳ `check:fabricated-docs`      | დოკუმენტაციაში მითითებული route-ები, env var-ები, CLI ბრძანებები, hook-ების სახელები და ფაილების path-ები კოდების ბაზაში არსებობს. მკაცრი კარიბჭე `--strict`-ის მეშვეობით; ამ flag-ის გარეშე წარუმატებლობა ბლოკირებადი არ არის. | დიახ (CI-ში `--strict`-ის მეშვეობით) |
| `check:cli-i18n`               | CLI ბრძანებების სტრიქონები ყველა i18n locale ფაილშია წარმოდგენილი                                                                                                                                                               | დიახ                                 |
| `check:openapi-coverage`       | OpenAPI სპეციფიკაცია რეალური route-ების სულ მცირე ratchet-ით განსაზღვრულ მინიმუმს ფარავს                                                                                                                                        | დიახ                                 |
...
| `check:openapi-routes`         | `openapi.yaml`-ში მოცემული ყოველი path რეალურ `route.ts`-ს შეესაბამება (ჰალუცინაციების საწინააღმდეგო შემოწმება)                                                                                                                 | დიახ                                 |
| `check:docs-symbols`           | `docs/**/*.md`-ში მოცემული ყოველი `/api/...` მითითება რეალურ `route.ts`-ს შეესაბამება (ჰალუცინაციების საწინააღმდეგო შემოწმება)                                                                                                  | დიახ                                 |
| `i18n` თარგმანის აცდენა        | უთარგმნელი keys i18n locale ფაილებში — მხოლოდ გაფრთხილება                                                                                                                                                                       | **სარეკომენდაციო**                   |

### დავალება: `i18n-ui-coverage`

| სკრიპტი                           | რას ამოწმებს                                                                                                                                                                                                  | ბლოკირებადი        |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `check-ui-keys-coverage` (inline) | UI-ის i18n გასაღებების დაფარვა ≥ 65%-ია                                                                                                                                                                       | კი                 |
| `check-ui-value-drift` (inline)   | ხელახლა დაწერილი ინგლისური **მნიშვნელობა** მოძველებულ თარგმანს არ ტოვებს                                                                                                                                      | კი                 |
| `check-new-key-coverage` (inline) | **ახალი** ინგლისური გასაღები ყველა ლოკალში ხვდება                                                                                                                                                             | კი                 |
| `check-translation-ratio`         | რეალური თარგმანების თანაფარდობა თითოეულ ლოკალში (ინგლისურის იდენტური / placeholder / allowlist-ის მიღმა გამოტოვებული ფოთლები) არ უნდა აღემატებოდეს `config/quality/i18n-translation-baseline.json`-ს + მარაგს | **სარეკომენდაციო** |

საჭიროებს `fetch-depth: 0`-ს — მნიშვნელობის ცვლილების შემოწმება `en.json`-ს merge base-თან ადარებს.

#### `check-ui-value-drift` — მოძველებული თარგმანის ბარიერი

იჭერს იმ ერთადერთ i18n რეგრესიას, რომელსაც სხვა ბარიერები სტრუქტურულად ვერ ხედავენ: ინგლისური მნიშვნელობა
ხელახლა იწერება, ხოლო _წინა_ ინგლისური ტექსტიდან მიღებული თარგმანები უცვლელი რჩება, რის გამოც
არაინგლისურენოვანი მომხმარებლები დამაჯერებლად ჩამოყალიბებული, თუმცა უკვე არასწორი ტექსტის კითხვას აგრძელებენ.

ეს რეალურ რელიზში მოხვდა. `oauthModal.googleOAuthWarning` ხელახლა დაიწერა, როდესაც Antigravity-ის
შესვლის დამხმარე დაემატა (#5203); **43 ლოკალიდან 39-ში** დარჩა ტექსტი, რომელიც ოპერატორებს ეუბნებოდა, რომ „სრული
URL დაეკოპირებინათ და ქვემოთ ჩაესვათ“ — პროცესი, რომელიც ამ პროვაიდერისთვის ვერ სრულდება. ეს
#8463-მდე შეუმჩნეველი დარჩა, რადგან:

- `sync-ui-keys` მხოლოდ **არარსებულ** გასაღებებს ავსებს და არასდროს — **მოძველებულებს**;
- `check-ui-keys-coverage` გასაღების _არსებობას_ ითვლის, ამიტომ მოძველებული თარგმანი დაფარულად მიიჩნევა;
- `check-translation-drift` აკონტროლებს `docs/i18n/<locale>/**.md` დოკუმენტაციის ასლებს —
  ის არასდროს კითხულობს `src/i18n/messages/*.json`-ს. ბლოკირებადია `docs-sync-strict` დავალებაში
  2026-09-ის ხელახალი სინქრონიზაციის შემდეგ: შეცვალეთ ძირითადი დოკუმენტი → `npm run i18n:run -- --files=<doc>` (სექციის დონეზე, იაფი).

**Diff-ზე ორიენტირებული და არა baseline-ზე დაფუძნებული.** ის merge base-ში არსებულ `en.json`-ს
სამუშაო ხეს ადარებს; ყოველი გასაღებისთვის, რომლის ინგლისური მნიშვნელობაც შეიცვალა, ნებისმიერი ლოკალი, რომელშიც
ხელუხლებელი თარგმანი დარჩა, მოძველებულად მიიჩნევა. ეს განზრახ **ყინავს წინასწარ არსებულ დავალიანებას** — diff-ით
ვერ დადგინდება, რომელი ძველი ინგლისური ტექსტიდან წარმოიშვა დიდი ხნის წინანდელი თარგმანი, ამიტომ ბარიერი
მხოლოდ იმას აფასებს, რასაც მიმდინარე ცვლილება ეხება. ალტერნატივა (თითოეული გასაღების hash baseline) საჭირო გახდიდა
დაახლოებით 600 KB-იან გენერირებულ ფაილს, რომელიც უდიდეს არსებულ baseline-ზე 3-ჯერ დიდია და ყოველ i18n PR-ზე შეიცვლებოდა.
...
2. მიანიჭეთ მათ `__MISSING__:<new english>` — ამის შემდეგ runtime გასცემს შესწორებულ ინგლისურ ტექსტს
   (`src/i18n/request.ts::deepMergeFallback`, #7258), ხოლო გასაღები თარგმნის რიგში ჩადგება.
...
| სკრიპტი                | რას ამოწმებს                                                                                                                                | ბლოკირებადი |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `check:pr-test-policy` | PR-ები, რომლებიც ცვლიან საწარმოო კოდს `src/`, `open-sse/`, `electron/` ან `bin/`-ში, უნდა შეიცავდნენ ან აახლებდნენ ტესტებს (მკაცრი წესი #8) | კი          |
| `check:test-masking`   | შეცვლილი სატესტო ფაილები არ ამცირებს assert-ების წმინდა რაოდენობას და არ ამატებს `assert.ok(true)` ტავტოლოგიებს                             | კი          |
| `check:pr-evidence`    | PR-ის აღწერა უთითებს ცვლილების ტესტირების/VPS მტკიცებულებებს (მკაცრი წესის #18 მექანიზაცია PR-ის ტექსტში ძიებით — მყიფეა, იხილეთ Backlog)   | კი          |

### დავალება: `test-vitest`

ეშვება `build`-ის შემდეგ. წარუმატებლობის შემთხვევაში merge-ს ბლოკავს.

| ნაკრები          | ამოწმებს                                                         | ბლოკირებადი                                                                                                                      |
| ---------------- | ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `test:vitest`    | MCP სერვერი (110 ინსტრუმენტი), autoCombo, კეში — vitest გამშვები | დიახ                                                                                                                             |
| `test:vitest:ui` | UI კომპონენტების ტესტები — vitest გამშვები                       | **ბლოკირებადი** — არსებული წარუმატებლობები პირდაპირ გამორიცხულია `vitest.config.ts`-ში; ახალი წარუმატებლობები დავალებას ჩააგდებს |

### ღამის სამუშაო პროცესები (გეგმური, სარეკომენდაციო)

ისინი სრულდება cron განრიგით (და `workflow_dispatch`-ით), არასოდეს — PR-ებზე. ყველა მათგანი სარეკომენდაციოა.

| სამუშაო პროცესი        | ამოწმებს                                                                                                                                                                           | ბლოკირებადი        |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `nightly-property`     | fast-check თვისებებზე დაფუძნებული ტესტები შემთხვევითი საწყისი მნიშვნელობითა და გაშვებების დიდი რაოდენობით                                                                          | **სარეკომენდაციო** |
| `nightly-resilience`   | heap-ის ზრდის ზღვარი, ქაოსური შეცდომების ინექცია, k6 დატვირთვის/ხანგრძლივი დატვირთვის ტესტირება                                                                                    | **სარეკომენდაციო** |
| `nightly-llm-security` | promptfoo-ს ინექციისგან დაცვა (დაბლოკვის რეჟიმი) + garak-ის შემოწმებები (გამოტოვებულია პროვაიდერის საიდუმლო მონაცემის გარეშე)                                                      | **სარეკომენდაციო** |
| `nightly-schemathesis` | OpenAPI კონტრაქტის ფაზინგი (schemathesis) აქტიური OmniRoute-ის მიმართ, `docs/openapi.yaml`-ის გამოყენებით — ავლენს სპეციფიკაციის დარღვევებს / დაუმუშავებელ 500-იანებს (ფაზა 8 B.4) | **სარეკომენდაციო** |
| `nightly-mutation`     | Stryker-ის მუტაციური ტესტირების ქულა სწრაფი მოდულური ტესტების ნაკრებისთვის — გადარჩენილი მუტანტები სუსტ მტკიცებებს ავლენს                                                          | **სარეკომენდაციო** |
...
- მიწოდების ჯაჭვი (წარმომავლობა, SBOM, Trivy, Scorecard): [`docs/security/SUPPLY_CHAIN.md`](../security/SUPPLY_CHAIN.md)

#### `check-key-completeness` — გასაღებების სიმრავლეთა თანხვედრის შემოწმება

`scripts/i18n/check-key-completeness.mjs` (`npm run i18n:check-keys`, დავალება `i18n-ui-coverage`).
ადარებს ყოველი `src/i18n/messages/<locale>.json`-ის ფოთლოვანი გასაღებების სიმრავლეს `en.json`-ს და
ნებისმიერი გამოტოვებული ან ზედმეტი ფოთლის აღმოჩენისას შემოწმებას წარუმატებლად ასრულებს, მიუხედავად
იმისა, თუ როდის დაემატა გასაღები. `__MISSING__:` ჩანაცვლების ნიშნები არსებულად ითვლება (მათი
შიგთავსი თანაფარდობის შემოწმების საზრუნავია). ეს ორი ცვლილებებზე დაფუძნებული/პროცენტული შემოწმების
აბსოლუტური შემავსებელია: `check-ui-keys-coverage` თითოეული ლოკალისთვის 80 %-იან ქვედა ზღვარს
უზრუნველყოფს (დაახლოებით 13,000-დან 43 გამოტოვებული გასაღები მაინც 99.7 %-ად იკითხება), ხოლო
`check-new-key-coverage` აფასებს მხოლოდ იმ გასაღებებს, რომლებსაც PR `en.json`-ს ამატებს.
ლოკალების პაკეტი გენერირდება იმ დღის `en.json`-დან, როდესაც მისი განშტოება იქმნება, და თარგმნა
დღეების განმავლობაში გრძელდება, მაშინ როცა საბაზისო განშტოებას გასაღებები კვლავ ემატება; თავად
პაკეტის PR გასაღებს არ ამატებს, ამიტომ ორივე მონათესავე შემოწმება დუმდა, როდესაც პაკეტი 1 (#13044)
ცხრა ლოკალში 43 გასაღების დანაკლისით, ხოლო პაკეტი 2 (#13660) რვა ლოკალში 10 გასაღების დანაკლისით
გაერთიანდა (2026-09-15). წარუმატებელი შემოწმების გამოსასწორებლად გამოიყენეთ
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers`; `extra` ფოთოლი ნიშნავს,
რომ წყაროდან ის ამოღებულია — წაშალეთ იგი ლოკალიდან. `--warn` პრობლემებს წარუმატებლობის გარეშე
ატყობინებს. `--catalog=cli` იმავე შედარებას `bin/cli/locales`-ზე ასრულებს
(`npm run i18n:check-keys:cli`); ორივე ნაბიჯი დავალება `i18n-ui-coverage`-შია.

#### `check-new-key-coverage` — ახალი გასაღებების i18n-შემოწმება

`check-ui-value-drift`-ის მონათესავე შემოწმება. ის აფიქსირებს შემთხვევას, როდესაც ინგლისური
მნიშვნელობა **ხელახლა ჩაიწერა**, მაგრამ მისი თარგმანები ძველი დარჩა; ეს შემოწმება კი აფიქსირებს
შემთხვევას, როდესაც ინგლისური გასაღები **დაემატა**, თუმცა ზოგიერთ ლოკალს ის საერთოდ არ მიუღია.

`check-ui-keys-coverage` ამ კლასის პრობლემას ვერ ხედავს: ის თითოეული ლოკალისთვის პროცენტულ ქვედა
ზღვარს უზრუნველყოფს, ხოლო დაახლოებით 13,000 ფოთლიდან თერთმეტი გამოტოვებული გასაღების შემთხვევაში
დაფარვა 99.9%-ზე რჩება. თითოეულ ენაზე გამოთვლილი პროცენტი ვერ გამოხატავს აზრს „ეს ფუნქცია თარგმანის
გარეშე გამოვიდა“ — ახალ ლოკალში მთელი ფუნქცია შეიძლება ტექსტის გარეშე დაემატოს და მაჩვენებელი
საერთოდ არ შეიცვალოს.

ინციდენტი, რომელსაც ის ასახავს: Orchestration Canvas-ის Phase 3-მა თავისი თერთმეტი გასაღები იმ
დროისთვის არსებულ 42 ლოკალზე თარგმნა. რამდენიმე საათის შემდეგ ევროკავშირის ენების პაკეტმა
(#13044) რეპოზიტორიაში ლოკალების რაოდენობა 51-მდე გაზარდა, ხოლო ცხრა ახალ ლოკალს (`el`, `et`,
`ga`, `hr`, `lt`, `lv`, `mt`, `sl`, `sr`) ეს გასაღებები არასოდეს მიუღია. `deepMergeFallback`
გამოტოვებული გასაღების ნაცვლად ინგლისურ ტექსტს იყენებს, ამიტომ მარცხის გამოვლინება ცარიელი
ინტერფეისის ნაცვლად უთარგმნელი ინტერფეისი იყო — რეალური და არქიტექტურულად უხმაურო.

თავისი მონათესავის მსგავსად, ის **ითვალისწინებს ცვლილებებს** და გაერთიანების საბაზისო წერტილში
არსებულ ინგლისურ ვერსიას სამუშაო ხეს ადარებს, ამიტომ წინასწარ არსებული ხარვეზები გაყინული რჩება
და შემოწმების ჩასართავად მიგრაცია საჭირო არ გამხდარა. გამონაკლისის მექანიზმი:
`__MISSING__:<english>` თარგმანს სამომავლოდ გადადებს და ამავე დროს გაშვების გარემოს სისწორეს
ინარჩუნებს. `vi` ჩანაცვლების ნიშნებს კრძალავს (`tests/unit/i18n-vi-completeness.test.ts`) და
ნამდვილ თარგმანს მოითხოვს.

#### `check-vitest-exclusions` — გადადებული ტესტების შემოწმება

`vitest.config.ts`-ის `exclude` სიაში არსებული ფაილი არის ტესტი, რომელიც არ სრულდება, თუმცა ხის
მკითხველისთვის დაფარვის ნაწილად გამოიყურება. კომენტარის
`// #8618 — წინასწარ არსებული წარუმატებლობა; გამოსწორების შემდეგ ამოიღეთ ეს გამონაკლისი` უკან
სამოცდაორი ფაილი დაგროვდა. საკითხი #8618 დაიხურა 2026-08-11-ს, მაშინ როცა მის მიერ აღრიცხული სია
45 ჩანაწერიდან 62-მდე გაიზარდა და ყოველი ახალი ჩანაწერი მკვდარ საკითხზე მიმანიშნებელ კომენტარს
იმკვიდრებდა. როდესაც სია საბოლოოდ ფაილების მიხედვით გაიზომა (#13204), **62-დან 51 ტესტმა მიმდინარე
ხეზე წყაროს ყოველგვარი ცვლილების გარეშე წარმატებით გაიარა**.

შემოწმება მოითხოვს, რომ ყოველი გამონაკლისი, რომელიც რეალურ ფაილზე მიუთითებს, (a) ასახელებდეს
აღრიცხვის საკითხს და (b) თავისი გაზომილი სტატუსით შეტანილი იყოს
`config/quality/vitest-exclusions.json`-ში, რათა ახალი გამონაკლისის დამატება ცალკე ფაილში
განსახილველი ცვლილება იყოს და არა 60-ჩანაწერიან მასივში დამატებული კიდევ ერთი სტრიქონი. ის
განზრახ არ უშვებს გამორიცხულ ტესტებს ხელახლა — ამას დაახლოებით 10 წუთი სჭირდება და პერიოდულ
დავალებას ეკუთვნის; ინვენტარში აღირიცხება, ბოლოს როდის გაიზომა თითოეული მათგანი.
