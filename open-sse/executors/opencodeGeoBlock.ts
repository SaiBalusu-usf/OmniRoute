...
// an egress-scoped refusal like the geo class above, so rotation reuses the
// same tried-set. Literal exact token only; `user-blocked` / `user blocked`
// are unobserved phrasings (fail closed).
