...
export function supportsNativeWebSearchFallbackBypass({
  ...
  // Antigravity targets share that translator (openaiToAntigravityRequest ->
  // openaiToCloudCodeGeminiRequest -> openaiToGeminiBase -> buildGeminiTools),
  // so they map web_search to googleSearch natively too (#13447).
