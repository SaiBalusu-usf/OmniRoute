...
function isSchemaAlreadyApplied(
  ...
  switch (migration.version) {
    ...
    case "182":
      ...
      // rotation_account at boot. Keyed by version only.
      return hasColumn(db, "proxy_logs", "rotation_account");
    case "183":
      // Same shape as 179/181/182: ensureProxyLogsColumns may have added
      // correlation_id at boot. Keyed by version only.
